...
public class Header extends HttpSecureAppServlet {
  ...
  private static final String windowId = "E547CE89D4C04429B6340FFA44E70716";
  private static final String tabId = "C4B6506838E14A349D6717D6856F1B56";
  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("86CF41840F714046BD90A23EE5249C68")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("86CF41840F714046BD90A23EE5249C68");
        SessionInfo.setModuleId("E1CE87638F174BA58FF1F76E75962960");
        if (securedProcess || explicitAccess.contains("86CF41840F714046BD90A23EE5249C68")) {
          classInfo.type = "P";
          classInfo.id = "86CF41840F714046BD90A23EE5249C68";
        }
      }
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
     ...
     } else if (vars.commandIn("BUTTONEM_Sspiv_Annulment86CF41840F714046BD90A23EE5249C68")) {
        vars.setSessionValue("button86CF41840F714046BD90A23EE5249C68.stremSspivAnnulment", vars.getStringParameter("inpemSspivAnnulment"));
        vars.setSessionValue("button86CF41840F714046BD90A23EE5249C68.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button86CF41840F714046BD90A23EE5249C68.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button86CF41840F714046BD90A23EE5249C68.strClient", vars.getStringParameter("inpadClientId"));
        ...
        vars.setSessionObject("button86CF41840F714046BD90A23EE5249C68.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "86CF41840F714046BD90A23EE5249C68", request.getServletPath());    
     } else if (vars.commandIn("BUTTON86CF41840F714046BD90A23EE5249C68")) {
        String strFin_Payment_ID = vars.getGlobalVariable("inpfinPaymentId", windowId + "|Fin_Payment_ID", "");
        String stremSspivAnnulment = vars.getSessionValue("button86CF41840F714046BD90A23EE5249C68.stremSspivAnnulment");
        String strProcessing = vars.getSessionValue("button86CF41840F714046BD90A23EE5249C68.strProcessing");
        String strOrg = vars.getSessionValue("button86CF41840F714046BD90A23EE5249C68.strOrg");
        String strClient = vars.getSessionValue("button86CF41840F714046BD90A23EE5249C68.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Sspiv_Annulment86CF41840F714046BD90A23EE5249C68(response, vars, strFin_Payment_ID, stremSspivAnnulment, strProcessing);
        }
    ...
    } else if (vars.commandIn("SAVE_BUTTONEM_Sspiv_Annulment86CF41840F714046BD90A23EE5249C68")) {
        String strFin_Payment_ID = vars.getGlobalVariable("inpKey", windowId + "|Fin_Payment_ID", "");
        String stremSspivAnnulment = vars.getStringParameter("inpemSspivAnnulment");
        String strProcessing = vars.getStringParameter("inpprocessing");
        OBError myMessage = null;
        try {
          String pinstance = SequenceIdData.getUUID();
          PInstanceProcessData.insertPInstance(this, pinstance, "86CF41840F714046BD90A23EE5249C68", (("Fin_Payment_ID".equalsIgnoreCase("AD_Language"))?"0":strFin_Payment_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
...
params.put("action", straction);
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonEM_Sspiv_Annulment86CF41840F714046BD90A23EE5249C68(HttpServletResponse response, VariablesSecureApp vars, String strFin_Payment_ID, String stremSspivAnnulment, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 86CF41840F714046BD90A23EE5249C68");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Sspiv_Annulment86CF41840F714046BD90A23EE5249C68", discard).createXmlDocument();
      ...
      xmlDocument.setParameter("processId", "86CF41840F714046BD90A23EE5249C68");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("86CF41840F714046BD90A23EE5249C68");
        vars.removeMessage("86CF41840F714046BD90A23EE5249C68");
        if (myMessage!=null) {
    ...
    xmlDocument.setParameter("action", Utility.getContext(this, vars, "EM_APRM_Process_Payment", "E547CE89D4C04429B6340FFA44E70716"));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button6255BE488882480599C81284B70CD9B3.originalParams"), comboTableData, windowId, Utility.getContext(this, vars, "EM_APRM_Process_Payment", "E547CE89D4C04429B6340FFA44E70716"));
