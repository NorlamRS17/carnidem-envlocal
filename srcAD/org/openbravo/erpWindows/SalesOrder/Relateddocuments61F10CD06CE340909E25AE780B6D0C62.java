...
public class Relateddocuments61F10CD06CE340909E25AE780B6D0C62 extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
        ...
        String strSsorel_Invoiceorder_V_ID = vars.getGlobalVariable("inpssorelInvoiceorderVId", windowId + "|Ssorel_Invoiceorder_V_ID", "");
...
String stradTableId = "318";
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonDocAction111(response, vars, strSsorel_Invoiceorder_V_ID, strdocaction, strProcessing, strdocstatus, stradTableId);
        }
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonCalculate_Promotions9EB2228A60684C0DBEC12D5CD8D85218(response, vars, strSsorel_Invoiceorder_V_ID, strcalculatePromotions, strProcessing);
        }

    } else if (vars.commandIn("SAVE_BUTTONDocAction111")) {
        String strSsorel_Invoiceorder_V_ID = vars.getGlobalVariable("inpKey", windowId + "|Ssorel_Invoiceorder_V_ID", "");
        String strdocaction = vars.getStringParameter("inpdocaction");
        String strProcessing = vars.getStringParameter("inpprocessing");
        OBError myMessage = null;
        try {
          String pinstance = SequenceIdData.getUUID();
          PInstanceProcessData.insertPInstance(this, pinstance, "111", (("Ssorel_Invoiceorder_V_ID".equalsIgnoreCase("AD_Language"))?"0":strSsorel_Invoiceorder_V_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
          
          Relateddocuments61F10CD06CE340909E25AE780B6D0C62Data.updateDocAction(this, strdocaction, strSsorel_Invoiceorder_V_ID);
        ...
        params.put("Ssorel_Invoiceorder_V_ID", strSsorel_Invoiceorder_V_ID);
        ...
        String strSsorel_Invoiceorder_V_ID = vars.getGlobalVariable("inpssorelInvoiceorderVId", windowId + "|Ssorel_Invoiceorder_V_ID", "");
        String strTableId = "6A1681582A6940E2BC4BB1B12A5D0833";
        String strProcessId = "";
        ...
        vars.setSessionValue("CreateFrom|key", strSsorel_Invoiceorder_V_ID);
        ...
        vars.setSessionValue("CreateFrom|tabName", "Relateddocuments61F10CD06CE340909E25AE780B6D0C62");
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          OBError myError = Utility.translateError(this, vars, vars.getLanguage(), Utility.messageBD(this, "NoWriteAccess", vars.getLanguage()));
          vars.setMessage(tabId, myError);
          printPageClosePopUp(response, vars);
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          vars.setSessionValue("Posted|key", strSsorel_Invoiceorder_V_ID);
          ...
          vars.setSessionValue("Posted|tabName", "Relateddocuments61F10CD06CE340909E25AE780B6D0C62");
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonDocAction111(HttpServletResponse response, VariablesSecureApp vars, String strSsorel_Invoiceorder_V_ID, String strdocaction, String strProcessing, String strdocstatus, String stradTableId)
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("key", strSsorel_Invoiceorder_V_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Relateddocuments61F10CD06CE340909E25AE780B6D0C62_Edition.html");
...
xmlDocument.setParameter("array", dact.toString());
    ...
    void printPageButtonCalculate_Promotions9EB2228A60684C0DBEC12D5CD8D85218(HttpServletResponse response, VariablesSecureApp vars, String strSsorel_Invoiceorder_V_ID, String strcalculatePromotions, String strProcessing)
    throws IOException, ServletException {
