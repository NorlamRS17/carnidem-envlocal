  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("C59D80628EAC461CA227D7ABAD089FA0")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("C59D80628EAC461CA227D7ABAD089FA0");
        SessionInfo.setModuleId("B0801CBD73C74727AA4E27E8B2C206F6");
      }
      ...
      if (command.contains("514BA7125E514741BB76B2B4B83901BD")) {
        ...
        SessionInfo.setModuleId("A9A8BBC6E6F74E1F82E848E7E892137D");
      ...
      if (explicitAccess.contains("C59D80628EAC461CA227D7ABAD089FA0") || (securedProcess && command.contains("C59D80628EAC461CA227D7ABAD089FA0"))) {
        classInfo.type = "P";
        classInfo.id = "C59D80628EAC461CA227D7ABAD089FA0";
      }
...
String stradTableId = "259";
        ...
        vars.setSessionValue("button514BA7125E514741BB76B2B4B83901BD.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button514BA7125E514741BB76B2B4B83901BD.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("button514BA7125E514741BB76B2B4B83901BD.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "514BA7125E514741BB76B2B4B83901BD", request.getServletPath());    
     } else if (vars.commandIn("BUTTON514BA7125E514741BB76B2B4B83901BD")) {
        String strC_Order_ID = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID", "");
        String stremCscopvVoid = vars.getSessionValue("button514BA7125E514741BB76B2B4B83901BD.stremCscopvVoid");
        String strProcessing = vars.getSessionValue("button514BA7125E514741BB76B2B4B83901BD.strProcessing");
        String strOrg = vars.getSessionValue("button514BA7125E514741BB76B2B4B83901BD.strOrg");
        String strClient = vars.getSessionValue("button514BA7125E514741BB76B2B4B83901BD.strClient");
    ...
    } else if (vars.commandIn("BUTTONEM_Obdisc_AddpackC59D80628EAC461CA227D7ABAD089FA0")) {
        vars.setSessionValue("buttonC59D80628EAC461CA227D7ABAD089FA0.stremObdiscAddpack", vars.getStringParameter("inpemObdiscAddpack"));
        vars.setSessionValue("buttonC59D80628EAC461CA227D7ABAD089FA0.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("buttonC59D80628EAC461CA227D7ABAD089FA0.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("buttonC59D80628EAC461CA227D7ABAD089FA0.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("buttonC59D80628EAC461CA227D7ABAD089FA0.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "C59D80628EAC461CA227D7ABAD089FA0", request.getServletPath());
      } else if (vars.commandIn("BUTTONC59D80628EAC461CA227D7ABAD089FA0")) {
        String strC_Order_ID = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID", "");
        String stremObdiscAddpack = vars.getSessionValue("buttonC59D80628EAC461CA227D7ABAD089FA0.stremObdiscAddpack");
        String strProcessing = vars.getSessionValue("buttonC59D80628EAC461CA227D7ABAD089FA0.strProcessing");
        String strOrg = vars.getSessionValue("buttonC59D80628EAC461CA227D7ABAD089FA0.strOrg");
        String strClient = vars.getSessionValue("buttonC59D80628EAC461CA227D7ABAD089FA0.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Obdisc_AddpackC59D80628EAC461CA227D7ABAD089FA0(response, vars, strC_Order_ID, stremObdiscAddpack, strProcessing);
        }
...
params.put("recalculateprices", strrecalculateprices);
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONEM_Obdisc_AddpackC59D80628EAC461CA227D7ABAD089FA0")) {
        String strC_Order_ID = vars.getGlobalVariable("inpKey", windowId + "|C_Order_ID", "");
        
        ProcessBundle pb = new ProcessBundle("C59D80628EAC461CA227D7ABAD089FA0", vars).init(this);
        HashMap<String, Object> params= new HashMap<String, Object>();
...
xmlDocument.setParameter("array", dact.toString());
    ...
    throws IOException, ServletException {
      ...
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Cscopv_Void514BA7125E514741BB76B2B4B83901BD", discard).createXmlDocument();
      xmlDocument.setParameter("key", strC_Order_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "514BA7125E514741BB76B2B4B83901BD");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
...
comboTableData = null;
    ...
    void printPageButtonEM_Obdisc_AddpackC59D80628EAC461CA227D7ABAD089FA0(HttpServletResponse response, VariablesSecureApp vars, String strC_Order_ID, String stremObdiscAddpack, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process C59D80628EAC461CA227D7ABAD089FA0");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Obdisc_AddpackC59D80628EAC461CA227D7ABAD089FA0", discard).createXmlDocument();
      xmlDocument.setParameter("key", strC_Order_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "C59D80628EAC461CA227D7ABAD089FA0");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("buttonC59D80628EAC461CA227D7ABAD089FA0.originalParams"), comboTableData, windowId, "");
