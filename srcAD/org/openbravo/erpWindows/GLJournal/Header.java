  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("254354AEAC1645369FC71F81415993EB")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("254354AEAC1645369FC71F81415993EB");
        SessionInfo.setModuleId("6FC7BEFF500840D8919938BB0FB21FFA");
      }
      ...
      if (explicitAccess.contains("254354AEAC1645369FC71F81415993EB") || (securedProcess && command.contains("254354AEAC1645369FC71F81415993EB"))) {
        classInfo.type = "P";
        classInfo.id = "254354AEAC1645369FC71F81415993EB";
      }
...
String stradTableId = "224";
    ...
    } else if (vars.commandIn("BUTTONEM_Sliae_Loadacct254354AEAC1645369FC71F81415993EB")) {
        vars.setSessionValue("button254354AEAC1645369FC71F81415993EB.stremSliaeLoadacct", vars.getStringParameter("inpemSliaeLoadacct"));
        vars.setSessionValue("button254354AEAC1645369FC71F81415993EB.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button254354AEAC1645369FC71F81415993EB.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button254354AEAC1645369FC71F81415993EB.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("button254354AEAC1645369FC71F81415993EB.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "254354AEAC1645369FC71F81415993EB", request.getServletPath());
      } else if (vars.commandIn("BUTTON254354AEAC1645369FC71F81415993EB")) {
        String strGL_Journal_ID = vars.getGlobalVariable("inpglJournalId", windowId + "|GL_Journal_ID", "");
        String stremSliaeLoadacct = vars.getSessionValue("button254354AEAC1645369FC71F81415993EB.stremSliaeLoadacct");
        String strProcessing = vars.getSessionValue("button254354AEAC1645369FC71F81415993EB.strProcessing");
        String strOrg = vars.getSessionValue("button254354AEAC1645369FC71F81415993EB.strOrg");
        String strClient = vars.getSessionValue("button254354AEAC1645369FC71F81415993EB.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Sliae_Loadacct254354AEAC1645369FC71F81415993EB(response, vars, strGL_Journal_ID, stremSliaeLoadacct, strProcessing);
        }
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONEM_Sliae_Loadacct254354AEAC1645369FC71F81415993EB")) {
        String strGL_Journal_ID = vars.getGlobalVariable("inpKey", windowId + "|GL_Journal_ID", "");
        
        ProcessBundle pb = new ProcessBundle("254354AEAC1645369FC71F81415993EB", vars).init(this);
        HashMap<String, Object> params= new HashMap<String, Object>();
...
xmlDocument.setParameter("array", dact.toString());
    ...
    void printPageButtonEM_Sliae_Loadacct254354AEAC1645369FC71F81415993EB(HttpServletResponse response, VariablesSecureApp vars, String strGL_Journal_ID, String stremSliaeLoadacct, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 254354AEAC1645369FC71F81415993EB");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Sliae_Loadacct254354AEAC1645369FC71F81415993EB", discard).createXmlDocument();
      xmlDocument.setParameter("key", strGL_Journal_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "254354AEAC1645369FC71F81415993EB");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
