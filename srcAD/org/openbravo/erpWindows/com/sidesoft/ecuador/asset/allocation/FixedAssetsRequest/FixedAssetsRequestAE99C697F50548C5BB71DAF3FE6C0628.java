...
public class FixedAssetsRequestAE99C697F50548C5BB71DAF3FE6C0628 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "5117C70DACDF4EADA8EB43916139BC77";
  private static final String tabId = "AE99C697F50548C5BB71DAF3FE6C0628";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
        ...
        String strSsal_Active_Main_ID = vars.getGlobalVariable("inpssalActiveMainId", windowId + "|Ssal_Active_Main_ID", "");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonProcess_Request3A53E5B4438A432EA7F48FD4A4FB9992(response, vars, strSsal_Active_Main_ID, strprocessRequest, strProcessing);
        }


    } else if (vars.commandIn("SAVE_BUTTONProcess_Request3A53E5B4438A432EA7F48FD4A4FB9992")) {
        String strSsal_Active_Main_ID = vars.getGlobalVariable("inpKey", windowId + "|Ssal_Active_Main_ID", "");
        
        ProcessBundle pb = new ProcessBundle("3A53E5B4438A432EA7F48FD4A4FB9992", vars).init(this);
        HashMap<String, Object> params= new HashMap<String, Object>();
       
        params.put("Ssal_Active_Main_ID", strSsal_Active_Main_ID);
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonProcess_Request3A53E5B4438A432EA7F48FD4A4FB9992(HttpServletResponse response, VariablesSecureApp vars, String strSsal_Active_Main_ID, String strprocessRequest, String strProcessing)
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("key", strSsal_Active_Main_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "FixedAssetsRequestAE99C697F50548C5BB71DAF3FE6C0628_Edition.html");
