...
public class ReconciliationsFF8080813320657F0133209DE21B0042 extends HttpSecureAppServlet {
  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("4561D06CE99F485CB70E213EF48D9192")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("4561D06CE99F485CB70E213EF48D9192");
        SessionInfo.setModuleId("F96807E5A0A446B1BF0933FD3AF93D5F");
        if (securedProcess || explicitAccess.contains("4561D06CE99F485CB70E213EF48D9192")) {
          classInfo.type = "P";
          classInfo.id = "4561D06CE99F485CB70E213EF48D9192";
        }
      }
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
     ...
     } else if (vars.commandIn("BUTTONEM_Ssfi_Reverse4561D06CE99F485CB70E213EF48D9192")) {
        vars.setSessionValue("button4561D06CE99F485CB70E213EF48D9192.stremSsfiReverse", vars.getStringParameter("inpemSsfiReverse"));
        vars.setSessionValue("button4561D06CE99F485CB70E213EF48D9192.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button4561D06CE99F485CB70E213EF48D9192.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button4561D06CE99F485CB70E213EF48D9192.strClient", vars.getStringParameter("inpadClientId"));
        ...
        vars.setSessionObject("button4561D06CE99F485CB70E213EF48D9192.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "4561D06CE99F485CB70E213EF48D9192", request.getServletPath());    
     } else if (vars.commandIn("BUTTON4561D06CE99F485CB70E213EF48D9192")) {
        String strFIN_Reconciliation_ID = vars.getGlobalVariable("inpfinReconciliationId", windowId + "|FIN_Reconciliation_ID", "");
        String stremSsfiReverse = vars.getSessionValue("button4561D06CE99F485CB70E213EF48D9192.stremSsfiReverse");
        String strProcessing = vars.getSessionValue("button4561D06CE99F485CB70E213EF48D9192.strProcessing");
        String strOrg = vars.getSessionValue("button4561D06CE99F485CB70E213EF48D9192.strOrg");
        String strClient = vars.getSessionValue("button4561D06CE99F485CB70E213EF48D9192.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Ssfi_Reverse4561D06CE99F485CB70E213EF48D9192(response, vars, strFIN_Reconciliation_ID, stremSsfiReverse, strProcessing);
        }
...
p.put("Processed", vars.getStringParameter("inpprocessed"));
    ...
    } else if (vars.commandIn("SAVE_BUTTONEM_Ssfi_Reverse4561D06CE99F485CB70E213EF48D9192")) {
        String strFIN_Reconciliation_ID = vars.getGlobalVariable("inpKey", windowId + "|FIN_Reconciliation_ID", "");
        String stremSsfiReverse = vars.getStringParameter("inpemSsfiReverse");
        String strProcessing = vars.getStringParameter("inpprocessing");
        OBError myMessage = null;
        try {
          String pinstance = SequenceIdData.getUUID();
          PInstanceProcessData.insertPInstance(this, pinstance, "4561D06CE99F485CB70E213EF48D9192", (("FIN_Reconciliation_ID".equalsIgnoreCase("AD_Language"))?"0":strFIN_Reconciliation_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
...
params.put("action", straction);
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonEM_Ssfi_Reverse4561D06CE99F485CB70E213EF48D9192(HttpServletResponse response, VariablesSecureApp vars, String strFIN_Reconciliation_ID, String stremSsfiReverse, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 4561D06CE99F485CB70E213EF48D9192");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Ssfi_Reverse4561D06CE99F485CB70E213EF48D9192", discard).createXmlDocument();
      ...
      xmlDocument.setParameter("processId", "4561D06CE99F485CB70E213EF48D9192");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("4561D06CE99F485CB70E213EF48D9192");
        vars.removeMessage("4561D06CE99F485CB70E213EF48D9192");
        if (myMessage!=null) {
