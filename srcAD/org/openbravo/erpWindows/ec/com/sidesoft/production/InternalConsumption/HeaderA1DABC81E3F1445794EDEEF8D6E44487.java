...
package org.openbravo.erpWindows.ec.com.sidesoft.production.InternalConsumption;
...
public class HeaderA1DABC81E3F1445794EDEEF8D6E44487 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "C5FAE6AAFF89405ABAB9AA1478A11634";
  private static final String tabId = "A1DABC81E3F1445794EDEEF8D6E44487";
  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("800131")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("800131");
        SessionInfo.setModuleId("0");
        if (securedProcess || explicitAccess.contains("800131")) {
          classInfo.type = "P";
          classInfo.id = "800131";
        }
      }
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
        ...
        p.put("Status", vars.getStringParameter("inpstatus"));
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "action", straction, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          vars.setSessionValue("Posted|key", strM_Internal_Consumption_ID);
          ...
          vars.setSessionValue("Posted|tabName", "HeaderA1DABC81E3F1445794EDEEF8D6E44487");
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonProcessing800131(HttpServletResponse response, VariablesSecureApp vars, String strM_Internal_Consumption_ID, String strprocessing, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 800131");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/Processing800131", discard).createXmlDocument();
      xmlDocument.setParameter("key", strM_Internal_Consumption_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "HeaderA1DABC81E3F1445794EDEEF8D6E44487_Edition.html");
      xmlDocument.setParameter("window", windowId);
      xmlDocument.setParameter("css", vars.getTheme());
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "800131");
    ...
    comboTableData = new ComboTableData(vars, this, "17", "action", "657B89EF105149F2B011CF8F5034FF92", "C5A7AABB91A440EBAA53A0222B99FF2F", Utility.getContext(this, vars, "#AccessibleOrgTree", ""), Utility.getContext(this, vars, "#User_Client", ""), 0);
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button800131.originalParams"), comboTableData, windowId, "");
