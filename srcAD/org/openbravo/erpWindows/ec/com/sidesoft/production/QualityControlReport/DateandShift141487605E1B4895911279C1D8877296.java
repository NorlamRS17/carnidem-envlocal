...
package org.openbravo.erpWindows.ec.com.sidesoft.production.QualityControlReport;
...
public class DateandShift141487605E1B4895911279C1D8877296 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "B997A55D42144D0495AE707E49A593A4";
  private static final String tabId = "141487605E1B4895911279C1D8877296";
  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("C14ACFDEF17E458E90AD6072C93D78D8")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("C14ACFDEF17E458E90AD6072C93D78D8");
        SessionInfo.setModuleId("14F37E1BF8DF4FA38F64F2E7E86701B7");
      }
      ...
      if (explicitAccess.contains("C14ACFDEF17E458E90AD6072C93D78D8") || (securedProcess && command.contains("C14ACFDEF17E458E90AD6072C93D78D8"))) {
        classInfo.type = "P";
        classInfo.id = "C14ACFDEF17E458E90AD6072C93D78D8";
      }
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
    ...
    } else if (vars.commandIn("BUTTONEM_Crprod_CompletedfpqC14ACFDEF17E458E90AD6072C93D78D8")) {
        vars.setSessionValue("buttonC14ACFDEF17E458E90AD6072C93D78D8.stremCrprodCompletedfpq", vars.getStringParameter("inpemCrprodCompletedfpq"));
        vars.setSessionValue("buttonC14ACFDEF17E458E90AD6072C93D78D8.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("buttonC14ACFDEF17E458E90AD6072C93D78D8.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("buttonC14ACFDEF17E458E90AD6072C93D78D8.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("buttonC14ACFDEF17E458E90AD6072C93D78D8.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "C14ACFDEF17E458E90AD6072C93D78D8", request.getServletPath());
      } else if (vars.commandIn("BUTTONC14ACFDEF17E458E90AD6072C93D78D8")) {
        String strMA_Measure_Shift_ID = vars.getGlobalVariable("inpmaMeasureShiftId", windowId + "|MA_Measure_Shift_ID", "");
        String stremCrprodCompletedfpq = vars.getSessionValue("buttonC14ACFDEF17E458E90AD6072C93D78D8.stremCrprodCompletedfpq");
        String strProcessing = vars.getSessionValue("buttonC14ACFDEF17E458E90AD6072C93D78D8.strProcessing");
        String strOrg = vars.getSessionValue("buttonC14ACFDEF17E458E90AD6072C93D78D8.strOrg");
        String strClient = vars.getSessionValue("buttonC14ACFDEF17E458E90AD6072C93D78D8.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Crprod_CompletedfpqC14ACFDEF17E458E90AD6072C93D78D8(response, vars, strMA_Measure_Shift_ID, stremCrprodCompletedfpq, strProcessing);
        }
...
params.put("emCrprodMovemennogen", stremCrprodMovemennogen);
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONEM_Crprod_CompletedfpqC14ACFDEF17E458E90AD6072C93D78D8")) {
        String strMA_Measure_Shift_ID = vars.getGlobalVariable("inpKey", windowId + "|MA_Measure_Shift_ID", "");
        
        ProcessBundle pb = new ProcessBundle("C14ACFDEF17E458E90AD6072C93D78D8", vars).init(this);
        HashMap<String, Object> params= new HashMap<String, Object>();
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "DateandShift141487605E1B4895911279C1D8877296_Edition.html");
    ...
    void printPageButtonEM_Crprod_CompletedfpqC14ACFDEF17E458E90AD6072C93D78D8(HttpServletResponse response, VariablesSecureApp vars, String strMA_Measure_Shift_ID, String stremCrprodCompletedfpq, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process C14ACFDEF17E458E90AD6072C93D78D8");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Crprod_CompletedfpqC14ACFDEF17E458E90AD6072C93D78D8", discard).createXmlDocument();
      xmlDocument.setParameter("key", strMA_Measure_Shift_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "DateandShift141487605E1B4895911279C1D8877296_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "C14ACFDEF17E458E90AD6072C93D78D8");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
