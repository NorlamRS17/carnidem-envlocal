...
OB.ManagerReservation = OB.ManagerReservation || {};
 ...
 */
OB.ManagerReservation.QuantityValidate = function (
  item,
  validator,
  value,
  record
...
OB.ManagerReservation.PrereservationQuantityValidate = function (
  item,
  validator,
  value,
  record
  ...
  var reservedQty = isc.isA.Number(record.reservedQty)
    ...
    orderedQuantity = isc.isA.Number(record.orderedQuantity)
      ...
      : BigDecimal.prototype.ZERO,
    deliveredQuantity = isc.isA.Number(record.deliveredQuantity)
      ? new BigDecimal(String(record.deliveredQuantity))
      : BigDecimal.prototype.ZERO,
  ...
  if (solTotalReserved.compareTo(orderedQuantity) != 0) {
    isc.warn(
      OB.I18N.getLabel("SSORRES_MustBeTheSame", [
