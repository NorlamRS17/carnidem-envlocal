...
public class AttributeSetInstanceValue {
  ...
  public AttributeSetInstanceValue(String strlot, String strserno, String strguaranteedate,String juliandate,
    ...
    this.juliandate = juliandate == null ? "" : juliandate;
  ...
  public void setJulianDate(String _data) {
	    this.juliandate = _data == null ? "" : _data;
	  }

  public String getJulianDate() {
	  return ((this.juliandate == null) ? "" : this.juliandate);
  }
    ...
    try {
      ...
      if ((!strInstance.equals("")) && (isinstance)) {
        ...
        if (AttributeSetInstanceValueData.updateHeader(conn, conProv, vars.getUser(),
            data[0].mAttributesetId, serno, lot, guaranteedate, "", locked, lockDescription,juliandate,
            strInstance) == 0) {
