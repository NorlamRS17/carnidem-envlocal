...
class AgingData implements Comparable<AgingData> {
  ...
  public AgingData(String BPartnerID, String BPartner, BigDecimal current, BigDecimal amount1,
      ...
      BigDecimal amount11, BigDecimal amount12, BigDecimal amount13, BigDecimal amount14,
      BigDecimal credit, BigDecimal doubtfulDebt, Date dueDate) {
    ...
    this.taxId = taxId;
    this.amount011 = this.total = current.add(amount1).add(amount2).add(amount3).add(amount4)
        .add(amount5).add(amount11).add(amount12).add(amount13).add(amount14);
    this.credit = credit;
  ...
  public AgingData(String BPartnerID, String BPartner, BigDecimal amount, int index) {
    ...
    this.amount11 = BigDecimal.ZERO;
    this.amount12 = BigDecimal.ZERO;
    this.amount13 = BigDecimal.ZERO;
    this.amount14 = BigDecimal.ZERO;
    ...
    this.amount011 = BigDecimal.ZERO;
    this.taxId = BigDecimal.ZERO;
  ...
  public void addAmount(BigDecimal amt, int index) {
    switch (index) {
    case -4: {
      this.amount14 = this.current.add(amt);
      break;
    }
    case -3: {
      this.amount13 = this.current.add(amt);
      break;
    }
    case -2: {
      this.amount12 = this.current.add(amt);
      break;
    }
    case -1: {
      this.amount11 = this.current.add(amt);
      break;
    }
    case 0: {
  ...
  public BigDecimal[] getAmount() {
    BigDecimal[] auxBigDecimal = { this.current, this.amount1, this.amount2, this.amount3,
        this.amount4, this.amount5, this.amount11, this.amount12, this.amount13, this.amount14 };
