...
public class CommissionAmount extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCOMSTSALEPERCENTAGE = "scomstSalePercentage";
    public static final String PROPERTY_SCOMSTOPERATINGPROFIT = "scomstOperatingProfit";
    ...
    public CommissionAmount() {
        ...
        setDefaultValue(PROPERTY_SCOMSTSALEPERCENTAGE, new BigDecimal(0));
        setDefaultValue(PROPERTY_SCOMSTOPERATINGPROFIT, new BigDecimal(0));
    ...
    public BigDecimal getScomstSalePercentage() {
        return (BigDecimal) get(PROPERTY_SCOMSTSALEPERCENTAGE);
    }

    public void setScomstSalePercentage(BigDecimal scomstSalePercentage) {
        set(PROPERTY_SCOMSTSALEPERCENTAGE, scomstSalePercentage);
    }

    public BigDecimal getScomstOperatingProfit() {
        return (BigDecimal) get(PROPERTY_SCOMSTOPERATINGPROFIT);
    }

    public void setScomstOperatingProfit(BigDecimal scomstOperatingProfit) {
        set(PROPERTY_SCOMSTOPERATINGPROFIT, scomstOperatingProfit);
    }
