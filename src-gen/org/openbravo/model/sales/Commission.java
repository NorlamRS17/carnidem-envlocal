...
public class Commission extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCOMSTGRACEDAYS = "scomstGraceDays";
    public static final String PROPERTY_CASCADE = "cascade";
    public static final String PROPERTY_SCOMSTSALESBUDGET = "scomstSalesBudget";
    public static final String PROPERTY_SCOMSTCOLLECTIONRATIO = "scomstCollectionRatio";
    ...
    public Long getScomstGraceDays() {
        return (Long) get(PROPERTY_SCOMSTGRACEDAYS);
    }

    public void setScomstGraceDays(Long scomstGraceDays) {
        set(PROPERTY_SCOMSTGRACEDAYS, scomstGraceDays);
    }
    ...
    public BigDecimal getScomstSalesBudget() {
        return (BigDecimal) get(PROPERTY_SCOMSTSALESBUDGET);
    }

    public void setScomstSalesBudget(BigDecimal scomstSalesBudget) {
        set(PROPERTY_SCOMSTSALESBUDGET, scomstSalesBudget);
    }

    public BigDecimal getScomstCollectionRatio() {
        return (BigDecimal) get(PROPERTY_SCOMSTCOLLECTIONRATIO);
    }

    public void setScomstCollectionRatio(BigDecimal scomstCollectionRatio) {
        set(PROPERTY_SCOMSTCOLLECTIONRATIO, scomstCollectionRatio);
    }
