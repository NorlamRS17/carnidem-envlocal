...
public class CommissionDetail extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCOMSTCOMMISSIONAMOUNT = "scomstCommissionAmount";
    public static final String PROPERTY_SCOMSTBPARTNER = "scomstBpartner";
    public static final String PROPERTY_SCOMSTPAIDDATE = "scomstPaidDate";
    public static final String PROPERTY_SCOMSTDATEINVOICED = "scomstDateInvoiced";
    public static final String PROPERTY_SCOMSTDUEDATE = "scomstDueDate";
    ...
    public BigDecimal getScomstCommissionAmount() {
        return (BigDecimal) get(PROPERTY_SCOMSTCOMMISSIONAMOUNT);
    }

    public void setScomstCommissionAmount(BigDecimal scomstCommissionAmount) {
        set(PROPERTY_SCOMSTCOMMISSIONAMOUNT, scomstCommissionAmount);
    }

    public BusinessPartner getScomstBpartner() {
        return (BusinessPartner) get(PROPERTY_SCOMSTBPARTNER);
    }

    public void setScomstBpartner(BusinessPartner scomstBpartner) {
        set(PROPERTY_SCOMSTBPARTNER, scomstBpartner);
    }

    public Date getScomstPaidDate() {
        return (Date) get(PROPERTY_SCOMSTPAIDDATE);
    }

    public void setScomstPaidDate(Date scomstPaidDate) {
        set(PROPERTY_SCOMSTPAIDDATE, scomstPaidDate);
    }

    public Date getScomstDateInvoiced() {
        return (Date) get(PROPERTY_SCOMSTDATEINVOICED);
    }

    public void setScomstDateInvoiced(Date scomstDateInvoiced) {
        set(PROPERTY_SCOMSTDATEINVOICED, scomstDateInvoiced);
    }

    public Date getScomstDueDate() {
        return (Date) get(PROPERTY_SCOMSTDUEDATE);
    }

    public void setScomstDueDate(Date scomstDueDate) {
        set(PROPERTY_SCOMSTDUEDATE, scomstDueDate);
    }
