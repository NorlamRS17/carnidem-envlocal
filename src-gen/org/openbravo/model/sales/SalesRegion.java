...
public class SalesRegion extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ORGANIZATIONEMSSCDIMCSALESREGIONIDLIST = "organizationEMSscdimCSalesregionIDList";
    ...
    public SalesRegion() {
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONEMSSCDIMCSALESREGIONIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMSscdimCSalesregionIDList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMSSCDIMCSALESREGIONIDLIST);
    }

    public void setOrganizationEMSscdimCSalesregionIDList(List<Organization> organizationEMSscdimCSalesregionIDList) {
        set(PROPERTY_ORGANIZATIONEMSSCDIMCSALESREGIONIDLIST, organizationEMSscdimCSalesregionIDList);
    }
