...
public class PurchasingRun extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSMRPTYPECALCULATION = "ssmrpTypeCalculation";
    public static final String PROPERTY_SSMRPDATEDOCUMENT = "ssmrpDateDocument";
    public static final String PROPERTY_SSMRPBRAND = "ssmrpBrand";
    public static final String PROPERTY_SSMRPA = "ssmrpA";
    public static final String PROPERTY_SSMRPB = "ssmrpB";
    public static final String PROPERTY_SSMRPC = "ssmrpC";
    ...
    public PurchasingRun() {
        ...
        setDefaultValue(PROPERTY_SSMRPA, (long) 80);
        setDefaultValue(PROPERTY_SSMRPB, (long) 15);
        setDefaultValue(PROPERTY_SSMRPC, (long) 5);
    ...
    public String getSsmrpTypeCalculation() {
        return (String) get(PROPERTY_SSMRPTYPECALCULATION);
    }

    public void setSsmrpTypeCalculation(String ssmrpTypeCalculation) {
        set(PROPERTY_SSMRPTYPECALCULATION, ssmrpTypeCalculation);
    }

    public Date getSsmrpDateDocument() {
        return (Date) get(PROPERTY_SSMRPDATEDOCUMENT);
    }

    public void setSsmrpDateDocument(Date ssmrpDateDocument) {
        set(PROPERTY_SSMRPDATEDOCUMENT, ssmrpDateDocument);
    }

    public Brand getSsmrpBrand() {
        return (Brand) get(PROPERTY_SSMRPBRAND);
    }

    public void setSsmrpBrand(Brand ssmrpBrand) {
        set(PROPERTY_SSMRPBRAND, ssmrpBrand);
    }

    public Long getSsmrpA() {
        return (Long) get(PROPERTY_SSMRPA);
    }

    public void setSsmrpA(Long ssmrpA) {
        set(PROPERTY_SSMRPA, ssmrpA);
    }

    public Long getSsmrpB() {
        return (Long) get(PROPERTY_SSMRPB);
    }

    public void setSsmrpB(Long ssmrpB) {
        set(PROPERTY_SSMRPB, ssmrpB);
    }

    public Long getSsmrpC() {
        return (Long) get(PROPERTY_SSMRPC);
    }

    public void setSsmrpC(Long ssmrpC) {
        set(PROPERTY_SSMRPC, ssmrpC);
    }
