...
public class InventoryCount extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSWHISTRANSFORMATION = "sswhIstransformation";
    ...
    public static final String PROPERTY_SSIPDVKEY = "ssipdvKey";
    public static final String PROPERTY_SSCIRPRINTMVNT = "sscirPrintmvnt";
    public static final String PROPERTY_SSIPDVKEYAUTH = "ssipdvKeyAuth";
    public static final String PROPERTY_SSIPDVGENERATEKEY = "ssipdvGenerateKey";
    public static final String PROPERTY_SSIPDVDATEKEY = "ssipdvDateKey";
    public static final String PROPERTY_SSIPDVSTATUSKEY = "ssipdvStatusKey";
    ...
    public static final String PROPERTY_ATINDPOPOSTVENTAEMSATMACINVENTORYIDLIST = "atindpoPostventaEMSatmacInventoryIDList";
    ...
    public InventoryCount() {
        ...
        setDefaultValue(PROPERTY_SSWHISTRANSFORMATION, false);
        setDefaultValue(PROPERTY_INVENTORYTYPE, "N");
        setDefaultValue(PROPERTY_SSCIRPRINTMVNT, false);
        setDefaultValue(PROPERTY_SSIPDVGENERATEKEY, false);
        ...
        setDefaultValue(PROPERTY_ATINDPOPOSTVENTAEMSATMACINVENTORYIDLIST, new ArrayList<Object>());
    }
    ...
    public Boolean isSswhIstransformation() {
        return (Boolean) get(PROPERTY_SSWHISTRANSFORMATION);
    }

    public void setSswhIstransformation(Boolean sswhIstransformation) {
        set(PROPERTY_SSWHISTRANSFORMATION, sswhIstransformation);
    }
    ...
    public String getSsipdvKey() {
        return (String) get(PROPERTY_SSIPDVKEY);
    }

    public void setSsipdvKey(String ssipdvKey) {
        set(PROPERTY_SSIPDVKEY, ssipdvKey);
    }

    public Boolean isSscirPrintmvnt() {
        return (Boolean) get(PROPERTY_SSCIRPRINTMVNT);
    }

    public void setSscirPrintmvnt(Boolean sscirPrintmvnt) {
        set(PROPERTY_SSCIRPRINTMVNT, sscirPrintmvnt);
    }

    public String getSsipdvKeyAuth() {
        return (String) get(PROPERTY_SSIPDVKEYAUTH);
    }

    public void setSsipdvKeyAuth(String ssipdvKeyAuth) {
        set(PROPERTY_SSIPDVKEYAUTH, ssipdvKeyAuth);
    }

    public Boolean isSsipdvGenerateKey() {
        return (Boolean) get(PROPERTY_SSIPDVGENERATEKEY);
    }

    public void setSsipdvGenerateKey(Boolean ssipdvGenerateKey) {
        set(PROPERTY_SSIPDVGENERATEKEY, ssipdvGenerateKey);
    }

    public Date getSsipdvDateKey() {
        return (Date) get(PROPERTY_SSIPDVDATEKEY);
    }

    public void setSsipdvDateKey(Date ssipdvDateKey) {
        set(PROPERTY_SSIPDVDATEKEY, ssipdvDateKey);
    }

    public String getSsipdvStatusKey() {
        return (String) get(PROPERTY_SSIPDVSTATUSKEY);
    }

    public void setSsipdvStatusKey(String ssipdvStatusKey) {
        set(PROPERTY_SSIPDVSTATUSKEY, ssipdvStatusKey);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<atindpo_postventa> getAtindpoPostventaEMSatmacInventoryIDList() {
      return (List<atindpo_postventa>) get(PROPERTY_ATINDPOPOSTVENTAEMSATMACINVENTORYIDLIST);
    }

    public void setAtindpoPostventaEMSatmacInventoryIDList(List<atindpo_postventa> atindpoPostventaEMSatmacInventoryIDList) {
        set(PROPERTY_ATINDPOPOSTVENTAEMSATMACINVENTORYIDLIST, atindpoPostventaEMSatmacInventoryIDList);
    }
