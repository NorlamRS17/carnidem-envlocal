...
public class ProductionTransaction extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSWHCALCULECOSTE = "sswhCalculecoste";
    public static final String PROPERTY_ASSET = "asset";
    public static final String PROPERTY_OBBOMCORDER = "obbomCOrder";
    public static final String PROPERTY_SPDAIDOCUMENTTYPE = "spdaiDocumentType";
    public static final String PROPERTY_SPINLCINVOICE = "spinlCInvoice";
    public static final String PROPERTY_SPINLACTIONBUTTON = "spinlActionbutton";
    public static final String PROPERTY_SPINLMLOCATOR = "spinlMLocator";
    public static final String PROPERTY_MANUFACTURINGGLOBALUSELIST = "manufacturingGlobalUseList";
    public static final String PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYWORKEFFORTIDLIST = "manufacturingMeasureShiftEMSpqulyWorkeffortIDList";
    ...
    public ProductionTransaction() {
        ...
        setDefaultValue(PROPERTY_SSWHCALCULECOSTE, false);
        setDefaultValue(PROPERTY_SPINLACTIONBUTTON, false);
        setDefaultValue(PROPERTY_MANUFACTURINGGLOBALUSELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYWORKEFFORTIDLIST, new ArrayList<Object>());
    ...
    public Boolean isSswhCalculecoste() {
        return (Boolean) get(PROPERTY_SSWHCALCULECOSTE);
    }

    public void setSswhCalculecoste(Boolean sswhCalculecoste) {
        set(PROPERTY_SSWHCALCULECOSTE, sswhCalculecoste);
    }
    ...
    public Order getObbomCOrder() {
        return (Order) get(PROPERTY_OBBOMCORDER);
    }

    public void setObbomCOrder(Order obbomCOrder) {
        set(PROPERTY_OBBOMCORDER, obbomCOrder);
    }

    public DocumentType getSpdaiDocumentType() {
        return (DocumentType) get(PROPERTY_SPDAIDOCUMENTTYPE);
    }

    public void setSpdaiDocumentType(DocumentType spdaiDocumentType) {
        set(PROPERTY_SPDAIDOCUMENTTYPE, spdaiDocumentType);
    }

    public Invoice getSpinlCInvoice() {
        return (Invoice) get(PROPERTY_SPINLCINVOICE);
    }

    public void setSpinlCInvoice(Invoice spinlCInvoice) {
        set(PROPERTY_SPINLCINVOICE, spinlCInvoice);
    }

    public Boolean isSpinlActionbutton() {
        return (Boolean) get(PROPERTY_SPINLACTIONBUTTON);
    }

    public void setSpinlActionbutton(Boolean spinlActionbutton) {
        set(PROPERTY_SPINLACTIONBUTTON, spinlActionbutton);
    }

    public Locator getSpinlMLocator() {
        return (Locator) get(PROPERTY_SPINLMLOCATOR);
    }

    public void setSpinlMLocator(Locator spinlMLocator) {
        set(PROPERTY_SPINLMLOCATOR, spinlMLocator);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<MeasureShift> getManufacturingMeasureShiftEMSpqulyWorkeffortIDList() {
      return (List<MeasureShift>) get(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYWORKEFFORTIDLIST);
    }

    public void setManufacturingMeasureShiftEMSpqulyWorkeffortIDList(List<MeasureShift> manufacturingMeasureShiftEMSpqulyWorkeffortIDList) {
        set(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYWORKEFFORTIDLIST, manufacturingMeasureShiftEMSpqulyWorkeffortIDList);
    }
