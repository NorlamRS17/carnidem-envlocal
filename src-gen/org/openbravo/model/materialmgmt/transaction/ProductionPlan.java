...
public class ProductionPlan extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSAPQTRANSFERRED = "ssapqTransferred";
    public static final String PROPERTY_SSCRTXTSHIFT = "sscrtxtShift";
    public static final String PROPERTY_SSPRODENVCONDITIONS = "ssprodEnvConditions";
    public static final String PROPERTY_SSPRODPSTOP = "ssprodpStop";
    public static final String PROPERTY_CRPRODCUTOUT = "crprodCutout";
    public static final String PROPERTY_SSPRODQTYSECRECH = "ssprodQtysecrech";
    ...
    public static final String PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMCRPRODPRODPLANIDLIST = "materialMgmtInternalMovementEMCrprodProdplanIDList";
    ...
    public ProductionPlan() {
        ...
        setDefaultValue(PROPERTY_SSAPQTRANSFERRED, false);
        ...
        setDefaultValue(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMCRPRODPRODPLANIDLIST, new ArrayList<Object>());
    ...
    public Boolean isSsapqTransferred() {
        return (Boolean) get(PROPERTY_SSAPQTRANSFERRED);
    }

    public void setSsapqTransferred(Boolean ssapqTransferred) {
        set(PROPERTY_SSAPQTRANSFERRED, ssapqTransferred);
    }

    public String getSscrtxtShift() {
        return (String) get(PROPERTY_SSCRTXTSHIFT);
    }

    public void setSscrtxtShift(String sscrtxtShift) {
        set(PROPERTY_SSCRTXTSHIFT, sscrtxtShift);
    }

    public String getSsprodEnvConditions() {
        return (String) get(PROPERTY_SSPRODENVCONDITIONS);
    }

    public void setSsprodEnvConditions(String ssprodEnvConditions) {
        set(PROPERTY_SSPRODENVCONDITIONS, ssprodEnvConditions);
    }
    ...
    public BigDecimal getCrprodCutout() {
        return (BigDecimal) get(PROPERTY_CRPRODCUTOUT);
    }

    public void setCrprodCutout(BigDecimal crprodCutout) {
        set(PROPERTY_CRPRODCUTOUT, crprodCutout);
    }

    public BigDecimal getSsprodQtysecrech() {
        return (BigDecimal) get(PROPERTY_SSPRODQTYSECRECH);
    }

    public void setSsprodQtysecrech(BigDecimal ssprodQtysecrech) {
        set(PROPERTY_SSPRODQTYSECRECH, ssprodQtysecrech);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<InternalMovement> getMaterialMgmtInternalMovementEMCrprodProdplanIDList() {
      return (List<InternalMovement>) get(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMCRPRODPRODPLANIDLIST);
    }

    public void setMaterialMgmtInternalMovementEMCrprodProdplanIDList(List<InternalMovement> materialMgmtInternalMovementEMCrprodProdplanIDList) {
        set(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMCRPRODPRODPLANIDLIST, materialMgmtInternalMovementEMCrprodProdplanIDList);
    }
