...
public class ShipmentInOutLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SLQSMAPERCTRL = "slqsMaPerCtrl";
    public static final String PROPERTY_SPRLIIDENTIFIER = "sprliIdentifier";
    public static final String PROPERTY_SLQSEVALQUALITY = "slqsEvalQuality";
    public static final String PROPERTY_SPROCTMCPROJECTPHASE = "sproctmCProjectphase";
    public static final String PROPERTY_SLQSCHECKQUALITY = "slqsCheckQuality";
    public static final String PROPERTY_SPROCTMCPROJECTTASK = "sproctmCProjecttask";
    public static final String PROPERTY_SSPRJPROJECTPRODUCT = "sSPRJProjectProduct";
    public static final String PROPERTY_ECSPBCONFIRM = "ecspbConfirm";
    public static final String PROPERTY_ECSPBHEAVYUNITS = "ecspbHeavyunits";
    ...
    public ShipmentInOutLine() {
        ...
        setDefaultValue(PROPERTY_ECSPBCONFIRM, false);
        setDefaultValue(PROPERTY_ECSPBHEAVYUNITS, (long) 0);
    ...
    public PeriodicControl getSlqsMaPerCtrl() {
        return (PeriodicControl) get(PROPERTY_SLQSMAPERCTRL);
    }

    public void setSlqsMaPerCtrl(PeriodicControl slqsMaPerCtrl) {
        set(PROPERTY_SLQSMAPERCTRL, slqsMaPerCtrl);
    }
    ...
    public String getSlqsEvalQuality() {
        return (String) get(PROPERTY_SLQSEVALQUALITY);
    }

    public void setSlqsEvalQuality(String slqsEvalQuality) {
        set(PROPERTY_SLQSEVALQUALITY, slqsEvalQuality);
    }

    public ProjectPhase getSproctmCProjectphase() {
        return (ProjectPhase) get(PROPERTY_SPROCTMCPROJECTPHASE);
    }

    public void setSproctmCProjectphase(ProjectPhase sproctmCProjectphase) {
        set(PROPERTY_SPROCTMCPROJECTPHASE, sproctmCProjectphase);
    }
    ...
    public ProjectTask getSproctmCProjecttask() {
        return (ProjectTask) get(PROPERTY_SPROCTMCPROJECTTASK);
    }

    public void setSproctmCProjecttask(ProjectTask sproctmCProjecttask) {
        set(PROPERTY_SPROCTMCPROJECTTASK, sproctmCProjecttask);
    }

    public SproctmTaskProd getSSPRJProjectProduct() {
        return (SproctmTaskProd) get(PROPERTY_SSPRJPROJECTPRODUCT);
    }

    public void setSSPRJProjectProduct(SproctmTaskProd sSPRJProjectProduct) {
        set(PROPERTY_SSPRJPROJECTPRODUCT, sSPRJProjectProduct);
    }

    public Boolean isEcspbConfirm() {
        return (Boolean) get(PROPERTY_ECSPBCONFIRM);
    }

    public void setEcspbConfirm(Boolean ecspbConfirm) {
        set(PROPERTY_ECSPBCONFIRM, ecspbConfirm);
    }

    public Long getEcspbHeavyunits() {
        return (Long) get(PROPERTY_ECSPBHEAVYUNITS);
    }

    public void setEcspbHeavyunits(Long ecspbHeavyunits) {
        set(PROPERTY_ECSPBHEAVYUNITS, ecspbHeavyunits);
    }
