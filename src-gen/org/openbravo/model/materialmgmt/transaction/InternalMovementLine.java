...
public class InternalMovementLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSRSRESUPPLYLINE = "ssrsResupplyline";
    ...
    public static final String PROPERTY_SMVAIISRECEIVED = "smvaiIsreceived";
    public static final String PROPERTY_SPSMVATPVL = "spsmvatPvl";
    public static final String PROPERTY_SSPRJTASKPROD = "ssprjTaskProd";
    public static final String PROPERTY_ECSPBCONFIRM = "ecspbConfirm";
    public static final String PROPERTY_CRPRODBPARTNER = "crprodBpartner";
    ...
    public InternalMovementLine() {
        ...
        setDefaultValue(PROPERTY_SMVAIISRECEIVED, false);
    ...
    public ssrsresupplyline getSsrsResupplyline() {
        return (ssrsresupplyline) get(PROPERTY_SSRSRESUPPLYLINE);
    }

    public void setSsrsResupplyline(ssrsresupplyline ssrsResupplyline) {
        set(PROPERTY_SSRSRESUPPLYLINE, ssrsResupplyline);
    }
    ...
    public Boolean isSmvaiIsreceived() {
        return (Boolean) get(PROPERTY_SMVAIISRECEIVED);
    }

    public void setSmvaiIsreceived(Boolean smvaiIsreceived) {
        set(PROPERTY_SMVAIISRECEIVED, smvaiIsreceived);
    }

    public atindpo_postventalinea getSpsmvatPvl() {
        return (atindpo_postventalinea) get(PROPERTY_SPSMVATPVL);
    }

    public void setSpsmvatPvl(atindpo_postventalinea spsmvatPvl) {
        set(PROPERTY_SPSMVATPVL, spsmvatPvl);
    }

    public SproctmTaskProd getSsprjTaskProd() {
        return (SproctmTaskProd) get(PROPERTY_SSPRJTASKPROD);
    }

    public void setSsprjTaskProd(SproctmTaskProd ssprjTaskProd) {
        set(PROPERTY_SSPRJTASKPROD, ssprjTaskProd);
    }
    ...
    public BusinessPartner getCrprodBpartner() {
        return (BusinessPartner) get(PROPERTY_CRPRODBPARTNER);
    }

    public void setCrprodBpartner(BusinessPartner crprodBpartner) {
        set(PROPERTY_CRPRODBPARTNER, crprodBpartner);
    }
