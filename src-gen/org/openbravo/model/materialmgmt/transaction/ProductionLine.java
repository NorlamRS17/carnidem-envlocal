...
public class ProductionLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSAPQISCONFIRM = "ssapqIsconfirm";
    public static final String PROPERTY_SSAPQMCONFIRM = "ssapqMconfirm";
    public static final String PROPERTY_SSAPQMUNCONFIRM = "ssapqMunconfirm";
    public static final String PROPERTY_MANUFACTURINGCASEEMSLQSMPRODLINEIDLIST = "manufacturingCaseEMSlqsMProdLineIDList";
    ...
    public ProductionLine() {
        ...
        setDefaultValue(PROPERTY_SSAPQISCONFIRM, false);
        setDefaultValue(PROPERTY_SSAPQMCONFIRM, false);
        setDefaultValue(PROPERTY_SSAPQMUNCONFIRM, false);
        setDefaultValue(PROPERTY_MANUFACTURINGCASEEMSLQSMPRODLINEIDLIST, new ArrayList<Object>());
    ...
    public Boolean isSsapqIsconfirm() {
        return (Boolean) get(PROPERTY_SSAPQISCONFIRM);
    }

    public void setSsapqIsconfirm(Boolean ssapqIsconfirm) {
        set(PROPERTY_SSAPQISCONFIRM, ssapqIsconfirm);
    }

    public Boolean isSsapqMconfirm() {
        return (Boolean) get(PROPERTY_SSAPQMCONFIRM);
    }

    public void setSsapqMconfirm(Boolean ssapqMconfirm) {
        set(PROPERTY_SSAPQMCONFIRM, ssapqMconfirm);
    }

    public Boolean isSsapqMunconfirm() {
        return (Boolean) get(PROPERTY_SSAPQMUNCONFIRM);
    }

    public void setSsapqMunconfirm(Boolean ssapqMunconfirm) {
        set(PROPERTY_SSAPQMUNCONFIRM, ssapqMunconfirm);
    }

    @SuppressWarnings("unchecked")
    public List<Case> getManufacturingCaseEMSlqsMProdLineIDList() {
      return (List<Case>) get(PROPERTY_MANUFACTURINGCASEEMSLQSMPRODLINEIDLIST);
    }

    public void setManufacturingCaseEMSlqsMProdLineIDList(List<Case> manufacturingCaseEMSlqsMProdLineIDList) {
        set(PROPERTY_MANUFACTURINGCASEEMSLQSMPRODLINEIDLIST, manufacturingCaseEMSlqsMProdLineIDList);
    }
