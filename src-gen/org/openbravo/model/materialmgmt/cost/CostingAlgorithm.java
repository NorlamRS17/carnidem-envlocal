 ...
 */
public class CostingAlgorithm extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "M_Costing_Algorithm";
    public static final String ENTITY_NAME = "CostingAlgorithm";
