...
public class ShippingCompany extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_INVOICEEMSLCISHIPPERIDLIST = "invoiceEMSlciShipperIDList";
    public static final String PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMSSRSMSHIPPERIDLIST = "materialMgmtInternalMovementEMSsrsMShipperIDList";
    public static final String PROPERTY_MATERIALMGMTSHIPMENTINOUTLIST = "materialMgmtShipmentInOutList";
    public static final String PROPERTY_MATERIALMGMTSHIPMENTINOUTEMSLCISHIPPERIDLIST = "materialMgmtShipmentInOutEMSlciShipperIDList";
    ...
    public ShippingCompany() {
        ...
        setDefaultValue(PROPERTY_INVOICEEMSLCISHIPPERIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMSSRSMSHIPPERIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_MATERIALMGMTSHIPMENTINOUTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_MATERIALMGMTSHIPMENTINOUTEMSLCISHIPPERIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Invoice> getInvoiceEMSlciShipperIDList() {
      return (List<Invoice>) get(PROPERTY_INVOICEEMSLCISHIPPERIDLIST);
    }

    public void setInvoiceEMSlciShipperIDList(List<Invoice> invoiceEMSlciShipperIDList) {
        set(PROPERTY_INVOICEEMSLCISHIPPERIDLIST, invoiceEMSlciShipperIDList);
    }

    @SuppressWarnings("unchecked")
    public List<InternalMovement> getMaterialMgmtInternalMovementEMSsrsMShipperIDList() {
      return (List<InternalMovement>) get(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMSSRSMSHIPPERIDLIST);
    }

    public void setMaterialMgmtInternalMovementEMSsrsMShipperIDList(List<InternalMovement> materialMgmtInternalMovementEMSsrsMShipperIDList) {
        set(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMSSRSMSHIPPERIDLIST, materialMgmtInternalMovementEMSsrsMShipperIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ShipmentInOut> getMaterialMgmtShipmentInOutEMSlciShipperIDList() {
      return (List<ShipmentInOut>) get(PROPERTY_MATERIALMGMTSHIPMENTINOUTEMSLCISHIPPERIDLIST);
    }

    public void setMaterialMgmtShipmentInOutEMSlciShipperIDList(List<ShipmentInOut> materialMgmtShipmentInOutEMSlciShipperIDList) {
        set(PROPERTY_MATERIALMGMTSHIPMENTINOUTEMSLCISHIPPERIDLIST, materialMgmtShipmentInOutEMSlciShipperIDList);
    }
