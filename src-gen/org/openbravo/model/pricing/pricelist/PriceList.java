...
public class PriceList extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ORGANIZATIONEMOBRETCOPRICELISTIDLIST = "organizationEMObretcoPricelistIDList";
    ...
    public static final String PROPERTY_SSPIMPLIMPORTPRICELISTLIST = "sspimplImportPriceListList";
    ...
    public PriceList() {
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONEMOBRETCOPRICELISTIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SSPIMPLIMPORTPRICELISTLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMObretcoPricelistIDList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMOBRETCOPRICELISTIDLIST);
    }

    public void setOrganizationEMObretcoPricelistIDList(List<Organization> organizationEMObretcoPricelistIDList) {
        set(PROPERTY_ORGANIZATIONEMOBRETCOPRICELISTIDLIST, organizationEMObretcoPricelistIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ImportPriceList> getSspimplImportPriceListList() {
      return (List<ImportPriceList>) get(PROPERTY_SSPIMPLIMPORTPRICELISTLIST);
    }

    public void setSspimplImportPriceListList(List<ImportPriceList> sspimplImportPriceListList) {
        set(PROPERTY_SSPIMPLIMPORTPRICELISTLIST, sspimplImportPriceListList);
    }
