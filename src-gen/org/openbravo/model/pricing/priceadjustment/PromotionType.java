...
public class PromotionType extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBPOSISCATEGORY = "obposIsCategory";
    public static final String PROPERTY_ORDERPLSQLIMPLEMENTOR = "orderPLSQLImplementor";
    public static final String PROPERTY_OBPOSIMAGE = "obposImage";
    ...
    public PromotionType() {
        ...
        setDefaultValue(PROPERTY_OBPOSISCATEGORY, false);
    ...
    public Boolean isObposIsCategory() {
        return (Boolean) get(PROPERTY_OBPOSISCATEGORY);
    }

    public void setObposIsCategory(Boolean obposIsCategory) {
        set(PROPERTY_OBPOSISCATEGORY, obposIsCategory);
    }
    ...
    public Image getObposImage() {
        return (Image) get(PROPERTY_OBPOSIMAGE);
    }

    public void setObposImage(Image obposImage) {
        set(PROPERTY_OBPOSIMAGE, obposImage);
    }
