...
public class Product extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBDISCISGIFT = "obdiscIsGift";
    public static final String PROPERTY_OBDISCQTY = "obdiscQty";
    public static final String PROPERTY_OBDISCGIFQTY = "obdiscGifqty";

    public Product() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_OBDISCISGIFT, false);
    }
    ...
    public Boolean isObdiscIsGift() {
        return (Boolean) get(PROPERTY_OBDISCISGIFT);
    }

    public void setObdiscIsGift(Boolean obdiscIsGift) {
        set(PROPERTY_OBDISCISGIFT, obdiscIsGift);
    }

    public Long getObdiscQty() {
        return (Long) get(PROPERTY_OBDISCQTY);
    }

    public void setObdiscQty(Long obdiscQty) {
        set(PROPERTY_OBDISCQTY, obdiscQty);
    }

    public Long getObdiscGifqty() {
        return (Long) get(PROPERTY_OBDISCGIFQTY);
    }

    public void setObdiscGifqty(Long obdiscGifqty) {
        set(PROPERTY_OBDISCGIFQTY, obdiscGifqty);
    }
