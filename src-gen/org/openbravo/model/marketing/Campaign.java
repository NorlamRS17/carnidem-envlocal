...
public class Campaign extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OPCRMTYPE = "opcrmType";
    public static final String PROPERTY_OPCRMIMPRESSIONS = "opcrmImpressions";
    public static final String PROPERTY_OPCRMBUDGET = "opcrmBudget";
    public static final String PROPERTY_OPCRMREVENUE = "opcrmRevenue";
    public static final String PROPERTY_OPCRMEXPECTEDCOST = "opcrmExpectedCost";
    public static final String PROPERTY_OPCRMOBJECTIVE = "opcrmObjective";
    public static final String PROPERTY_OPCRMDESCRIPTION = "opcrmDescription";
    public static final String PROPERTY_OPCRMASSIGNEDTO = "oPCRMAssignedTo";
    public static final String PROPERTY_OPCRMSTATUS = "opcrmStatus";
    public static final String PROPERTY_SSIPISIMPORT = "ssipIsimport";
    public static final String PROPERTY_SSIMPDTCDOCTYPE = "ssimpdtCDocType";
    public static final String PROPERTY_SSIMPDTDOCUMENTNO = "ssimpdtDocumentNo";
    public static final String PROPERTY_SSIMPDTDATE = "ssimpdtDate";
    ...
    public static final String PROPERTY_BUSINESSPARTNEREMOPCRMBPCCAMPAIGNLIST = "businessPartnerEMOpcrmBpCCampaignList";
    ...
    public static final String PROPERTY_INVOICELINEEMSSIPCAMPAIGNIDLIST = "invoiceLineEMSsipCampaignIDList";
    public static final String PROPERTY_INVOICELINEEMSSIPICEIMPORTICELIST = "invoiceLineEMSSIPICEImportICEList";
    ...
    public Campaign() {
        ...
        setDefaultValue(PROPERTY_BUSINESSPARTNEREMOPCRMBPCCAMPAIGNLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_INVOICELINEEMSSIPCAMPAIGNIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_INVOICELINEEMSSIPICEIMPORTICELIST, new ArrayList<Object>());
    ...
    public String getOpcrmType() {
        return (String) get(PROPERTY_OPCRMTYPE);
    }

    public void setOpcrmType(String opcrmType) {
        set(PROPERTY_OPCRMTYPE, opcrmType);
    }

    public Long getOpcrmImpressions() {
        return (Long) get(PROPERTY_OPCRMIMPRESSIONS);
    }

    public void setOpcrmImpressions(Long opcrmImpressions) {
        set(PROPERTY_OPCRMIMPRESSIONS, opcrmImpressions);
    }

    public BigDecimal getOpcrmBudget() {
        return (BigDecimal) get(PROPERTY_OPCRMBUDGET);
    }

    public void setOpcrmBudget(BigDecimal opcrmBudget) {
        set(PROPERTY_OPCRMBUDGET, opcrmBudget);
    }

    public BigDecimal getOpcrmRevenue() {
        return (BigDecimal) get(PROPERTY_OPCRMREVENUE);
    }

    public void setOpcrmRevenue(BigDecimal opcrmRevenue) {
        set(PROPERTY_OPCRMREVENUE, opcrmRevenue);
    }

    public BigDecimal getOpcrmExpectedCost() {
        return (BigDecimal) get(PROPERTY_OPCRMEXPECTEDCOST);
    }

    public void setOpcrmExpectedCost(BigDecimal opcrmExpectedCost) {
        set(PROPERTY_OPCRMEXPECTEDCOST, opcrmExpectedCost);
    }

    public String getOpcrmObjective() {
        return (String) get(PROPERTY_OPCRMOBJECTIVE);
    }

    public void setOpcrmObjective(String opcrmObjective) {
        set(PROPERTY_OPCRMOBJECTIVE, opcrmObjective);
    }

    public String getOpcrmDescription() {
        return (String) get(PROPERTY_OPCRMDESCRIPTION);
    }

    public void setOpcrmDescription(String opcrmDescription) {
        set(PROPERTY_OPCRMDESCRIPTION, opcrmDescription);
    }
    ...
    public String getOpcrmStatus() {
        return (String) get(PROPERTY_OPCRMSTATUS);
    }

    public void setOpcrmStatus(String opcrmStatus) {
        set(PROPERTY_OPCRMSTATUS, opcrmStatus);
    }

    public Boolean isSsipIsimport() {
        return (Boolean) get(PROPERTY_SSIPISIMPORT);
    }

    public void setSsipIsimport(Boolean ssipIsimport) {
        set(PROPERTY_SSIPISIMPORT, ssipIsimport);
    }

    public DocumentType getSsimpdtCDocType() {
        return (DocumentType) get(PROPERTY_SSIMPDTCDOCTYPE);
    }

    public void setSsimpdtCDocType(DocumentType ssimpdtCDocType) {
        set(PROPERTY_SSIMPDTCDOCTYPE, ssimpdtCDocType);
    }

    public String getSsimpdtDocumentNo() {
        return (String) get(PROPERTY_SSIMPDTDOCUMENTNO);
    }

    public void setSsimpdtDocumentNo(String ssimpdtDocumentNo) {
        set(PROPERTY_SSIMPDTDOCUMENTNO, ssimpdtDocumentNo);
    }

    public Date getSsimpdtDate() {
        return (Date) get(PROPERTY_SSIMPDTDATE);
    }

    public void setSsimpdtDate(Date ssimpdtDate) {
        set(PROPERTY_SSIMPDTDATE, ssimpdtDate);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerEMOpcrmBpCCampaignList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMOPCRMBPCCAMPAIGNLIST);
    }

    public void setBusinessPartnerEMOpcrmBpCCampaignList(List<BusinessPartner> businessPartnerEMOpcrmBpCCampaignList) {
        set(PROPERTY_BUSINESSPARTNEREMOPCRMBPCCAMPAIGNLIST, businessPartnerEMOpcrmBpCCampaignList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<InvoiceLine> getInvoiceLineEMSsipCampaignIDList() {
      return (List<InvoiceLine>) get(PROPERTY_INVOICELINEEMSSIPCAMPAIGNIDLIST);
    }

    public void setInvoiceLineEMSsipCampaignIDList(List<InvoiceLine> invoiceLineEMSsipCampaignIDList) {
        set(PROPERTY_INVOICELINEEMSSIPCAMPAIGNIDLIST, invoiceLineEMSsipCampaignIDList);
    }

    @SuppressWarnings("unchecked")
    public List<InvoiceLine> getInvoiceLineEMSSIPICEImportICEList() {
      return (List<InvoiceLine>) get(PROPERTY_INVOICELINEEMSSIPICEIMPORTICELIST);
    }

    public void setInvoiceLineEMSSIPICEImportICEList(List<InvoiceLine> invoiceLineEMSSIPICEImportICEList) {
        set(PROPERTY_INVOICELINEEMSSIPICEIMPORTICELIST, invoiceLineEMSSIPICEImportICEList);
    }
