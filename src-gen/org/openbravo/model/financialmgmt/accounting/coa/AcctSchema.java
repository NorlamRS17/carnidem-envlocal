...
public class AcctSchema extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SPROCTMCONFIGACCOUNTLIST = "sproctmConfigAccountList";
    ...
    public AcctSchema() {
        ...
        setDefaultValue(PROPERTY_SPROCTMCONFIGACCOUNTLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<SproctmConfigAccount> getSproctmConfigAccountList() {
      return (List<SproctmConfigAccount>) get(PROPERTY_SPROCTMCONFIGACCOUNTLIST);
    }

    public void setSproctmConfigAccountList(List<SproctmConfigAccount> sproctmConfigAccountList) {
        set(PROPERTY_SPROCTMCONFIGACCOUNTLIST, sproctmConfigAccountList);
    }
