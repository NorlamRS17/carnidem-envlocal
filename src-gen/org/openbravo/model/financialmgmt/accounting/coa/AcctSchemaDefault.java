...
public class AcctSchemaDefault extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSPRCDEBITACCT = "ssprCDebitAcct";
    public static final String PROPERTY_SSPRCCREDITACCT = "ssprCCreditAcct";
    public static final String PROPERTY_SSPRCCLOSINGACCT = "ssprCClosingAcct";
    public static final String PROPERTY_SSWHWHINCOMEACCT = "sswhWhIncomeAcct";
    public static final String PROPERTY_SSWHWHIVAACCT = "sswhWhIvaAcct";
    public static final String PROPERTY_SSWHWHTRANSITACCT = "sswhWhTransitAcct";
    ...
    public AccountingCombination getSsprCDebitAcct() {
        return (AccountingCombination) get(PROPERTY_SSPRCDEBITACCT);
    }

    public void setSsprCDebitAcct(AccountingCombination ssprCDebitAcct) {
        set(PROPERTY_SSPRCDEBITACCT, ssprCDebitAcct);
    }

    public AccountingCombination getSsprCCreditAcct() {
        return (AccountingCombination) get(PROPERTY_SSPRCCREDITACCT);
    }

    public void setSsprCCreditAcct(AccountingCombination ssprCCreditAcct) {
        set(PROPERTY_SSPRCCREDITACCT, ssprCCreditAcct);
    }

    public AccountingCombination getSsprCClosingAcct() {
        return (AccountingCombination) get(PROPERTY_SSPRCCLOSINGACCT);
    }

    public void setSsprCClosingAcct(AccountingCombination ssprCClosingAcct) {
        set(PROPERTY_SSPRCCLOSINGACCT, ssprCClosingAcct);
    }

    public AccountingCombination getSswhWhIncomeAcct() {
        return (AccountingCombination) get(PROPERTY_SSWHWHINCOMEACCT);
    }

    public void setSswhWhIncomeAcct(AccountingCombination sswhWhIncomeAcct) {
        set(PROPERTY_SSWHWHINCOMEACCT, sswhWhIncomeAcct);
    }

    public AccountingCombination getSswhWhIvaAcct() {
        return (AccountingCombination) get(PROPERTY_SSWHWHIVAACCT);
    }

    public void setSswhWhIvaAcct(AccountingCombination sswhWhIvaAcct) {
        set(PROPERTY_SSWHWHIVAACCT, sswhWhIvaAcct);
    }

    public AccountingCombination getSswhWhTransitAcct() {
        return (AccountingCombination) get(PROPERTY_SSWHWHTRANSITACCT);
    }

    public void setSswhWhTransitAcct(AccountingCombination sswhWhTransitAcct) {
        set(PROPERTY_SSWHWHTRANSITACCT, sswhWhTransitAcct);
    }
