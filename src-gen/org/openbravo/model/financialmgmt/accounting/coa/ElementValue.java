...
import ec.com.sidesoft.carnidem.financialtree.bi.AcctAccount;
import ec.com.sidesoft.carnidem.financialtree.bi.Acctclassif;
import ec.com.sidesoft.carnidem.financialtree.bi.FinanAcctInd;
...
import ec.com.sidesoft.projects.complement.SproctmAcctDetail;
...
public class ElementValue extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSFIISCOSTCENTER = "ssfiIscostcenter";
    public static final String PROPERTY_SSFIISUSER1 = "ssfiIsuser1";
    public static final String PROPERTY_SSFIISUSER2 = "ssfiIsuser2";
    public static final String PROPERTY_SSAMASSET = "ssamAsset";
    public static final String PROPERTY_SACGLDNOSHOWCLIENT = "sacgldNoshowClient";
    public static final String PROPERTY_SSAVISMODULE = "ssavIsmodule";
    public static final String PROPERTY_SCFTACCOUNT = "scftAccount";
    ...
    public static final String PROPERTY_STXREVFINANCIALLACCOUNTINGACCOUNTLIST = "sTXREVFinanciallAccountingAccountList";
    public static final String PROPERTY_SSMAACTACCOUNTINGACCOUNTIDLIST = "ssmaactAccountingAccountIDList";
    public static final String PROPERTY_SSMAACTAUDITACCOUNTIDLIST = "ssmaactAuditAccountIDList";
    public static final String PROPERTY_SBPRFFACTACCTAGGDACCOUNTLIST = "sbprfFactAcctAggdAccountList";
    public static final String PROPERTY_SBPRFFACTACCTAGGDDOCACCOUNTIDLIST = "sbprfFactAcctAggdDocAccountIDList";
    public static final String PROPERTY_SCFTACCTACCOUNTLIST = "scftAcctAccountList";
    public static final String PROPERTY_SCFTFINANACCTINDLIST = "scftFinanAcctIndList";
    public static final String PROPERTY_SPROCTMACCTDETAILLIST = "sproctmAcctDetailList";
    ...
    public ElementValue() {
        ...
        setDefaultValue(PROPERTY_SSFIISCOSTCENTER, false);
        setDefaultValue(PROPERTY_SSFIISUSER1, false);
        setDefaultValue(PROPERTY_SSFIISUSER2, false);
        setDefaultValue(PROPERTY_SSAMASSET, false);
        setDefaultValue(PROPERTY_SACGLDNOSHOWCLIENT, false);
        setDefaultValue(PROPERTY_SSAVISMODULE, false);
        ...
        setDefaultValue(PROPERTY_STXREVFINANCIALLACCOUNTINGACCOUNTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSMAACTACCOUNTINGACCOUNTIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSMAACTAUDITACCOUNTIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SBPRFFACTACCTAGGDACCOUNTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SBPRFFACTACCTAGGDDOCACCOUNTIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SCFTACCTACCOUNTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SCFTFINANACCTINDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SPROCTMACCTDETAILLIST, new ArrayList<Object>());
    ...
    public Boolean isSsfiIscostcenter() {
        return (Boolean) get(PROPERTY_SSFIISCOSTCENTER);
    }

    public void setSsfiIscostcenter(Boolean ssfiIscostcenter) {
        set(PROPERTY_SSFIISCOSTCENTER, ssfiIscostcenter);
    }

    public Boolean isSsfiIsuser1() {
        return (Boolean) get(PROPERTY_SSFIISUSER1);
    }

    public void setSsfiIsuser1(Boolean ssfiIsuser1) {
        set(PROPERTY_SSFIISUSER1, ssfiIsuser1);
    }

    public Boolean isSsfiIsuser2() {
        return (Boolean) get(PROPERTY_SSFIISUSER2);
    }

    public void setSsfiIsuser2(Boolean ssfiIsuser2) {
        set(PROPERTY_SSFIISUSER2, ssfiIsuser2);
    }
    ...
    public Boolean isSacgldNoshowClient() {
        return (Boolean) get(PROPERTY_SACGLDNOSHOWCLIENT);
    }

    public void setSacgldNoshowClient(Boolean sacgldNoshowClient) {
        set(PROPERTY_SACGLDNOSHOWCLIENT, sacgldNoshowClient);
    }

    public Boolean isSsavIsmodule() {
        return (Boolean) get(PROPERTY_SSAVISMODULE);
    }

    public void setSsavIsmodule(Boolean ssavIsmodule) {
        set(PROPERTY_SSAVISMODULE, ssavIsmodule);
    }

    public Acctclassif getScftAccount() {
        return (Acctclassif) get(PROPERTY_SCFTACCOUNT);
    }

    public void setScftAccount(Acctclassif scftAccount) {
        set(PROPERTY_SCFTACCOUNT, scftAccount);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<AccountingReversal> getSTXREVFinanciallAccountingAccountList() {
      return (List<AccountingReversal>) get(PROPERTY_STXREVFINANCIALLACCOUNTINGACCOUNTLIST);
    }

    public void setSTXREVFinanciallAccountingAccountList(List<AccountingReversal> sTXREVFinanciallAccountingAccountList) {
        set(PROPERTY_STXREVFINANCIALLACCOUNTINGACCOUNTLIST, sTXREVFinanciallAccountingAccountList);
    }

    @SuppressWarnings("unchecked")
    public List<SsmaactAccounting> getSsmaactAccountingAccountIDList() {
      return (List<SsmaactAccounting>) get(PROPERTY_SSMAACTACCOUNTINGACCOUNTIDLIST);
    }

    public void setSsmaactAccountingAccountIDList(List<SsmaactAccounting> ssmaactAccountingAccountIDList) {
        set(PROPERTY_SSMAACTACCOUNTINGACCOUNTIDLIST, ssmaactAccountingAccountIDList);
    }

    @SuppressWarnings("unchecked")
    public List<SsmaactAudit> getSsmaactAuditAccountIDList() {
      return (List<SsmaactAudit>) get(PROPERTY_SSMAACTAUDITACCOUNTIDLIST);
    }

    public void setSsmaactAuditAccountIDList(List<SsmaactAudit> ssmaactAuditAccountIDList) {
        set(PROPERTY_SSMAACTAUDITACCOUNTIDLIST, ssmaactAuditAccountIDList);
    }

    @SuppressWarnings("unchecked")
    public List<SbprfFactAcctAggd> getSbprfFactAcctAggdAccountList() {
      return (List<SbprfFactAcctAggd>) get(PROPERTY_SBPRFFACTACCTAGGDACCOUNTLIST);
    }

    public void setSbprfFactAcctAggdAccountList(List<SbprfFactAcctAggd> sbprfFactAcctAggdAccountList) {
        set(PROPERTY_SBPRFFACTACCTAGGDACCOUNTLIST, sbprfFactAcctAggdAccountList);
    }

    @SuppressWarnings("unchecked")
    public List<SbprfFactAcctAggdDoc> getSbprfFactAcctAggdDocAccountIDList() {
      return (List<SbprfFactAcctAggdDoc>) get(PROPERTY_SBPRFFACTACCTAGGDDOCACCOUNTIDLIST);
    }

    public void setSbprfFactAcctAggdDocAccountIDList(List<SbprfFactAcctAggdDoc> sbprfFactAcctAggdDocAccountIDList) {
        set(PROPERTY_SBPRFFACTACCTAGGDDOCACCOUNTIDLIST, sbprfFactAcctAggdDocAccountIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<FinanAcctInd> getScftFinanAcctIndList() {
      return (List<FinanAcctInd>) get(PROPERTY_SCFTFINANACCTINDLIST);
    }

    public void setScftFinanAcctIndList(List<FinanAcctInd> scftFinanAcctIndList) {
        set(PROPERTY_SCFTFINANACCTINDLIST, scftFinanAcctIndList);
    }

    @SuppressWarnings("unchecked")
    public List<SproctmAcctDetail> getSproctmAcctDetailList() {
      return (List<SproctmAcctDetail>) get(PROPERTY_SPROCTMACCTDETAILLIST);
    }

    public void setSproctmAcctDetailList(List<SproctmAcctDetail> sproctmAcctDetailList) {
        set(PROPERTY_SPROCTMACCTDETAILLIST, sproctmAcctDetailList);
    }
