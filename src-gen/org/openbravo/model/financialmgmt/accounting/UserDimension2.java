...
public class UserDimension2 extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_BUSINESSPARTNEREMSSPRUSER2IDLIST = "businessPartnerEMSsprUser2IDList";
    ...
    public static final String PROPERTY_SSPRPAYROLLTICKETEMSPRCUSER2IDLIST = "sSPRPayrollTicketEMSprcUser2IDList";
    ...
    public static final String PROPERTY_CSAAACUSTODIANLINEUSER22IDLIST = "csaaaCustodianlineUser22IDList";
    ...
    public UserDimension2() {
        ...
        setDefaultValue(PROPERTY_BUSINESSPARTNEREMSSPRUSER2IDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SSPRPAYROLLTICKETEMSPRCUSER2IDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_CSAAACUSTODIANLINEUSER22IDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerEMSsprUser2IDList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMSSPRUSER2IDLIST);
    }

    public void setBusinessPartnerEMSsprUser2IDList(List<BusinessPartner> businessPartnerEMSsprUser2IDList) {
        set(PROPERTY_BUSINESSPARTNEREMSSPRUSER2IDLIST, businessPartnerEMSsprUser2IDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<PayrollTicket> getSSPRPayrollTicketEMSprcUser2IDList() {
      return (List<PayrollTicket>) get(PROPERTY_SSPRPAYROLLTICKETEMSPRCUSER2IDLIST);
    }

    public void setSSPRPayrollTicketEMSprcUser2IDList(List<PayrollTicket> sSPRPayrollTicketEMSprcUser2IDList) {
        set(PROPERTY_SSPRPAYROLLTICKETEMSPRCUSER2IDLIST, sSPRPayrollTicketEMSprcUser2IDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<CsaaaCustodianLine> getCsaaaCustodianlineUser22IDList() {
      return (List<CsaaaCustodianLine>) get(PROPERTY_CSAAACUSTODIANLINEUSER22IDLIST);
    }

    public void setCsaaaCustodianlineUser22IDList(List<CsaaaCustodianLine> csaaaCustodianlineUser22IDList) {
        set(PROPERTY_CSAAACUSTODIANLINEUSER22IDLIST, csaaaCustodianlineUser22IDList);
    }
