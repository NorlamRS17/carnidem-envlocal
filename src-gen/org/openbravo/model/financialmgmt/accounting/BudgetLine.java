...
public class BudgetLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SBBSCOMPLIANCEPERCENTAGE = "sbbsCompliancePercentage";
    public static final String PROPERTY_SCFTSALESPERSON = "scftSalesperson";
    public static final String PROPERTY_SCFTPRODUCT = "scftProduct";

    public BudgetLine() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_QUANTITY, new BigDecimal(0));
        setDefaultValue(PROPERTY_SBBSCOMPLIANCEPERCENTAGE, new BigDecimal(0));
    }
    ...
    public BigDecimal getSbbsCompliancePercentage() {
        return (BigDecimal) get(PROPERTY_SBBSCOMPLIANCEPERCENTAGE);
    }

    public void setSbbsCompliancePercentage(BigDecimal sbbsCompliancePercentage) {
        set(PROPERTY_SBBSCOMPLIANCEPERCENTAGE, sbbsCompliancePercentage);
    }

    public BusinessPartner getScftSalesperson() {
        return (BusinessPartner) get(PROPERTY_SCFTSALESPERSON);
    }

    public void setScftSalesperson(BusinessPartner scftSalesperson) {
        set(PROPERTY_SCFTSALESPERSON, scftSalesperson);
    }

    public Product getScftProduct() {
        return (Product) get(PROPERTY_SCFTPRODUCT);
    }

    public void setScftProduct(Product scftProduct) {
        set(PROPERTY_SCFTPRODUCT, scftProduct);
    }
