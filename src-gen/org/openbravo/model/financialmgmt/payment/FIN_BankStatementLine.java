...
public class FIN_BankStatementLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSDRREFERENCENO = "ssdrReferenceno";
    public static final String PROPERTY_SSDRFINPAYMENT = "ssdrFinPayment";
    ...
    public String getSsdrReferenceno() {
        return (String) get(PROPERTY_SSDRREFERENCENO);
    }

    public void setSsdrReferenceno(String ssdrReferenceno) {
        set(PROPERTY_SSDRREFERENCENO, ssdrReferenceno);
    }

    public FIN_Payment getSsdrFinPayment() {
        return (FIN_Payment) get(PROPERTY_SSDRFINPAYMENT);
    }

    public void setSsdrFinPayment(FIN_Payment ssdrFinPayment) {
        set(PROPERTY_SSDRFINPAYMENT, ssdrFinPayment);
    }
