...
public class FinAccPaymentMethod extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SLCBISGENERATECHECK = "slcbIsgeneratecheck";
    ...
    public FinAccPaymentMethod() {
        ...
        setDefaultValue(PROPERTY_SLCBISGENERATECHECK, false);
    }
    ...
    public Boolean isSlcbIsgeneratecheck() {
        return (Boolean) get(PROPERTY_SLCBISGENERATECHECK);
    }

    public void setSlcbIsgeneratecheck(Boolean slcbIsgeneratecheck) {
        set(PROPERTY_SLCBISGENERATECHECK, slcbIsgeneratecheck);
    }
