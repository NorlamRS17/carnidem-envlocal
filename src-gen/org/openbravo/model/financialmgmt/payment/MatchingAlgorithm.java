...
public class MatchingAlgorithm extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSDRMATCHCONFIRMDATE = "ssdrMatchconfirmdate";
    ...
    public MatchingAlgorithm() {
        ...
        setDefaultValue(PROPERTY_SSDRMATCHCONFIRMDATE, false);
    ...
    public Boolean isSsdrMatchconfirmdate() {
        return (Boolean) get(PROPERTY_SSDRMATCHCONFIRMDATE);
    }

    public void setSsdrMatchconfirmdate(Boolean ssdrMatchconfirmdate) {
        set(PROPERTY_SSDRMATCHCONFIRMDATE, ssdrMatchconfirmdate);
    }
