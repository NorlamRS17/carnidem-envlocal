...
public class FIN_Reconciliation extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSFICONCILIATIONBANK = "ssfiConciliationbank";
    public static final String PROPERTY_SSFIREVERSE = "ssfiReverse";
    ...
    public FIN_Reconciliation() {
        ...
        setDefaultValue(PROPERTY_SSFICONCILIATIONBANK, false);
        setDefaultValue(PROPERTY_SSFIREVERSE, false);
    ...
    public Boolean isSsfiConciliationbank() {
        return (Boolean) get(PROPERTY_SSFICONCILIATIONBANK);
    }

    public void setSsfiConciliationbank(Boolean ssfiConciliationbank) {
        set(PROPERTY_SSFICONCILIATIONBANK, ssfiConciliationbank);
    }

    public Boolean isSsfiReverse() {
        return (Boolean) get(PROPERTY_SSFIREVERSE);
    }

    public void setSsfiReverse(Boolean ssfiReverse) {
        set(PROPERTY_SSFIREVERSE, ssfiReverse);
    }
