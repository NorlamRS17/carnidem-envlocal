...
public class FIN_PaymentScheduleDetail extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSWSWITHHOLDINGSSALES = "sSWSWithholdingsSales";
    public static final String PROPERTY_SSWSAMOUNT = "sswsAmount";
    public static final String PROPERTY_SSPITRACTDETAIL = "sspitraCtDetail";
    ...
    public static final String PROPERTY_SCOMSTPAYMENTCOMMISSION = "scomstPaymentCommission";
    ...
    public static final String PROPERTY_SWSPCTRANSACTIONLIST = "swspcTransactionList";
    ...
    public FIN_PaymentScheduleDetail() {
        ...
        setDefaultValue(PROPERTY_SSWSAMOUNT, new BigDecimal(0));
        setDefaultValue(PROPERTY_SSTPCISLIQUIDATED, false);
        setDefaultValue(PROPERTY_SCOMSTPAYMENTCOMMISSION, false);
        ...
        setDefaultValue(PROPERTY_SWSPCTRANSACTIONLIST, new ArrayList<Object>());
    }
    ...
    public SSWSWithholdingSale getSSWSWithholdingsSales() {
        return (SSWSWithholdingSale) get(PROPERTY_SSWSWITHHOLDINGSSALES);
    }

    public void setSSWSWithholdingsSales(SSWSWithholdingSale sSWSWithholdingsSales) {
        set(PROPERTY_SSWSWITHHOLDINGSSALES, sSWSWithholdingsSales);
    }

    public BigDecimal getSswsAmount() {
        return (BigDecimal) get(PROPERTY_SSWSAMOUNT);
    }

    public void setSswsAmount(BigDecimal sswsAmount) {
        set(PROPERTY_SSWSAMOUNT, sswsAmount);
    }

    public SspitraCtDetail getSspitraCtDetail() {
        return (SspitraCtDetail) get(PROPERTY_SSPITRACTDETAIL);
    }

    public void setSspitraCtDetail(SspitraCtDetail sspitraCtDetail) {
        set(PROPERTY_SSPITRACTDETAIL, sspitraCtDetail);
    }
    ...
    public Boolean isScomstPaymentCommission() {
        return (Boolean) get(PROPERTY_SCOMSTPAYMENTCOMMISSION);
    }

    public void setScomstPaymentCommission(Boolean scomstPaymentCommission) {
        set(PROPERTY_SCOMSTPAYMENTCOMMISSION, scomstPaymentCommission);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SWSPCTransaction> getSwspcTransactionList() {
      return (List<SWSPCTransaction>) get(PROPERTY_SWSPCTRANSACTIONLIST);
    }

    public void setSwspcTransactionList(List<SWSPCTransaction> swspcTransactionList) {
        set(PROPERTY_SWSPCTRANSACTIONLIST, swspcTransactionList);
    }
