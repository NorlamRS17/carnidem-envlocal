...
import ec.com.sidesoft.creditcard.reconciliation.Ssccr_CardRecSummaryV;
...
public class FIN_FinaccTransaction extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SFADTDOCUMENTNO = "sfadtDocumentno";
    public static final String PROPERTY_SPEVISPROCESSED = "spevIsprocessed";
    public static final String PROPERTY_SCCCISCASHCLOUSURE = "scccIscashclousure";
    public static final String PROPERTY_SFADTCDOCTYPE = "sfadtCDoctype";
    public static final String PROPERTY_SCCCCASHCLOUSURE = "scccCashClousure";
    public static final String PROPERTY_SSCCRCINVOICE = "ssccrCInvoice";
    public static final String PROPERTY_SSCCRCORDER = "ssccrCOrder";
    public static final String PROPERTY_SSCCRLOT = "ssccrLot";
    public static final String PROPERTY_SSCCRRECONCILED = "ssccrReconciled";
    public static final String PROPERTY_SSCCRPROCESSORBANCK = "ssccrProcessorBanck";
    public static final String PROPERTY_SSCCRTYPESOFCREDIT = "ssccrTypesOfCredit";
    public static final String PROPERTY_SSCCRSSFIBANKTRANSFER = "ssccrSsfiBanktransfer";
    ...
    public static final String PROPERTY_SSCCRRECAPNO = "ssccrRecapno";
    public static final String PROPERTY_SSCCRFINPAYMENT = "ssccrFinPayment";
    public static final String PROPERTY_SSCCCINREFERENCE = "sscccinReference";
    public static final String PROPERTY_SSCCRRECONCILIATIONNO = "ssccrReconciliationNo";
    public static final String PROPERTY_SSCCRRECSUMLINE = "ssccrRecSumLine";
    public static final String PROPERTY_SSCCRPOSCARDREC = "ssccrPosCardRec";
    public static final String PROPERTY_SFADTACCSEQUENCE = "sfadtAccsequence";
    ...
    public static final String PROPERTY_FINFINACCTRANSACTIONEMAPRMFINACCTRANSORIGINLIST = "fINFinaccTransactionEMAprmFinaccTransOriginList";
    ...
    public static final String PROPERTY_OBPOSPAYMENTCASHUPEVENTSRELATEDTRANSACTIONIDLIST = "oBPOSPaymentcashupEventsRelatedTransactionIDList";
    public static final String PROPERTY_SSCCRFINACCTRANSVLIST = "ssccrFinaccTransVList";
    public static final String PROPERTY_SSCCRPOSCARDRECLINEGROUPIDLIST = "ssccrPosCardRecLineGroupIDList";
    public static final String PROPERTY_SSCCSOCASHINCEXPLIST = "ssccsoCashIncExpList";
    public static final String PROPERTY_SCCRTCARDLOADLINEFINFINACCTRANSSACTIONIDLIST = "sccrtCardLoadLineFINFinaccTranssactionIDList";
    public static final String PROPERTY_SSCCRCARDRECDETAILVLIST = "ssccrCardRecDetailVList";
    public static final String PROPERTY_SSCCRCARDRECSUMMARYVLIST = "ssccrCardRecSummaryVList";
    ...
    public FIN_FinaccTransaction() {
        ...
        setDefaultValue(PROPERTY_SPEVISPROCESSED, false);
        setDefaultValue(PROPERTY_SCCCISCASHCLOUSURE, false);
        ...
        setDefaultValue(PROPERTY_FINFINACCTRANSACTIONEMAPRMFINACCTRANSORIGINLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OBPOSPAYMENTCASHUPEVENTSRELATEDTRANSACTIONIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSCCRFINACCTRANSVLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSCCRPOSCARDRECLINEGROUPIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSCCSOCASHINCEXPLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SCCRTCARDLOADLINEFINFINACCTRANSSACTIONIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSCCRCARDRECDETAILVLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSCCRCARDRECSUMMARYVLIST, new ArrayList<Object>());
    }
    ...
    public OBPOSAppCashup getObposAppCashup() {
        return (OBPOSAppCashup) get(PROPERTY_OBPOSAPPCASHUP);
    }

    public void setObposAppCashup(OBPOSAppCashup obposAppCashup) {
    ...
    public String getSfadtDocumentno() {
        return (String) get(PROPERTY_SFADTDOCUMENTNO);
    }

    public void setSfadtDocumentno(String sfadtDocumentno) {
        set(PROPERTY_SFADTDOCUMENTNO, sfadtDocumentno);
    }

    public Boolean isSpevIsprocessed() {
        return (Boolean) get(PROPERTY_SPEVISPROCESSED);
    }

    public void setSpevIsprocessed(Boolean spevIsprocessed) {
        set(PROPERTY_SPEVISPROCESSED, spevIsprocessed);
    }

    public Boolean isScccIscashclousure() {
        return (Boolean) get(PROPERTY_SCCCISCASHCLOUSURE);
    }

    public void setScccIscashclousure(Boolean scccIscashclousure) {
        set(PROPERTY_SCCCISCASHCLOUSURE, scccIscashclousure);
    }

    public DocumentType getSfadtCDoctype() {
        return (DocumentType) get(PROPERTY_SFADTCDOCTYPE);
    }

    public void setSfadtCDoctype(DocumentType sfadtCDoctype) {
        set(PROPERTY_SFADTCDOCTYPE, sfadtCDoctype);
    }
    ...
    public Invoice getSsccrCInvoice() {
        return (Invoice) get(PROPERTY_SSCCRCINVOICE);
    }

    public void setSsccrCInvoice(Invoice ssccrCInvoice) {
        set(PROPERTY_SSCCRCINVOICE, ssccrCInvoice);
    }

    public Order getSsccrCOrder() {
        return (Order) get(PROPERTY_SSCCRCORDER);
    }

    public void setSsccrCOrder(Order ssccrCOrder) {
        set(PROPERTY_SSCCRCORDER, ssccrCOrder);
    }

    public String getSsccrLot() {
        return (String) get(PROPERTY_SSCCRLOT);
    }

    public void setSsccrLot(String ssccrLot) {
        set(PROPERTY_SSCCRLOT, ssccrLot);
    }

    public String getSsccrReconciled() {
        return (String) get(PROPERTY_SSCCRRECONCILED);
    }

    public void setSsccrReconciled(String ssccrReconciled) {
        set(PROPERTY_SSCCRRECONCILED, ssccrReconciled);
    }

    public SsccrProcessorBanck getSsccrProcessorBanck() {
        return (SsccrProcessorBanck) get(PROPERTY_SSCCRPROCESSORBANCK);
    }

    public void setSsccrProcessorBanck(SsccrProcessorBanck ssccrProcessorBanck) {
        set(PROPERTY_SSCCRPROCESSORBANCK, ssccrProcessorBanck);
    }

    public SsccrTypesOfCredit getSsccrTypesOfCredit() {
        return (SsccrTypesOfCredit) get(PROPERTY_SSCCRTYPESOFCREDIT);
    }

    public void setSsccrTypesOfCredit(SsccrTypesOfCredit ssccrTypesOfCredit) {
        set(PROPERTY_SSCCRTYPESOFCREDIT, ssccrTypesOfCredit);
    }

    public ssfiBanktransfer getSsccrSsfiBanktransfer() {
        return (ssfiBanktransfer) get(PROPERTY_SSCCRSSFIBANKTRANSFER);
    }

    public void setSsccrSsfiBanktransfer(ssfiBanktransfer ssccrSsfiBanktransfer) {
        set(PROPERTY_SSCCRSSFIBANKTRANSFER, ssccrSsfiBanktransfer);
    }
    ...
    public String getSsccrRecapno() {
        return (String) get(PROPERTY_SSCCRRECAPNO);
    }

    public void setSsccrRecapno(String ssccrRecapno) {
        set(PROPERTY_SSCCRRECAPNO, ssccrRecapno);
    }

    public FIN_Payment getSsccrFinPayment() {
        return (FIN_Payment) get(PROPERTY_SSCCRFINPAYMENT);
    }

    public void setSsccrFinPayment(FIN_Payment ssccrFinPayment) {
        set(PROPERTY_SSCCRFINPAYMENT, ssccrFinPayment);
    }

    public String getSscccinReference() {
        return (String) get(PROPERTY_SSCCCINREFERENCE);
    }

    public void setSscccinReference(String sscccinReference) {
        set(PROPERTY_SSCCCINREFERENCE, sscccinReference);
    }

    public String getSsccrReconciliationNo() {
        return (String) get(PROPERTY_SSCCRRECONCILIATIONNO);
    }

    public void setSsccrReconciliationNo(String ssccrReconciliationNo) {
        set(PROPERTY_SSCCRRECONCILIATIONNO, ssccrReconciliationNo);
    }

    public String getSsccrRecSumLine() {
        return (String) get(PROPERTY_SSCCRRECSUMLINE);
    }

    public void setSsccrRecSumLine(String ssccrRecSumLine) {
        set(PROPERTY_SSCCRRECSUMLINE, ssccrRecSumLine);
    }
    ...
    public String getSfadtAccsequence() {
        return (String) get(PROPERTY_SFADTACCSEQUENCE);
    }

    public void setSfadtAccsequence(String sfadtAccsequence) {
        set(PROPERTY_SFADTACCSEQUENCE, sfadtAccsequence);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<FIN_FinaccTransaction> getFINFinaccTransactionEMAprmFinaccTransOriginList() {
      return (List<FIN_FinaccTransaction>) get(PROPERTY_FINFINACCTRANSACTIONEMAPRMFINACCTRANSORIGINLIST);
    }

    public void setFINFinaccTransactionEMAprmFinaccTransOriginList(List<FIN_FinaccTransaction> fINFinaccTransactionEMAprmFinaccTransOriginList) {
        set(PROPERTY_FINFINACCTRANSACTIONEMAPRMFINACCTRANSORIGINLIST, fINFinaccTransactionEMAprmFinaccTransOriginList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OBPOSPaymentcashupEvents> getOBPOSPaymentcashupEventsRelatedTransactionIDList() {
      return (List<OBPOSPaymentcashupEvents>) get(PROPERTY_OBPOSPAYMENTCASHUPEVENTSRELATEDTRANSACTIONIDLIST);
    }

    public void setOBPOSPaymentcashupEventsRelatedTransactionIDList(List<OBPOSPaymentcashupEvents> oBPOSPaymentcashupEventsRelatedTransactionIDList) {
        set(PROPERTY_OBPOSPAYMENTCASHUPEVENTSRELATEDTRANSACTIONIDLIST, oBPOSPaymentcashupEventsRelatedTransactionIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SsccrPosCardRecLine> getSsccrPosCardRecLineGroupIDList() {
      return (List<SsccrPosCardRecLine>) get(PROPERTY_SSCCRPOSCARDRECLINEGROUPIDLIST);
    }

    public void setSsccrPosCardRecLineGroupIDList(List<SsccrPosCardRecLine> ssccrPosCardRecLineGroupIDList) {
        set(PROPERTY_SSCCRPOSCARDRECLINEGROUPIDLIST, ssccrPosCardRecLineGroupIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SccrtCardLoadLine> getSccrtCardLoadLineFINFinaccTranssactionIDList() {
      return (List<SccrtCardLoadLine>) get(PROPERTY_SCCRTCARDLOADLINEFINFINACCTRANSSACTIONIDLIST);
    }

    public void setSccrtCardLoadLineFINFinaccTranssactionIDList(List<SccrtCardLoadLine> sccrtCardLoadLineFINFinaccTranssactionIDList) {
        set(PROPERTY_SCCRTCARDLOADLINEFINFINACCTRANSSACTIONIDLIST, sccrtCardLoadLineFINFinaccTranssactionIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Ssccr_CardRecSummaryV> getSsccrCardRecSummaryVList() {
      return (List<Ssccr_CardRecSummaryV>) get(PROPERTY_SSCCRCARDRECSUMMARYVLIST);
    }

    public void setSsccrCardRecSummaryVList(List<Ssccr_CardRecSummaryV> ssccrCardRecSummaryVList) {
        set(PROPERTY_SSCCRCARDRECSUMMARYVLIST, ssccrCardRecSummaryVList);
    }
