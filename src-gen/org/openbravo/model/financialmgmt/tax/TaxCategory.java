...
public class TaxCategory extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_FINANCIALMGMTASSETEMSSATAXCTAXCATEGORYIDLIST = "financialMgmtAssetEmSsataxCTaxcategoryIdList";
    ...
    public static final String PROPERTY_SSARVVALUECHANGEHVTAXCATEGORYLIST = "ssarvValueChangeHVTaxcategoryList";
    public static final String PROPERTY_SSARVVALUECHANGENVTAXCATEGORYLIST = "ssarvValueChangeNVTaxcategoryList";
    ...
    public TaxCategory() {
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTASSETEMSSATAXCTAXCATEGORYIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SSARVVALUECHANGEHVTAXCATEGORYLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSARVVALUECHANGENVTAXCATEGORYLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Asset> getFinancialMgmtAssetEmSsataxCTaxcategoryIdList() {
      return (List<Asset>) get(PROPERTY_FINANCIALMGMTASSETEMSSATAXCTAXCATEGORYIDLIST);
    }

    public void setFinancialMgmtAssetEmSsataxCTaxcategoryIdList(List<Asset> financialMgmtAssetEmSsataxCTaxcategoryIdList) {
        set(PROPERTY_FINANCIALMGMTASSETEMSSATAXCTAXCATEGORYIDLIST, financialMgmtAssetEmSsataxCTaxcategoryIdList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SsarvValueChange> getSsarvValueChangeHVTaxcategoryList() {
      return (List<SsarvValueChange>) get(PROPERTY_SSARVVALUECHANGEHVTAXCATEGORYLIST);
    }

    public void setSsarvValueChangeHVTaxcategoryList(List<SsarvValueChange> ssarvValueChangeHVTaxcategoryList) {
        set(PROPERTY_SSARVVALUECHANGEHVTAXCATEGORYLIST, ssarvValueChangeHVTaxcategoryList);
    }

    @SuppressWarnings("unchecked")
    public List<SsarvValueChange> getSsarvValueChangeNVTaxcategoryList() {
      return (List<SsarvValueChange>) get(PROPERTY_SSARVVALUECHANGENVTAXCATEGORYLIST);
    }

    public void setSsarvValueChangeNVTaxcategoryList(List<SsarvValueChange> ssarvValueChangeNVTaxcategoryList) {
        set(PROPERTY_SSARVVALUECHANGENVTAXCATEGORYLIST, ssarvValueChangeNVTaxcategoryList);
    }
