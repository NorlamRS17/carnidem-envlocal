...
public class GLBatch extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSTTDEFSETTLEDEFERRED = "ssttdefSettleDeferred";
    public static final String PROPERTY_ATIMDMISROL = "atimdmIsrol";
    public static final String PROPERTY_FINANCIALMGMTGLJOURNALLIST = "financialMgmtGLJournalList";
    public static final String PROPERTY_OBRECTXGLJOURNALVLIST = "oBRECTXGLJournalVList";
    ...
    public GLBatch() {
        ...
        setDefaultValue(PROPERTY_SSTTDEFSETTLEDEFERRED, false);
        setDefaultValue(PROPERTY_ATIMDMISROL, false);
        setDefaultValue(PROPERTY_FINANCIALMGMTGLJOURNALLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OBRECTXGLJOURNALVLIST, new ArrayList<Object>());
    ...
    public Boolean isSsttdefSettleDeferred() {
        return (Boolean) get(PROPERTY_SSTTDEFSETTLEDEFERRED);
    }

    public void setSsttdefSettleDeferred(Boolean ssttdefSettleDeferred) {
        set(PROPERTY_SSTTDEFSETTLEDEFERRED, ssttdefSettleDeferred);
    }

    public Boolean isAtimdmIsrol() {
        return (Boolean) get(PROPERTY_ATIMDMISROL);
    }

    public void setAtimdmIsrol(Boolean atimdmIsrol) {
        set(PROPERTY_ATIMDMISROL, atimdmIsrol);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GLJournalClone> getOBRECTXGLJournalVList() {
      return (List<GLJournalClone>) get(PROPERTY_OBRECTXGLJOURNALVLIST);
    }

    public void setOBRECTXGLJournalVList(List<GLJournalClone> oBRECTXGLJournalVList) {
        set(PROPERTY_OBRECTXGLJOURNALVLIST, oBRECTXGLJournalVList);
    }
