...
public class GLJournalLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSIPIMPORTCOSTS = "ssipImportcosts";
    public static final String PROPERTY_GLITEMS = "gLItems";
    public static final String PROPERTY_SSIPIMPORTDEBIT = "ssipImportdebit";
    public static final String PROPERTY_SSIMPCNTYPE = "sSIMPCNType";
    public static final String PROPERTY_SSIMPCNASSOCIATEDCONSOLIDATION = "sSIMPCNAssociatedConsolidation";
    ...
    public GLJournalLine() {
        ...
        setDefaultValue(PROPERTY_SSIPIMPORTCOSTS, false);
        setDefaultValue(PROPERTY_SSIPIMPORTDEBIT, false);
    ...
    public Boolean isSsipImportcosts() {
        return (Boolean) get(PROPERTY_SSIPIMPORTCOSTS);
    }

    public void setSsipImportcosts(Boolean ssipImportcosts) {
        set(PROPERTY_SSIPIMPORTCOSTS, ssipImportcosts);
    }
    ...
    public Boolean isSsipImportdebit() {
        return (Boolean) get(PROPERTY_SSIPIMPORTDEBIT);
    }

    public void setSsipImportdebit(Boolean ssipImportdebit) {
        set(PROPERTY_SSIPIMPORTDEBIT, ssipImportdebit);
    }
    ...
    public Ssimpcn_ImpConsolidation getSSIMPCNAssociatedConsolidation() {
        return (Ssimpcn_ImpConsolidation) get(PROPERTY_SSIMPCNASSOCIATEDCONSOLIDATION);
    }

    public void setSSIMPCNAssociatedConsolidation(Ssimpcn_ImpConsolidation sSIMPCNAssociatedConsolidation) {
        set(PROPERTY_SSIMPCNASSOCIATEDCONSOLIDATION, sSIMPCNAssociatedConsolidation);
    }
