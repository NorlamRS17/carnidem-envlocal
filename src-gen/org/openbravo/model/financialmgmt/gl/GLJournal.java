...
import org.openbravo.financial.recurringtransactions.GLJournalClone;
...
public class GLJournal extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SLIAELOADACCT = "sliaeLoadacct";
    public static final String PROPERTY_OBRECTXRECURRING = "obrectxRecurring";
    public static final String PROPERTY_OBRECTXRULE = "obrectxRule";
    public static final String PROPERTY_OBRECTXGLJOURNAL = "obrectxGlJournal";
    public static final String PROPERTY_CURRENCYCONVERSIONRATEDOCLIST = "currencyConversionRateDocList";
    public static final String PROPERTY_FINANCIALMGMTGLJOURNALEMOBRECTXGLJOURNALIDLIST = "financialMgmtGLJournalEMObrectxGlJournalIDList";
    ...
    public static final String PROPERTY_OBRECTXGLJOURNALVGLJOURNALIDLIST = "oBRECTXGLJournalVGLJournalIDList";
    ...
    public GLJournal() {
        ...
        setDefaultValue(PROPERTY_SLIAELOADACCT, false);
        setDefaultValue(PROPERTY_OBRECTXRECURRING, false);
        setDefaultValue(PROPERTY_CURRENCYCONVERSIONRATEDOCLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_FINANCIALMGMTGLJOURNALEMOBRECTXGLJOURNALIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OBRECTXGLJOURNALVGLJOURNALIDLIST, new ArrayList<Object>());
    }
    ...
    public Boolean isSliaeLoadacct() {
        return (Boolean) get(PROPERTY_SLIAELOADACCT);
    }

    public void setSliaeLoadacct(Boolean sliaeLoadacct) {
        set(PROPERTY_SLIAELOADACCT, sliaeLoadacct);
    }

    public Boolean isObrectxRecurring() {
        return (Boolean) get(PROPERTY_OBRECTXRECURRING);
    }

    public void setObrectxRecurring(Boolean obrectxRecurring) {
        set(PROPERTY_OBRECTXRECURRING, obrectxRecurring);
    }

    public RecurringRule getObrectxRule() {
        return (RecurringRule) get(PROPERTY_OBRECTXRULE);
    }

    public void setObrectxRule(RecurringRule obrectxRule) {
        set(PROPERTY_OBRECTXRULE, obrectxRule);
    }

    public GLJournal getObrectxGlJournal() {
        return (GLJournal) get(PROPERTY_OBRECTXGLJOURNAL);
    }

    public void setObrectxGlJournal(GLJournal obrectxGlJournal) {
        set(PROPERTY_OBRECTXGLJOURNAL, obrectxGlJournal);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GLJournal> getFinancialMgmtGLJournalEMObrectxGlJournalIDList() {
      return (List<GLJournal>) get(PROPERTY_FINANCIALMGMTGLJOURNALEMOBRECTXGLJOURNALIDLIST);
    }

    public void setFinancialMgmtGLJournalEMObrectxGlJournalIDList(List<GLJournal> financialMgmtGLJournalEMObrectxGlJournalIDList) {
        set(PROPERTY_FINANCIALMGMTGLJOURNALEMOBRECTXGLJOURNALIDLIST, financialMgmtGLJournalEMObrectxGlJournalIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GLJournalClone> getOBRECTXGLJournalVGLJournalIDList() {
      return (List<GLJournalClone>) get(PROPERTY_OBRECTXGLJOURNALVGLJOURNALIDLIST);
    }

    public void setOBRECTXGLJournalVGLJournalIDList(List<GLJournalClone> oBRECTXGLJournalVGLJournalIDList) {
        set(PROPERTY_OBRECTXGLJOURNALVGLJOURNALIDLIST, oBRECTXGLJournalVGLJournalIDList);
    }
