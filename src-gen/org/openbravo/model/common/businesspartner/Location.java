...
import ec.com.sidesoft.localization.geography.secpm_parroquia;
...
public class Location extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SECPMPARROQUIA = "secpmParroquia";
    public static final String PROPERTY_SPINCOLATITUDE = "spincoLatitude";
    public static final String PROPERTY_SSPSILATITUDE = "sspsiLatitude";
    public static final String PROPERTY_SPINCOLONGITUDE = "spincoLongitude";
    public static final String PROPERTY_SSPSILONGITUDE = "sspsiLongitude";
    ...
    public static final String PROPERTY_OBPOSAPPLICATIONSOBPOSCBPARTNERLOCIDLIST = "oBPOSApplicationsObposCBpartnerLocIDList";
    ...
    public static final String PROPERTY_ORGANIZATIONEMOBRETCOCBPLOCATIONIDLIST = "organizationEMObretcoCBpLocationIDList";
    ...
    public static final String PROPERTY_SBPCINFOPARTNERSVCBPARTNERLOCATIONIDPHONE1LIST = "sBPCInfoPartnersVCBpartnerLocationIdPhone1List";
    public static final String PROPERTY_SBPCINFOPARTNERSVCBPARTNERLOCATIONIDPHONE2LIST = "sBPCInfoPartnersVCBpartnerLocationIdPhone2List";
    ...
    public Location() {
        ...
        setDefaultValue(PROPERTY_OBPOSAPPLICATIONSOBPOSCBPARTNERLOCIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONEMOBRETCOCBPLOCATIONIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SBPCINFOPARTNERSVCBPARTNERLOCATIONIDPHONE1LIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SBPCINFOPARTNERSVCBPARTNERLOCATIONIDPHONE2LIST, new ArrayList<Object>());
    ...
    public secpm_parroquia getSecpmParroquia() {
        return (secpm_parroquia) get(PROPERTY_SECPMPARROQUIA);
    }

    public void setSecpmParroquia(secpm_parroquia secpmParroquia) {
        set(PROPERTY_SECPMPARROQUIA, secpmParroquia);
    }

    public String getSpincoLatitude() {
        return (String) get(PROPERTY_SPINCOLATITUDE);
    }

    public void setSpincoLatitude(String spincoLatitude) {
        set(PROPERTY_SPINCOLATITUDE, spincoLatitude);
    }

    public String getSspsiLatitude() {
        return (String) get(PROPERTY_SSPSILATITUDE);
    }

    public void setSspsiLatitude(String sspsiLatitude) {
        set(PROPERTY_SSPSILATITUDE, sspsiLatitude);
    }

    public String getSpincoLongitude() {
        return (String) get(PROPERTY_SPINCOLONGITUDE);
    }

    public void setSpincoLongitude(String spincoLongitude) {
        set(PROPERTY_SPINCOLONGITUDE, spincoLongitude);
    }

    public String getSspsiLongitude() {
        return (String) get(PROPERTY_SSPSILONGITUDE);
    }

    public void setSspsiLongitude(String sspsiLongitude) {
        set(PROPERTY_SSPSILONGITUDE, sspsiLongitude);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OBPOSApplications> getOBPOSApplicationsObposCBpartnerLocIDList() {
      return (List<OBPOSApplications>) get(PROPERTY_OBPOSAPPLICATIONSOBPOSCBPARTNERLOCIDLIST);
    }

    public void setOBPOSApplicationsObposCBpartnerLocIDList(List<OBPOSApplications> oBPOSApplicationsObposCBpartnerLocIDList) {
        set(PROPERTY_OBPOSAPPLICATIONSOBPOSCBPARTNERLOCIDLIST, oBPOSApplicationsObposCBpartnerLocIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMObretcoCBpLocationIDList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMOBRETCOCBPLOCATIONIDLIST);
    }

    public void setOrganizationEMObretcoCBpLocationIDList(List<Organization> organizationEMObretcoCBpLocationIDList) {
        set(PROPERTY_ORGANIZATIONEMOBRETCOCBPLOCATIONIDLIST, organizationEMObretcoCBpLocationIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SBPCInfoPartnersV> getSBPCInfoPartnersVCBpartnerLocationIdPhone1List() {
      return (List<SBPCInfoPartnersV>) get(PROPERTY_SBPCINFOPARTNERSVCBPARTNERLOCATIONIDPHONE1LIST);
    }

    public void setSBPCInfoPartnersVCBpartnerLocationIdPhone1List(List<SBPCInfoPartnersV> sBPCInfoPartnersVCBpartnerLocationIdPhone1List) {
        set(PROPERTY_SBPCINFOPARTNERSVCBPARTNERLOCATIONIDPHONE1LIST, sBPCInfoPartnersVCBpartnerLocationIdPhone1List);
    }

    @SuppressWarnings("unchecked")
    public List<SBPCInfoPartnersV> getSBPCInfoPartnersVCBpartnerLocationIdPhone2List() {
      return (List<SBPCInfoPartnersV>) get(PROPERTY_SBPCINFOPARTNERSVCBPARTNERLOCATIONIDPHONE2LIST);
    }

    public void setSBPCInfoPartnersVCBpartnerLocationIdPhone2List(List<SBPCInfoPartnersV> sBPCInfoPartnersVCBpartnerLocationIdPhone2List) {
        set(PROPERTY_SBPCINFOPARTNERSVCBPARTNERLOCATIONIDPHONE2LIST, sBPCInfoPartnersVCBpartnerLocationIdPhone2List);
    }
