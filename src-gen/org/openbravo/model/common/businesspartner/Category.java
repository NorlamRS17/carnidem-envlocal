...
public class Category extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSWHISEXPORTATION = "sswhIsexportation";
    public static final String PROPERTY_SSWHCLIENTTYPE = "sswhClienttype";
    public static final String PROPERTY_SSWHEXPORTATIONFROM = "sswhExportationFrom";
    public static final String PROPERTY_SSWHTYPEINGEXT = "sswhTypeIngExt";
    public static final String PROPERTY_SSWHINGEXTGRAVOTHCTRY = "sswhIngExtGravOthCtry";
    ...
    public static final String PROPERTY_ORGANIZATIONEMOBRETCODBPBPCATIDLIST = "organizationEMObretcoDbpBpcatidList";
    ...
    public Category() {
        ...
        setDefaultValue(PROPERTY_SSWHISEXPORTATION, false);
        setDefaultValue(PROPERTY_SSWHCLIENTTYPE, (long) 0);
        setDefaultValue(PROPERTY_SSWHINGEXTGRAVOTHCTRY, false);
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONEMOBRETCODBPBPCATIDLIST, new ArrayList<Object>());
    ...
    public Boolean isSswhIsexportation() {
        return (Boolean) get(PROPERTY_SSWHISEXPORTATION);
    }

    public void setSswhIsexportation(Boolean sswhIsexportation) {
        set(PROPERTY_SSWHISEXPORTATION, sswhIsexportation);
    }

    public Long getSswhClienttype() {
        return (Long) get(PROPERTY_SSWHCLIENTTYPE);
    }

    public void setSswhClienttype(Long sswhClienttype) {
        set(PROPERTY_SSWHCLIENTTYPE, sswhClienttype);
    }

    public Long getSswhExportationFrom() {
        return (Long) get(PROPERTY_SSWHEXPORTATIONFROM);
    }

    public void setSswhExportationFrom(Long sswhExportationFrom) {
        set(PROPERTY_SSWHEXPORTATIONFROM, sswhExportationFrom);
    }

    public Long getSswhTypeIngExt() {
        return (Long) get(PROPERTY_SSWHTYPEINGEXT);
    }

    public void setSswhTypeIngExt(Long sswhTypeIngExt) {
        set(PROPERTY_SSWHTYPEINGEXT, sswhTypeIngExt);
    }

    public Boolean isSswhIngExtGravOthCtry() {
        return (Boolean) get(PROPERTY_SSWHINGEXTGRAVOTHCTRY);
    }

    public void setSswhIngExtGravOthCtry(Boolean sswhIngExtGravOthCtry) {
        set(PROPERTY_SSWHINGEXTGRAVOTHCTRY, sswhIngExtGravOthCtry);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMObretcoDbpBpcatidList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMOBRETCODBPBPCATIDLIST);
    }

    public void setOrganizationEMObretcoDbpBpcatidList(List<Organization> organizationEMObretcoDbpBpcatidList) {
        set(PROPERTY_ORGANIZATIONEMOBRETCODBPBPCATIDLIST, organizationEMObretcoDbpBpcatidList);
    }
