...
import ec.com.sidesoft.crm.visitplan.Scrvro_Province;
...
public class Region extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ORGANIZATIONINFORMATIONEMSORGIREGIONIDLIST = "organizationInformationEMSorgiRegionIDList";
    ...
    public static final String PROPERTY_SECPMCANTONLIST = "secpmCantonList";
    ...
    public Region() {
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONINFORMATIONEMSORGIREGIONIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SECPMCANTONLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OrganizationInformation> getOrganizationInformationEMSorgiRegionIDList() {
      return (List<OrganizationInformation>) get(PROPERTY_ORGANIZATIONINFORMATIONEMSORGIREGIONIDLIST);
    }

    public void setOrganizationInformationEMSorgiRegionIDList(List<OrganizationInformation> organizationInformationEMSorgiRegionIDList) {
        set(PROPERTY_ORGANIZATIONINFORMATIONEMSORGIREGIONIDLIST, organizationInformationEMSorgiRegionIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<secpm_canton> getSecpmCantonList() {
      return (List<secpm_canton>) get(PROPERTY_SECPMCANTONLIST);
    }

    public void setSecpmCantonList(List<secpm_canton> secpmCantonList) {
        set(PROPERTY_SECPMCANTONLIST, secpmCantonList);
    }
