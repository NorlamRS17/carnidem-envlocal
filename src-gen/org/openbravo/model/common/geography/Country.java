...
import com.sidesoft.localization.ecuador.withholdings.SSWHTaxRegime;
...
public class Country extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSPRCODERESIDENCE = "ssprCoderesidence";
    public static final String PROPERTY_SSPRAPPLYAGREEMENT = "ssprApplyagreement";
    public static final String PROPERTY_SSWHTAXREGIME = "sswhTaxregime";
    public static final String PROPERTY_SSWHREGIMECODE = "sswhRegimeCode";
    public static final String PROPERTY_SSWHDESIGNATIONTAX = "sswhDesignationTax";
    public static final String PROPERTY_BANKLIST = "bankList";
    public static final String PROPERTY_BUSINESSPARTNEREMSSHRCOUNTRYLIST = "businessPartnerEMSshrCountryList";
    public static final String PROPERTY_BUSINESSPARTNEREMATIMDMNACIONALIDADLIST = "businessPartnerEMAtimdmNacionalidadList";
    ...
    public static final String PROPERTY_ORGANIZATIONEMOBRETCODBPCOUNTRYIDLIST = "organizationEMObretcoDbpCountryidList";
    public static final String PROPERTY_ORGANIZATIONINFORMATIONEMSORGICOUNTRYIDLIST = "organizationInformationEMSorgiCountryIDList";
    ...
    public static final String PROPERTY_SCRVROVENDORROUTECONFIGLIST = "scrvroVendorRouteConfigList";
    public static final String PROPERTY_SSHRQEDUCATIONCOUNTRYLIST = "sshrQeducationCountryList";
    ...
    public Country() {
        ...
        setDefaultValue(PROPERTY_SSPRAPPLYAGREEMENT, false);
        setDefaultValue(PROPERTY_BANKLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_BUSINESSPARTNEREMSSHRCOUNTRYLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_BUSINESSPARTNEREMATIMDMNACIONALIDADLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONEMOBRETCODBPCOUNTRYIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ORGANIZATIONINFORMATIONEMSORGICOUNTRYIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SCRVROVENDORROUTECONFIGLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSHRQEDUCATIONCOUNTRYLIST, new ArrayList<Object>());
    ...
    public String getSsprCoderesidence() {
        return (String) get(PROPERTY_SSPRCODERESIDENCE);
    }

    public void setSsprCoderesidence(String ssprCoderesidence) {
        set(PROPERTY_SSPRCODERESIDENCE, ssprCoderesidence);
    }

    public Boolean isSsprApplyagreement() {
        return (Boolean) get(PROPERTY_SSPRAPPLYAGREEMENT);
    }

    public void setSsprApplyagreement(Boolean ssprApplyagreement) {
        set(PROPERTY_SSPRAPPLYAGREEMENT, ssprApplyagreement);
    }

    public SSWHTaxRegime getSswhTaxregime() {
        return (SSWHTaxRegime) get(PROPERTY_SSWHTAXREGIME);
    }

    public void setSswhTaxregime(SSWHTaxRegime sswhTaxregime) {
        set(PROPERTY_SSWHTAXREGIME, sswhTaxregime);
    }

    public String getSswhRegimeCode() {
        return (String) get(PROPERTY_SSWHREGIMECODE);
    }

    public void setSswhRegimeCode(String sswhRegimeCode) {
        set(PROPERTY_SSWHREGIMECODE, sswhRegimeCode);
    }

    public String getSswhDesignationTax() {
        return (String) get(PROPERTY_SSWHDESIGNATIONTAX);
    }

    public void setSswhDesignationTax(String sswhDesignationTax) {
        set(PROPERTY_SSWHDESIGNATIONTAX, sswhDesignationTax);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerEMSshrCountryList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMSSHRCOUNTRYLIST);
    }

    public void setBusinessPartnerEMSshrCountryList(List<BusinessPartner> businessPartnerEMSshrCountryList) {
        set(PROPERTY_BUSINESSPARTNEREMSSHRCOUNTRYLIST, businessPartnerEMSshrCountryList);
    }

    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerEMAtimdmNacionalidadList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMATIMDMNACIONALIDADLIST);
    }

    public void setBusinessPartnerEMAtimdmNacionalidadList(List<BusinessPartner> businessPartnerEMAtimdmNacionalidadList) {
        set(PROPERTY_BUSINESSPARTNEREMATIMDMNACIONALIDADLIST, businessPartnerEMAtimdmNacionalidadList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMObretcoDbpCountryidList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMOBRETCODBPCOUNTRYIDLIST);
    }

    public void setOrganizationEMObretcoDbpCountryidList(List<Organization> organizationEMObretcoDbpCountryidList) {
        set(PROPERTY_ORGANIZATIONEMOBRETCODBPCOUNTRYIDLIST, organizationEMObretcoDbpCountryidList);
    }

    @SuppressWarnings("unchecked")
    public List<OrganizationInformation> getOrganizationInformationEMSorgiCountryIDList() {
      return (List<OrganizationInformation>) get(PROPERTY_ORGANIZATIONINFORMATIONEMSORGICOUNTRYIDLIST);
    }

    public void setOrganizationInformationEMSorgiCountryIDList(List<OrganizationInformation> organizationInformationEMSorgiCountryIDList) {
        set(PROPERTY_ORGANIZATIONINFORMATIONEMSORGICOUNTRYIDLIST, organizationInformationEMSorgiCountryIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Scrvro_VendorRouteConfig> getScrvroVendorRouteConfigList() {
      return (List<Scrvro_VendorRouteConfig>) get(PROPERTY_SCRVROVENDORROUTECONFIGLIST);
    }

    public void setScrvroVendorRouteConfigList(List<Scrvro_VendorRouteConfig> scrvroVendorRouteConfigList) {
        set(PROPERTY_SCRVROVENDORROUTECONFIGLIST, scrvroVendorRouteConfigList);
    }

    @SuppressWarnings("unchecked")
    public List<sshrEducation> getSshrQeducationCountryList() {
      return (List<sshrEducation>) get(PROPERTY_SSHRQEDUCATIONCOUNTRYLIST);
    }

    public void setSshrQeducationCountryList(List<sshrEducation> sshrQeducationCountryList) {
        set(PROPERTY_SSHRQEDUCATIONCOUNTRYLIST, sshrQeducationCountryList);
    }
