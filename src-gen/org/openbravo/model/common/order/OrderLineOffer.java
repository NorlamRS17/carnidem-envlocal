...
public class OrderLineOffer extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBDISCQTYOFFER = "obdiscQtyoffer";
    public static final String PROPERTY_OBDISCIDENTIFIER = "obdiscIdentifier";
    ...
    public BigDecimal getObdiscQtyoffer() {
        return (BigDecimal) get(PROPERTY_OBDISCQTYOFFER);
    }

    public void setObdiscQtyoffer(BigDecimal obdiscQtyoffer) {
        set(PROPERTY_OBDISCQTYOFFER, obdiscQtyoffer);
    }

    public String getObdiscIdentifier() {
        return (String) get(PROPERTY_OBDISCIDENTIFIER);
    }

    public void setObdiscIdentifier(String obdiscIdentifier) {
        set(PROPERTY_OBDISCIDENTIFIER, obdiscIdentifier);
    }
