...
public class Characteristic extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBPOSFILTERONWEBPOS = "obposFilteronwebpos";
    public static final String PROPERTY_EXPLODECONFIGURATIONTAB = "explodeConfigurationTab";
    public static final String PROPERTY_OBPOSUSEONWEBPOS = "obposUseonwebpos";
    ...
    public Characteristic() {
        ...
        setDefaultValue(PROPERTY_OBPOSFILTERONWEBPOS, true);
        setDefaultValue(PROPERTY_EXPLODECONFIGURATIONTAB, true);
        setDefaultValue(PROPERTY_OBPOSUSEONWEBPOS, true);
    ...
    public Boolean isObposFilteronwebpos() {
        return (Boolean) get(PROPERTY_OBPOSFILTERONWEBPOS);
    }

    public void setObposFilteronwebpos(Boolean obposFilteronwebpos) {
        set(PROPERTY_OBPOSFILTERONWEBPOS, obposFilteronwebpos);
    }
    ...
    public Boolean isObposUseonwebpos() {
        return (Boolean) get(PROPERTY_OBPOSUSEONWEBPOS);
    }

    public void setObposUseonwebpos(Boolean obposUseonwebpos) {
        set(PROPERTY_OBPOSUSEONWEBPOS, obposUseonwebpos);
    }
