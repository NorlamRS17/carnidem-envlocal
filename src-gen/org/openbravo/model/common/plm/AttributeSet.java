...
public class AttributeSet extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCPLAGISALTIDENTIFIER = "scplagIsaltIdentifier";
    public static final String PROPERTY_SCPLAGISELABORATIONDATE = "scplagIselaborationdate";
    public static final String PROPERTY_SCPLAGISPACKAGE = "scplagIspackage";
    public static final String PROPERTY_CSLJJULIANDATE = "csljJuliandate";
    public static final String PROPERTY_CSLJPRIORITY = "csljPriority";
    ...
    public AttributeSet() {
        ...
        setDefaultValue(PROPERTY_SCPLAGISALTIDENTIFIER, false);
        setDefaultValue(PROPERTY_SCPLAGISELABORATIONDATE, false);
        setDefaultValue(PROPERTY_SCPLAGISPACKAGE, false);
        setDefaultValue(PROPERTY_CSLJJULIANDATE, false);
    ...
    public Boolean isScplagIsaltIdentifier() {
        return (Boolean) get(PROPERTY_SCPLAGISALTIDENTIFIER);
    }

    public void setScplagIsaltIdentifier(Boolean scplagIsaltIdentifier) {
        set(PROPERTY_SCPLAGISALTIDENTIFIER, scplagIsaltIdentifier);
    }

    public Boolean isScplagIselaborationdate() {
        return (Boolean) get(PROPERTY_SCPLAGISELABORATIONDATE);
    }

    public void setScplagIselaborationdate(Boolean scplagIselaborationdate) {
        set(PROPERTY_SCPLAGISELABORATIONDATE, scplagIselaborationdate);
    }

    public Boolean isScplagIspackage() {
        return (Boolean) get(PROPERTY_SCPLAGISPACKAGE);
    }

    public void setScplagIspackage(Boolean scplagIspackage) {
        set(PROPERTY_SCPLAGISPACKAGE, scplagIspackage);
    }

    public Boolean isCsljJuliandate() {
        return (Boolean) get(PROPERTY_CSLJJULIANDATE);
    }

    public void setCsljJuliandate(Boolean csljJuliandate) {
        set(PROPERTY_CSLJJULIANDATE, csljJuliandate);
    }

    public String getCsljPriority() {
        return (String) get(PROPERTY_CSLJPRIORITY);
    }

    public void setCsljPriority(String csljPriority) {
        set(PROPERTY_CSLJPRIORITY, csljPriority);
    }
