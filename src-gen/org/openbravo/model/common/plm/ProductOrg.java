...
public class ProductOrg extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCMFPERCENTAGE = "scmfPercentage";
    public static final String PROPERTY_MAXIMUMQTY = "maximumqty";
    public static final String PROPERTY_SCMFDISPERSIONVALUE = "scmfDispersionValue";
    public static final String PROPERTY_SCMFSTORETYPE = "scmfStoretype";
    public static final String PROPERTY_SCMFMINIMUMCYCLE = "scmfMinimumCycle";
    ...
    public BigDecimal getScmfPercentage() {
        return (BigDecimal) get(PROPERTY_SCMFPERCENTAGE);
    }

    public void setScmfPercentage(BigDecimal scmfPercentage) {
        set(PROPERTY_SCMFPERCENTAGE, scmfPercentage);
    }
    ...
    public BigDecimal getScmfDispersionValue() {
        return (BigDecimal) get(PROPERTY_SCMFDISPERSIONVALUE);
    }

    public void setScmfDispersionValue(BigDecimal scmfDispersionValue) {
        set(PROPERTY_SCMFDISPERSIONVALUE, scmfDispersionValue);
    }

    public ScmfStoreType getScmfStoretype() {
        return (ScmfStoreType) get(PROPERTY_SCMFSTORETYPE);
    }

    public void setScmfStoretype(ScmfStoreType scmfStoretype) {
        set(PROPERTY_SCMFSTORETYPE, scmfStoretype);
    }

    public String getScmfMinimumCycle() {
        return (String) get(PROPERTY_SCMFMINIMUMCYCLE);
    }

    public void setScmfMinimumCycle(String scmfMinimumCycle) {
        set(PROPERTY_SCMFMINIMUMCYCLE, scmfMinimumCycle);
    }
