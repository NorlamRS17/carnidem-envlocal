...
public class CategoryAccounts extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSDACCTDISCOUNT = "ssdacctDiscount";
    public static final String PROPERTY_SSTPCCOSTPROCESSPROD = "sstpcCostProcessProd";
    public static final String PROPERTY_SSTPCPROJECTCOSTS = "sSTPCProjectCosts";
    ...
    public AccountingCombination getSsdacctDiscount() {
        return (AccountingCombination) get(PROPERTY_SSDACCTDISCOUNT);
    }

    public void setSsdacctDiscount(AccountingCombination ssdacctDiscount) {
        set(PROPERTY_SSDACCTDISCOUNT, ssdacctDiscount);
    }

    public AccountingCombination getSstpcCostProcessProd() {
        return (AccountingCombination) get(PROPERTY_SSTPCCOSTPROCESSPROD);
    }

    public void setSstpcCostProcessProd(AccountingCombination sstpcCostProcessProd) {
        set(PROPERTY_SSTPCCOSTPROCESSPROD, sstpcCostProcessProd);
    }

    public AccountingCombination getSSTPCProjectCosts() {
        return (AccountingCombination) get(PROPERTY_SSTPCPROJECTCOSTS);
    }

    public void setSSTPCProjectCosts(AccountingCombination sSTPCProjectCosts) {
        set(PROPERTY_SSTPCPROJECTCOSTS, sSTPCProjectCosts);
    }
