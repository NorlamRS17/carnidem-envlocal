...
public class ProductBOM extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SECUACMCOST = "secuacmCost";
    ...
    public BigDecimal getSecuacmCost() {
        return (BigDecimal) get(PROPERTY_SECUACMCOST);
    }

    public void setSecuacmCost(BigDecimal secuacmCost) {
        set(PROPERTY_SECUACMCOST, secuacmCost);
    }
