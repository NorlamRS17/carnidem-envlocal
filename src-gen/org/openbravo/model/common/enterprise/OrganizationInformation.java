...
public class OrganizationInformation extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBPOSSVALLOWNEGSTOCK = "obpossvAllownegstock";
    public static final String PROPERTY_ISDOUBLECASH = "isDoubleCash";
    public static final String PROPERTY_SORGICOUNTRY = "sorgiCountry";
    public static final String PROPERTY_APRMPAYMENTDESCRIPTION = "aPRMPaymentDescription";
    public static final String PROPERTY_SORGIREGION = "sorgiRegion";
    public static final String PROPERTY_SORGICANTON = "sorgiCanton";
    ...
    public OrganizationInformation() {
        ...
        setDefaultValue(PROPERTY_OBPOSSVALLOWNEGSTOCK, false);
    ...
    public Boolean isObpossvAllownegstock() {
        return (Boolean) get(PROPERTY_OBPOSSVALLOWNEGSTOCK);
    }

    public void setObpossvAllownegstock(Boolean obpossvAllownegstock) {
        set(PROPERTY_OBPOSSVALLOWNEGSTOCK, obpossvAllownegstock);
    }
    ...
    public Country getSorgiCountry() {
        return (Country) get(PROPERTY_SORGICOUNTRY);
    }

    public void setSorgiCountry(Country sorgiCountry) {
        set(PROPERTY_SORGICOUNTRY, sorgiCountry);
    }
    ...
    public Region getSorgiRegion() {
        return (Region) get(PROPERTY_SORGIREGION);
    }

    public void setSorgiRegion(Region sorgiRegion) {
        set(PROPERTY_SORGIREGION, sorgiRegion);
    }

    public secpm_canton getSorgiCanton() {
        return (secpm_canton) get(PROPERTY_SORGICANTON);
    }

    public void setSorgiCanton(secpm_canton sorgiCanton) {
        set(PROPERTY_SORGICANTON, sorgiCanton);
    }
