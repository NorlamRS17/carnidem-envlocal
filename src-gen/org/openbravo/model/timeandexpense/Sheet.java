...
public class Sheet extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SPROCTMCDOCTYPE = "sproctmCDoctype";
    ...
    public DocumentType getSproctmCDoctype() {
        return (DocumentType) get(PROPERTY_SPROCTMCDOCTYPE);
    }

    public void setSproctmCDoctype(DocumentType sproctmCDoctype) {
        set(PROPERTY_SPROCTMCDOCTYPE, sproctmCDoctype);
    }
