...
public class Requisition extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SINNAPPAPPROVENEED = "sinnappApproveNeed";
    public static final String PROPERTY_SINNAPPAPPROVED = "sinnappApproved";
    public static final String PROPERTY_SINNAPPAPPROVEDBY = "sinnappApprovedby";
    ...
    public Requisition() {
        ...
        setDefaultValue(PROPERTY_SINNAPPAPPROVENEED, false);
    ...
    public Boolean isSinnappApproveNeed() {
        return (Boolean) get(PROPERTY_SINNAPPAPPROVENEED);
    }

    public void setSinnappApproveNeed(Boolean sinnappApproveNeed) {
        set(PROPERTY_SINNAPPAPPROVENEED, sinnappApproveNeed);
    }

    public Date getSinnappApproved() {
        return (Date) get(PROPERTY_SINNAPPAPPROVED);
    }

    public void setSinnappApproved(Date sinnappApproved) {
        set(PROPERTY_SINNAPPAPPROVED, sinnappApproved);
    }

    public User getSinnappApprovedby() {
        return (User) get(PROPERTY_SINNAPPAPPROVEDBY);
    }

    public void setSinnappApprovedby(User sinnappApprovedby) {
        set(PROPERTY_SINNAPPAPPROVEDBY, sinnappApprovedby);
    }
