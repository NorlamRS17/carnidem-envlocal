...
import ec.com.sidesoft.imports.SSIPMeanstransport;
...
public class RequisitionLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSIPMEANSTRANSPORT = "ssipMeanstransport";
    ...
    public static final String PROPERTY_SPROCTMTASKPROD = "sproctmTaskProd";
    ...
    public SSIPMeanstransport getSsipMeanstransport() {
        return (SSIPMeanstransport) get(PROPERTY_SSIPMEANSTRANSPORT);
    }

    public void setSsipMeanstransport(SSIPMeanstransport ssipMeanstransport) {
        set(PROPERTY_SSIPMEANSTRANSPORT, ssipMeanstransport);
    }
    ...
    public SproctmTaskProd getSproctmTaskProd() {
        return (SproctmTaskProd) get(PROPERTY_SPROCTMTASKPROD);
    }

    public void setSproctmTaskProd(SproctmTaskProd sproctmTaskProd) {
        set(PROPERTY_SPROCTMTASKPROD, sproctmTaskProd);
    }
