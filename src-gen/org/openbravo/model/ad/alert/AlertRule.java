...
public class AlertRule extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SDEAISEMAIL = "sdeaIsemail";
    public static final String PROPERTY_SNMAALERTMOBILE = "sNMAAlertMobile";
    ...
    public AlertRule() {
        ...
        setDefaultValue(PROPERTY_SDEAISEMAIL, false);
        setDefaultValue(PROPERTY_SNMAALERTMOBILE, false);
    ...
    public Boolean isSdeaIsemail() {
        return (Boolean) get(PROPERTY_SDEAISEMAIL);
    }

    public void setSdeaIsemail(Boolean sdeaIsemail) {
        set(PROPERTY_SDEAISEMAIL, sdeaIsemail);
    }

    public Boolean isSNMAAlertMobile() {
        return (Boolean) get(PROPERTY_SNMAALERTMOBILE);
    }

    public void setSNMAAlertMobile(Boolean sNMAAlertMobile) {
        set(PROPERTY_SNMAALERTMOBILE, sNMAAlertMobile);
    }
