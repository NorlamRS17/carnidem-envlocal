...
import com.sidesoft.localization.ecuador.withholdings.SswhRptcSalesByStab;
...
import com.sidesoft.localization.ecuador.withholdings.SswhRptcSalesVoidedDetail;
...
import ec.com.sidesoft.custom.mrp.forecast.ScmfProductSubcategory;
...
import ec.com.sidesoft.custom.mrp.forecast.ScmfStoreType;
...
public class Client extends BaseOBObject implements Traceable, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBMOBCAUTHKEY = "obmobcAuthKey";
    public static final String PROPERTY_SSPRMANAGEBUDGET = "sSPRManageBudget";
    public static final String PROPERTY_DAYSTOPASSWORDEXPIRATION = "daysToPasswordExpiration";
    public static final String PROPERTY_OPCRMCLIENTIDBTN = "opcrmClientidBtn";
    ...
    public static final String PROPERTY_SSWHRPTCPURCHASEPAYMLIST = "sswhRptcPurchasePaymList";
    public static final String PROPERTY_SSWHRPTCPURCHASEWITHLIST = "sswhRptcPurchaseWithList";
    public static final String PROPERTY_SSWHRPTCSALESBYSTABLIST = "sswhRptcSalesByStabList";
    ...
    public static final String PROPERTY_SSWHRPTCSALESVOIDEDLIST = "sswhRptcSalesVoidedList";
    ...
    public static final String PROPERTY_SCMFSTORETYPELIST = "scmfStoretypeList";
    ...
    public Client() {
        ...
        setDefaultValue(PROPERTY_SSPRMANAGEBUDGET, false);
        setDefaultValue(PROPERTY_DAYSTOPASSWORDEXPIRATION, (long) 0);
        setDefaultValue(PROPERTY_OPCRMCLIENTIDBTN, false);
        ...
        setDefaultValue(PROPERTY_SSWHRPTCPURCHASEPAYMLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSWHRPTCPURCHASEWITHLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSWHRPTCSALESBYSTABLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SSWHRPTCSALESVOIDEDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SCMFSTORETYPELIST, new ArrayList<Object>());
    }
    ...
    public String getObmobcAuthKey() {
        return (String) get(PROPERTY_OBMOBCAUTHKEY);
    }

    public void setObmobcAuthKey(String obmobcAuthKey) {
        set(PROPERTY_OBMOBCAUTHKEY, obmobcAuthKey);
    }

    public Boolean isSSPRManageBudget() {
        return (Boolean) get(PROPERTY_SSPRMANAGEBUDGET);
    }

    public void setSSPRManageBudget(Boolean sSPRManageBudget) {
        set(PROPERTY_SSPRMANAGEBUDGET, sSPRManageBudget);
    }
    ...
    public Boolean isOpcrmClientidBtn() {
        return (Boolean) get(PROPERTY_OPCRMCLIENTIDBTN);
    }

    public void setOpcrmClientidBtn(Boolean opcrmClientidBtn) {
        set(PROPERTY_OPCRMCLIENTIDBTN, opcrmClientidBtn);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SswhRptcPurchasePaym> getSswhRptcPurchasePaymList() {
      return (List<SswhRptcPurchasePaym>) get(PROPERTY_SSWHRPTCPURCHASEPAYMLIST);
    }

    public void setSswhRptcPurchasePaymList(List<SswhRptcPurchasePaym> sswhRptcPurchasePaymList) {
        set(PROPERTY_SSWHRPTCPURCHASEPAYMLIST, sswhRptcPurchasePaymList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SswhRptcSalesByStab> getSswhRptcSalesByStabList() {
      return (List<SswhRptcSalesByStab>) get(PROPERTY_SSWHRPTCSALESBYSTABLIST);
    }

    public void setSswhRptcSalesByStabList(List<SswhRptcSalesByStab> sswhRptcSalesByStabList) {
        set(PROPERTY_SSWHRPTCSALESBYSTABLIST, sswhRptcSalesByStabList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SswhRptcSalesVoidedDetail> getSswhRptcSalesVoidedList() {
      return (List<SswhRptcSalesVoidedDetail>) get(PROPERTY_SSWHRPTCSALESVOIDEDLIST);
    }

    public void setSswhRptcSalesVoidedList(List<SswhRptcSalesVoidedDetail> sswhRptcSalesVoidedList) {
        set(PROPERTY_SSWHRPTCSALESVOIDEDLIST, sswhRptcSalesVoidedList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ScmfStoreType> getScmfStoretypeList() {
      return (List<ScmfStoreType>) get(PROPERTY_SCMFSTORETYPELIST);
    }

    public void setScmfStoretypeList(List<ScmfStoreType> scmfStoretypeList) {
        set(PROPERTY_SCMFSTORETYPELIST, scmfStoretypeList);
    }
