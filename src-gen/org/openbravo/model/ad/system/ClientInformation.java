...
public class ClientInformation extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBPOSCOMPANYLOGINIMAGE = "obposCompanyLoginImage";
    ...
    public static final String PROPERTY_OBPOSSVSTOCKORG = "obpossvStockorg";
    public static final String PROPERTY_SSPRCBPARTNER = "ssprCBpartner";
    public static final String PROPERTY_OPCRMSNPRO = "opcrmSnPro";
    ...
    public ClientInformation() {
        ...
        setDefaultValue(PROPERTY_OBPOSSVSTOCKORG, false);
    }
    ...
    public Image getObposCompanyLoginImage() {
        return (Image) get(PROPERTY_OBPOSCOMPANYLOGINIMAGE);
    }

    public void setObposCompanyLoginImage(Image obposCompanyLoginImage) {
        set(PROPERTY_OBPOSCOMPANYLOGINIMAGE, obposCompanyLoginImage);
    }
    ...
    public Boolean isObpossvStockorg() {
        return (Boolean) get(PROPERTY_OBPOSSVSTOCKORG);
    }

    public void setObpossvStockorg(Boolean obpossvStockorg) {
        set(PROPERTY_OBPOSSVSTOCKORG, obpossvStockorg);
    }

    public BusinessPartner getSsprCBpartner() {
        return (BusinessPartner) get(PROPERTY_SSPRCBPARTNER);
    }

    public void setSsprCBpartner(BusinessPartner ssprCBpartner) {
        set(PROPERTY_SSPRCBPARTNER, ssprCBpartner);
    }

    public String getOpcrmSnPro() {
        return (String) get(PROPERTY_OPCRMSNPRO);
    }

    public void setOpcrmSnPro(String opcrmSnPro) {
        set(PROPERTY_OPCRMSNPRO, opcrmSnPro);
    }
