...
import ec.com.sidesoft.unnoparts.extended.config.SsuecActions;
...
public class List extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    @SuppressWarnings("unchecked")
    public java.util.List<SsuecActions> getSsuecActionsList() {
      return (java.util.List<SsuecActions>) get(PROPERTY_SSUECACTIONSLIST);
    }

    public void setSsuecActionsList(java.util.List<SsuecActions> ssuecActionsList) {
