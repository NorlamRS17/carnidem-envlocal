...
import ec.cusoft.facturaec.EEIRemissionGuideLog;
...
public class Table extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_EEIREMISSIONGUIDELOGLIST = "eEIRemissionGuideLogList";
    ...
    public static final String PROPERTY_OBRECTXTEMPLATETYPELIST = "oBRECTXTemplateTypeList";
    ...
    public static final String PROPERTY_TABLENAVIGATIONLIST = "tableNavigationList";
    ...
    public Table() {
        ...
        setDefaultValue(PROPERTY_EEIREMISSIONGUIDELOGLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OBRECTXTEMPLATETYPELIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_TABLENAVIGATIONLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<EEIRemissionGuideLog> getEEIRemissionGuideLogList() {
      return (List<EEIRemissionGuideLog>) get(PROPERTY_EEIREMISSIONGUIDELOGLIST);
    }

    public void setEEIRemissionGuideLogList(List<EEIRemissionGuideLog> eEIRemissionGuideLogList) {
        set(PROPERTY_EEIREMISSIONGUIDELOGLIST, eEIRemissionGuideLogList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<TemplateType> getOBRECTXTemplateTypeList() {
      return (List<TemplateType>) get(PROPERTY_OBRECTXTEMPLATETYPELIST);
    }

    public void setOBRECTXTemplateTypeList(List<TemplateType> oBRECTXTemplateTypeList) {
        set(PROPERTY_OBRECTXTEMPLATETYPELIST, oBRECTXTemplateTypeList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<TableNavigation> getTableNavigationList() {
      return (List<TableNavigation>) get(PROPERTY_TABLENAVIGATIONLIST);
    }

    public void setTableNavigationList(List<TableNavigation> tableNavigationList) {
        set(PROPERTY_TABLENAVIGATIONLIST, tableNavigationList);
    }
