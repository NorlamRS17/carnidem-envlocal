...
public class Column extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ADTABLETREELINKTOPARENTCOLUMNLIST = "aDTableTreeLinkToParentColumnList";
    public static final String PROPERTY_ADTABLETREENODEIDCOLUMNLIST = "aDTableTreeNodeIdColumnList";
    ...
    public static final String PROPERTY_OBULOGCONFIGLIST = "oBULOGConfigList";
    public static final String PROPERTY_SSACHASSETSCHANGESLIST = "ssachAssetsChangesList";
    ...
    public Column() {
        ...
        setDefaultValue(PROPERTY_ADTABLETREELINKTOPARENTCOLUMNLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ADTABLETREENODEIDCOLUMNLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OBULOGCONFIGLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSACHASSETSCHANGESLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<TableTree> getADTableTreeLinkToParentColumnList() {
      return (List<TableTree>) get(PROPERTY_ADTABLETREELINKTOPARENTCOLUMNLIST);
    }

    public void setADTableTreeLinkToParentColumnList(List<TableTree> aDTableTreeLinkToParentColumnList) {
        set(PROPERTY_ADTABLETREELINKTOPARENTCOLUMNLIST, aDTableTreeLinkToParentColumnList);
    }

    @SuppressWarnings("unchecked")
    public List<TableTree> getADTableTreeNodeIdColumnList() {
      return (List<TableTree>) get(PROPERTY_ADTABLETREENODEIDCOLUMNLIST);
    }

    public void setADTableTreeNodeIdColumnList(List<TableTree> aDTableTreeNodeIdColumnList) {
        set(PROPERTY_ADTABLETREENODEIDCOLUMNLIST, aDTableTreeNodeIdColumnList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<LogCleanUpConfig> getOBULOGConfigList() {
      return (List<LogCleanUpConfig>) get(PROPERTY_OBULOGCONFIGLIST);
    }

    public void setOBULOGConfigList(List<LogCleanUpConfig> oBULOGConfigList) {
        set(PROPERTY_OBULOGCONFIGLIST, oBULOGConfigList);
    }

    @SuppressWarnings("unchecked")
    public List<AssetsChanges> getSsachAssetsChangesList() {
      return (List<AssetsChanges>) get(PROPERTY_SSACHASSETSCHANGESLIST);
    }

    public void setSsachAssetsChangesList(List<AssetsChanges> ssachAssetsChangesList) {
        set(PROPERTY_SSACHASSETSCHANGESLIST, ssachAssetsChangesList);
    }
