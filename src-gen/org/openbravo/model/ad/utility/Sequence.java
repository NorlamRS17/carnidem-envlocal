...
public class Sequence extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SPROCTMPROJECTSEQ = "sproctmProjectSeq";
    public static final String PROPERTY_DOCUMENTTYPEDOCUMENTSEQUENCELIST = "documentTypeDocumentSequenceList";
    public static final String PROPERTY_DOCUMENTTYPEEMSPDNSEQUENCEIDLIST = "documentTypeEMSpdnSequenceIDList";
    public static final String PROPERTY_FINANCIALMGMTTAXREGISTERTYPELIST = "financialMgmtTaxRegisterTypeList";
    public static final String PROPERTY_MATERIALMGMTREFERENCEDINVENTORYTYPELIST = "materialMgmtReferencedInventoryTypeList";
    ...
    public Sequence() {
        ...
        setDefaultValue(PROPERTY_SPROCTMPROJECTSEQ, false);
        setDefaultValue(PROPERTY_DOCUMENTTYPEDOCUMENTSEQUENCELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_DOCUMENTTYPEEMSPDNSEQUENCEIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_FINANCIALMGMTTAXREGISTERTYPELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_MATERIALMGMTREFERENCEDINVENTORYTYPELIST, new ArrayList<Object>());
    ...
    public Boolean isSproctmProjectSeq() {
        return (Boolean) get(PROPERTY_SPROCTMPROJECTSEQ);
    }

    public void setSproctmProjectSeq(Boolean sproctmProjectSeq) {
        set(PROPERTY_SPROCTMPROJECTSEQ, sproctmProjectSeq);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<DocumentType> getDocumentTypeEMSpdnSequenceIDList() {
      return (List<DocumentType>) get(PROPERTY_DOCUMENTTYPEEMSPDNSEQUENCEIDLIST);
    }

    public void setDocumentTypeEMSpdnSequenceIDList(List<DocumentType> documentTypeEMSpdnSequenceIDList) {
        set(PROPERTY_DOCUMENTTYPEEMSPDNSEQUENCEIDLIST, documentTypeEMSpdnSequenceIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ReferencedInventoryType> getMaterialMgmtReferencedInventoryTypeList() {
      return (List<ReferencedInventoryType>) get(PROPERTY_MATERIALMGMTREFERENCEDINVENTORYTYPELIST);
    }

    public void setMaterialMgmtReferencedInventoryTypeList(List<ReferencedInventoryType> materialMgmtReferencedInventoryTypeList) {
        set(PROPERTY_MATERIALMGMTREFERENCEDINVENTORYTYPELIST, materialMgmtReferencedInventoryTypeList);
    }
