...
public class Image extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_CLIENTINFORMATIONEMOBPOSCOMPANYLOGINIMAGELIST = "clientInformationEMObposCompanyLoginImageList";
    public static final String PROPERTY_OBPOSAPPPAYMENTTYPELIST = "oBPOSAppPaymentTypeList";
    public static final String PROPERTY_ORDERLINEEMSPROCTMADIMGTASKIDLIST = "orderLineEMSproctmAdImgTaskIDList";
    ...
    public static final String PROPERTY_PRICINGADJUSTMENTEMOBDISCIMAGELIST = "pricingAdjustmentEMObdiscImageList";
    ...
    public static final String PROPERTY_PROJECTTASKEMSPROCTMADIMAGEIDLIST = "projectTaskEMSproctmAdImageIDList";
    public static final String PROPERTY_PROMOTIONTYPEEMOBPOSIMAGELIST = "promotionTypeEMObposImageList";
    ...
    public Image() {
        ...
        setDefaultValue(PROPERTY_CLIENTINFORMATIONEMOBPOSCOMPANYLOGINIMAGELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OBPOSAPPPAYMENTTYPELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ORDERLINEEMSPROCTMADIMGTASKIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ORGANIZATIONINFORMATIONYOURCOMPANYDOCUMENTIMAGELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PRICINGADJUSTMENTEMOBDISCIMAGELIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_PROJECTTASKEMSPROCTMADIMAGEIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROMOTIONTYPEEMOBPOSIMAGELIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<ClientInformation> getClientInformationEMObposCompanyLoginImageList() {
      return (List<ClientInformation>) get(PROPERTY_CLIENTINFORMATIONEMOBPOSCOMPANYLOGINIMAGELIST);
    }

    public void setClientInformationEMObposCompanyLoginImageList(List<ClientInformation> clientInformationEMObposCompanyLoginImageList) {
        set(PROPERTY_CLIENTINFORMATIONEMOBPOSCOMPANYLOGINIMAGELIST, clientInformationEMObposCompanyLoginImageList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OrderLine> getOrderLineEMSproctmAdImgTaskIDList() {
      return (List<OrderLine>) get(PROPERTY_ORDERLINEEMSPROCTMADIMGTASKIDLIST);
    }

    public void setOrderLineEMSproctmAdImgTaskIDList(List<OrderLine> orderLineEMSproctmAdImgTaskIDList) {
        set(PROPERTY_ORDERLINEEMSPROCTMADIMGTASKIDLIST, orderLineEMSproctmAdImgTaskIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<PriceAdjustment> getPricingAdjustmentEMObdiscImageList() {
      return (List<PriceAdjustment>) get(PROPERTY_PRICINGADJUSTMENTEMOBDISCIMAGELIST);
    }

    public void setPricingAdjustmentEMObdiscImageList(List<PriceAdjustment> pricingAdjustmentEMObdiscImageList) {
        set(PROPERTY_PRICINGADJUSTMENTEMOBDISCIMAGELIST, pricingAdjustmentEMObdiscImageList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ProjectTask> getProjectTaskEMSproctmAdImageIDList() {
      return (List<ProjectTask>) get(PROPERTY_PROJECTTASKEMSPROCTMADIMAGEIDLIST);
    }

    public void setProjectTaskEMSproctmAdImageIDList(List<ProjectTask> projectTaskEMSproctmAdImageIDList) {
        set(PROPERTY_PROJECTTASKEMSPROCTMADIMAGEIDLIST, projectTaskEMSproctmAdImageIDList);
    }

    @SuppressWarnings("unchecked")
    public List<PromotionType> getPromotionTypeEMObposImageList() {
      return (List<PromotionType>) get(PROPERTY_PROMOTIONTYPEEMOBPOSIMAGELIST);
    }

    public void setPromotionTypeEMObposImageList(List<PromotionType> promotionTypeEMObposImageList) {
        set(PROPERTY_PROMOTIONTYPEEMOBPOSIMAGELIST, promotionTypeEMObposImageList);
    }
