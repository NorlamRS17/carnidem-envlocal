...
public class Session extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBPOSSTOREORG = "obposStoreOrg";
    ...
    public Organization getObposStoreOrg() {
        return (Organization) get(PROPERTY_OBPOSSTOREORG);
    }

    public void setObposStoreOrg(Organization obposStoreOrg) {
        set(PROPERTY_OBPOSSTOREORG, obposStoreOrg);
    }
