...
public class Role extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBPOSDEFAULTPOSLANGUAGE = "oBPOSDefaultPosLanguage";
    public static final String PROPERTY_TEMPLATE = "template";
    public static final String PROPERTY_RECALCULATEPERMISSIONS = "recalculatePermissions";
    public static final String PROPERTY_SCCACASHIER = "sccaCashier";
    public static final String PROPERTY_SCCCCLOSINGDATE = "scccClosingdate";
    public static final String PROPERTY_SCCAADMINISTRATOR = "sccaAdministrator";
    public static final String PROPERTY_SLCBISPROCESSEDBYCHECKBOOK = "sLCBIsProcessedByCheckbook";
    public static final String PROPERTY_SSPTDLTELECOMMDIALING = "ssptdlTelecommDialing";
    public static final String PROPERTY_SINNAPPISMNMANAGER = "sinnappIsMnManager";
    ...
    public static final String PROPERTY_ADUSEREMOBPOSDEFAULTPOSROLELIST = "aDUserEMOBPOSDefaultPOSRoleList";
    ...
    public Role() {
        ...
        setDefaultValue(PROPERTY_SCCACASHIER, true);
        setDefaultValue(PROPERTY_SCCCCLOSINGDATE, false);
        setDefaultValue(PROPERTY_SCCAADMINISTRATOR, false);
        setDefaultValue(PROPERTY_SLCBISPROCESSEDBYCHECKBOOK, false);
        setDefaultValue(PROPERTY_SSPTDLTELECOMMDIALING, false);
        setDefaultValue(PROPERTY_SINNAPPISMNMANAGER, false);
        ...
        setDefaultValue(PROPERTY_ADUSEREMOBPOSDEFAULTPOSROLELIST, new ArrayList<Object>());
    ...
    public Language getOBPOSDefaultPosLanguage() {
        return (Language) get(PROPERTY_OBPOSDEFAULTPOSLANGUAGE);
    }

    public void setOBPOSDefaultPosLanguage(Language oBPOSDefaultPosLanguage) {
        set(PROPERTY_OBPOSDEFAULTPOSLANGUAGE, oBPOSDefaultPosLanguage);
    }
    ...
    public Boolean isSccaCashier() {
        return (Boolean) get(PROPERTY_SCCACASHIER);
    }

    public void setSccaCashier(Boolean sccaCashier) {
        set(PROPERTY_SCCACASHIER, sccaCashier);
    }

    public Boolean isScccClosingdate() {
        return (Boolean) get(PROPERTY_SCCCCLOSINGDATE);
    }

    public void setScccClosingdate(Boolean scccClosingdate) {
        set(PROPERTY_SCCCCLOSINGDATE, scccClosingdate);
    }

    public Boolean isSccaAdministrator() {
        return (Boolean) get(PROPERTY_SCCAADMINISTRATOR);
    }

    public void setSccaAdministrator(Boolean sccaAdministrator) {
        set(PROPERTY_SCCAADMINISTRATOR, sccaAdministrator);
    }

    public Boolean isSLCBIsProcessedByCheckbook() {
        return (Boolean) get(PROPERTY_SLCBISPROCESSEDBYCHECKBOOK);
    }

    public void setSLCBIsProcessedByCheckbook(Boolean sLCBIsProcessedByCheckbook) {
        set(PROPERTY_SLCBISPROCESSEDBYCHECKBOOK, sLCBIsProcessedByCheckbook);
    }

    public Boolean isSsptdlTelecommDialing() {
        return (Boolean) get(PROPERTY_SSPTDLTELECOMMDIALING);
    }

    public void setSsptdlTelecommDialing(Boolean ssptdlTelecommDialing) {
        set(PROPERTY_SSPTDLTELECOMMDIALING, ssptdlTelecommDialing);
    }

    public Boolean isSinnappIsMnManager() {
        return (Boolean) get(PROPERTY_SINNAPPISMNMANAGER);
    }

    public void setSinnappIsMnManager(Boolean sinnappIsMnManager) {
        set(PROPERTY_SINNAPPISMNMANAGER, sinnappIsMnManager);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<User> getADUserEMOBPOSDefaultPOSRoleList() {
      return (List<User>) get(PROPERTY_ADUSEREMOBPOSDEFAULTPOSROLELIST);
    }

    public void setADUserEMOBPOSDefaultPOSRoleList(List<User> aDUserEMOBPOSDefaultPOSRoleList) {
        set(PROPERTY_ADUSEREMOBPOSDEFAULTPOSROLELIST, aDUserEMOBPOSDefaultPOSRoleList);
    }
