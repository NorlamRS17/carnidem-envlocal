...
public class Module extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBPOSPRINTTEMPLATELIST = "oBPOSPrintTemplateList";
    ...
    public Module() {
        ...
        setDefaultValue(PROPERTY_OBPOSPRINTTEMPLATELIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<PrintTemplate> getOBPOSPrintTemplateList() {
      return (List<PrintTemplate>) get(PROPERTY_OBPOSPRINTTEMPLATELIST);
    }

    public void setOBPOSPrintTemplateList(List<PrintTemplate> oBPOSPrintTemplateList) {
        set(PROPERTY_OBPOSPRINTTEMPLATELIST, oBPOSPrintTemplateList);
    }
