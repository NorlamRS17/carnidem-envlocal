...
import org.openbravo.model.ad.access.ProcessGroupExecution;
...
public class ProcessRequest extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SBKPDATEPROSSES = "sbkpDateprosses";
    public static final String PROPERTY_SBKPIMPORTANTINFO = "sbkpImportantInfo";
    ...
    public static final String PROPERTY_PROCESSREQUESTTRIGGEREDBYGROUPLIST = "processRequestTriggeredByGroupList";
    ...
    public ProcessRequest() {
        ...
        setDefaultValue(PROPERTY_PROCESSREQUESTTRIGGEREDBYGROUPLIST, new ArrayList<Object>());
    ...
    public Date getSbkpDateprosses() {
        return (Date) get(PROPERTY_SBKPDATEPROSSES);
    }

    public void setSbkpDateprosses(Date sbkpDateprosses) {
        set(PROPERTY_SBKPDATEPROSSES, sbkpDateprosses);
    }

    public String getSbkpImportantInfo() {
        return (String) get(PROPERTY_SBKPIMPORTANTINFO);
    }

    public void setSbkpImportantInfo(String sbkpImportantInfo) {
        set(PROPERTY_SBKPIMPORTANTINFO, sbkpImportantInfo);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ProcessRequest> getProcessRequestTriggeredByGroupList() {
      return (List<ProcessRequest>) get(PROPERTY_PROCESSREQUESTTRIGGEREDBYGROUPLIST);
    }

    public void setProcessRequestTriggeredByGroupList(List<ProcessRequest> processRequestTriggeredByGroupList) {
        set(PROPERTY_PROCESSREQUESTTRIGGEREDBYGROUPLIST, processRequestTriggeredByGroupList);
    }
