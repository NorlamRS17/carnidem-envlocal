...
import ec.com.sidesoft.localization.report.notposted.CslrnpDataNotPosted;
import ec.com.sidesoft.standar.validations.SssvStandarValidations;
...
public class Tab extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSSVSTANDARVALIDATIONSLIST = "sSSVStandarValidationsList";
    public static final String PROPERTY_TABLENAVIGATIONLIST = "tableNavigationList";
    public static final String PROPERTY_CSLRNPDATANOTPOSTEDTABIDLIST = "cslrnpDataNotpostedTABIDList";
    ...
    public Tab() {
        ...
        setDefaultValue(PROPERTY_SSSVSTANDARVALIDATIONSLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_TABLENAVIGATIONLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_CSLRNPDATANOTPOSTEDTABIDLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SssvStandarValidations> getSSSVStandarValidationsList() {
      return (List<SssvStandarValidations>) get(PROPERTY_SSSVSTANDARVALIDATIONSLIST);
    }

    public void setSSSVStandarValidationsList(List<SssvStandarValidations> sSSVStandarValidationsList) {
        set(PROPERTY_SSSVSTANDARVALIDATIONSLIST, sSSVStandarValidationsList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<CslrnpDataNotPosted> getCslrnpDataNotpostedTABIDList() {
      return (List<CslrnpDataNotPosted>) get(PROPERTY_CSLRNPDATANOTPOSTEDTABIDLIST);
    }

    public void setCslrnpDataNotpostedTABIDList(List<CslrnpDataNotPosted> cslrnpDataNotpostedTABIDList) {
        set(PROPERTY_CSLRNPDATANOTPOSTEDTABIDLIST, cslrnpDataNotpostedTABIDList);
    }
