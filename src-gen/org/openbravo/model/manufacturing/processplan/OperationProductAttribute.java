...
public class OperationProductAttribute extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCIASPECIALATT = "sciaSpecialatt";
    ...
    public String getSciaSpecialatt() {
        return (String) get(PROPERTY_SCIASPECIALATT);
    }

    public void setSciaSpecialatt(String sciaSpecialatt) {
        set(PROPERTY_SCIASPECIALATT, sciaSpecialatt);
    }
