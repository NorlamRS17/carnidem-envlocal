...
public class WorkRequirementProduct extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SPATMPINVENTORYLOCATION = "sPATMPInventoryLocation";
    ...
    public Locator getSPATMPInventoryLocation() {
        return (Locator) get(PROPERTY_SPATMPINVENTORYLOCATION);
    }

    public void setSPATMPInventoryLocation(Locator sPATMPInventoryLocation) {
        set(PROPERTY_SPATMPINVENTORYLOCATION, sPATMPInventoryLocation);
    }
