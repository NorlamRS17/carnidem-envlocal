...
public class WorkRequirement extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSPRODPMOVEMENTBTN = "ssprodpMovementBtn";
    public static final String PROPERTY_SSPRODPMOVEMENT = "ssprodpMovement";
    public static final String PROPERTY_SSPRODSECONDQTYSTOP = "ssprodSecondqtystop";
    public static final String PROPERTY_SSPRODPSTOP = "ssprodpStop";
    ...
    public static final String PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYWORKREQIDLIST = "manufacturingMeasureShiftEMSpqulyWorkreqIDList";
    public static final String PROPERTY_MANUFACTURINGWORKREQUIREMENTOPERATIONLIST = "manufacturingWorkRequirementOperationList";
    public static final String PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMSSFINMAWORKREQIDLIST = "materialMgmtInternalMovementEMSsfinMaWorkreqIDList";
    ...
    public WorkRequirement() {
        ...
        setDefaultValue(PROPERTY_SSPRODPMOVEMENTBTN, false);
        ...
        setDefaultValue(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYWORKREQIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_MANUFACTURINGWORKREQUIREMENTOPERATIONLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMSSFINMAWORKREQIDLIST, new ArrayList<Object>());
    ...
    public Boolean isSsprodpMovementBtn() {
        return (Boolean) get(PROPERTY_SSPRODPMOVEMENTBTN);
    }

    public void setSsprodpMovementBtn(Boolean ssprodpMovementBtn) {
        set(PROPERTY_SSPRODPMOVEMENTBTN, ssprodpMovementBtn);
    }

    public InternalMovement getSsprodpMovement() {
        return (InternalMovement) get(PROPERTY_SSPRODPMOVEMENT);
    }

    public void setSsprodpMovement(InternalMovement ssprodpMovement) {
        set(PROPERTY_SSPRODPMOVEMENT, ssprodpMovement);
    }

    public BigDecimal getSsprodSecondqtystop() {
        return (BigDecimal) get(PROPERTY_SSPRODSECONDQTYSTOP);
    }

    public void setSsprodSecondqtystop(BigDecimal ssprodSecondqtystop) {
        set(PROPERTY_SSPRODSECONDQTYSTOP, ssprodSecondqtystop);
    }

    public BigDecimal getSsprodpStop() {
        return (BigDecimal) get(PROPERTY_SSPRODPSTOP);
    }

    public void setSsprodpStop(BigDecimal ssprodpStop) {
        set(PROPERTY_SSPRODPSTOP, ssprodpStop);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<MeasureShift> getManufacturingMeasureShiftEMSpqulyWorkreqIDList() {
      return (List<MeasureShift>) get(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYWORKREQIDLIST);
    }

    public void setManufacturingMeasureShiftEMSpqulyWorkreqIDList(List<MeasureShift> manufacturingMeasureShiftEMSpqulyWorkreqIDList) {
        set(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYWORKREQIDLIST, manufacturingMeasureShiftEMSpqulyWorkreqIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<InternalMovement> getMaterialMgmtInternalMovementEMSsfinMaWorkreqIDList() {
      return (List<InternalMovement>) get(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMSSFINMAWORKREQIDLIST);
    }

    public void setMaterialMgmtInternalMovementEMSsfinMaWorkreqIDList(List<InternalMovement> materialMgmtInternalMovementEMSsfinMaWorkreqIDList) {
        set(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMSSFINMAWORKREQIDLIST, materialMgmtInternalMovementEMSsfinMaWorkreqIDList);
    }
