...
public class Machine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSPRODMACHINECAPACITY = "ssprodMachineCapacity";
    ...
    public String getSsprodMachineCapacity() {
        return (String) get(PROPERTY_SSPRODMACHINECAPACITY);
    }

    public void setSsprodMachineCapacity(String ssprodMachineCapacity) {
        set(PROPERTY_SSPRODMACHINECAPACITY, ssprodMachineCapacity);
    }
