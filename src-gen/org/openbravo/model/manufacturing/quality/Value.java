...
public class Value extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SLQSTYPEVALUE = "slqsTypeValue";
    public static final String PROPERTY_SLQSTEXT = "slqsText";
    public static final String PROPERTY_SLQSVALUE = "slqsValue";
    public static final String PROPERTY_SLQSTESTING = "slqsTesting";

    public Value() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_SLQSTESTING, false);
    }
    ...
    public String getSlqsTypeValue() {
        return (String) get(PROPERTY_SLQSTYPEVALUE);
    }

    public void setSlqsTypeValue(String slqsTypeValue) {
        set(PROPERTY_SLQSTYPEVALUE, slqsTypeValue);
    }

    public String getSlqsText() {
        return (String) get(PROPERTY_SLQSTEXT);
    }

    public void setSlqsText(String slqsText) {
        set(PROPERTY_SLQSTEXT, slqsText);
    }

    public BigDecimal getSlqsValue() {
        return (BigDecimal) get(PROPERTY_SLQSVALUE);
    }

    public void setSlqsValue(BigDecimal slqsValue) {
        set(PROPERTY_SLQSVALUE, slqsValue);
    }

    public Boolean isSlqsTesting() {
        return (Boolean) get(PROPERTY_SLQSTESTING);
    }

    public void setSlqsTesting(Boolean slqsTesting) {
        set(PROPERTY_SLQSTESTING, slqsTesting);
    }
