...
public class CheckPoint extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SPQULYLCI = "spqulyLci";
    public static final String PROPERTY_SPQULYLCS = "spqulyLcs";
    public static final String PROPERTY_CRPRODVO = "crprodVo";
    public static final String PROPERTY_MANUFACTURINGMEASUREVALUESLIST = "manufacturingMeasureValuesList";

    public CheckPoint() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_CRITICAL, true);
        setDefaultValue(PROPERTY_NUMBEROFMEASUREMENTS, (long) 1);
        setDefaultValue(PROPERTY_MANUFACTURINGMEASUREVALUESLIST, new ArrayList<Object>());
    }
    ...
    public BigDecimal getSpqulyLci() {
        return (BigDecimal) get(PROPERTY_SPQULYLCI);
    }

    public void setSpqulyLci(BigDecimal spqulyLci) {
        set(PROPERTY_SPQULYLCI, spqulyLci);
    }

    public BigDecimal getSpqulyLcs() {
        return (BigDecimal) get(PROPERTY_SPQULYLCS);
    }

    public void setSpqulyLcs(BigDecimal spqulyLcs) {
        set(PROPERTY_SPQULYLCS, spqulyLcs);
    }

    public BigDecimal getCrprodVo() {
        return (BigDecimal) get(PROPERTY_CRPRODVO);
    }

    public void setCrprodVo(BigDecimal crprodVo) {
        set(PROPERTY_CRPRODVO, crprodVo);
    }

    @SuppressWarnings("unchecked")
    public List<MeasureValues> getManufacturingMeasureValuesList() {
      return (List<MeasureValues>) get(PROPERTY_MANUFACTURINGMEASUREVALUESLIST);
    }

    public void setManufacturingMeasureValuesList(List<MeasureValues> manufacturingMeasureValuesList) {
        set(PROPERTY_MANUFACTURINGMEASUREVALUESLIST, manufacturingMeasureValuesList);
    }
