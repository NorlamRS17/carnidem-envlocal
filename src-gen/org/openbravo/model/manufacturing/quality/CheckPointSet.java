...
public class CheckPointSet extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYCCPIDLIST = "manufacturingMeasureShiftEMSpqulyCcpIDList";
    public static final String PROPERTY_CRPRODDIMENSIONLIST = "crprodDimensionList";
    ...
    public CheckPointSet() {
        ...
        setDefaultValue(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYCCPIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_CRPRODDIMENSIONLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<MeasureShift> getManufacturingMeasureShiftEMSpqulyCcpIDList() {
      return (List<MeasureShift>) get(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYCCPIDLIST);
    }

    public void setManufacturingMeasureShiftEMSpqulyCcpIDList(List<MeasureShift> manufacturingMeasureShiftEMSpqulyCcpIDList) {
        set(PROPERTY_MANUFACTURINGMEASURESHIFTEMSPQULYCCPIDLIST, manufacturingMeasureShiftEMSpqulyCcpIDList);
    }

    @SuppressWarnings("unchecked")
    public List<crprodDimension> getCrprodDimensionList() {
      return (List<crprodDimension>) get(PROPERTY_CRPRODDIMENSIONLIST);
    }

    public void setCrprodDimensionList(List<crprodDimension> crprodDimensionList) {
        set(PROPERTY_CRPRODDIMENSIONLIST, crprodDimensionList);
    }
