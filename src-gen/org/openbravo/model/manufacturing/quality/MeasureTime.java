...
public class MeasureTime extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SPQULYTAKENUMBER = "spqulyTakenumber";
    public static final String PROPERTY_CRPRODDESCRIPTION = "crprodDescription";
    ...
    public Long getSpqulyTakenumber() {
        return (Long) get(PROPERTY_SPQULYTAKENUMBER);
    }

    public void setSpqulyTakenumber(Long spqulyTakenumber) {
        set(PROPERTY_SPQULYTAKENUMBER, spqulyTakenumber);
    }

    public String getCrprodDescription() {
        return (String) get(PROPERTY_CRPRODDESCRIPTION);
    }

    public void setCrprodDescription(String crprodDescription) {
        set(PROPERTY_CRPRODDESCRIPTION, crprodDescription);
    }
