 ...
 */
public class Test extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "MA_PC_Test";
    public static final String ENTITY_NAME = "ManufacturingTest";
    ...
    public static final String PROPERTY_WAITINGPERIOD = "waitingPeriod";
    ...
    public Long getWaitingPeriod() {
        return (Long) get(PROPERTY_WAITINGPERIOD);
    }

    public void setWaitingPeriod(Long waitingPeriod) {
        set(PROPERTY_WAITINGPERIOD, waitingPeriod);
    }
