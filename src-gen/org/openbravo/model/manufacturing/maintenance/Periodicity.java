...
public class Periodicity extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCMAISWEEKENDMAINTENANCE = "scmaIsweekendMaintenance";
    public static final String PROPERTY_SCMAEND = "scmaEnd";
    public static final String PROPERTY_SCMASTART = "scmaStart";

    public Periodicity() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_EXCLUDEWEEKENDS, true);
        setDefaultValue(PROPERTY_SCMAISWEEKENDMAINTENANCE, false);
    }
    ...
    public Boolean isScmaIsweekendMaintenance() {
        return (Boolean) get(PROPERTY_SCMAISWEEKENDMAINTENANCE);
    }

    public void setScmaIsweekendMaintenance(Boolean scmaIsweekendMaintenance) {
        set(PROPERTY_SCMAISWEEKENDMAINTENANCE, scmaIsweekendMaintenance);
    }

    public Timestamp getScmaEnd() {
        return (Timestamp) get(PROPERTY_SCMAEND);
    }

    public void setScmaEnd(Timestamp scmaEnd) {
        set(PROPERTY_SCMAEND, scmaEnd);
    }

    public Timestamp getScmaStart() {
        return (Timestamp) get(PROPERTY_SCMASTART);
    }

    public void setScmaStart(Timestamp scmaStart) {
        set(PROPERTY_SCMASTART, scmaStart);
    }
