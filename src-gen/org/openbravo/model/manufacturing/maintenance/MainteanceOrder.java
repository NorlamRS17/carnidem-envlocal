...
public class MainteanceOrder extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCMABTNAPPROVE = "scmaBtnapprove";
    public static final String PROPERTY_SCMADOCSTATUS = "scmaDocstatus";
    ...
    public MainteanceOrder() {
        ...
        setDefaultValue(PROPERTY_SCMABTNAPPROVE, false);
        setDefaultValue(PROPERTY_SCMADOCSTATUS, "DR");
    ...
    public Boolean isScmaBtnapprove() {
        return (Boolean) get(PROPERTY_SCMABTNAPPROVE);
    }

    public void setScmaBtnapprove(Boolean scmaBtnapprove) {
        set(PROPERTY_SCMABTNAPPROVE, scmaBtnapprove);
    }

    public String getScmaDocstatus() {
        return (String) get(PROPERTY_SCMADOCSTATUS);
    }

    public void setScmaDocstatus(String scmaDocstatus) {
        set(PROPERTY_SCMADOCSTATUS, scmaDocstatus);
    }
