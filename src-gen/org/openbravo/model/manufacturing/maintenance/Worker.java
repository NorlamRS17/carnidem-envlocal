...
import org.openbravo.model.manufacturing.floorshop.Section;
/**
...
public class Worker extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCMAAPPLICANT = "scmaApplicant";
    public static final String PROPERTY_SCMASECTION = "scmaSection";
    ...
    public BusinessPartner getScmaApplicant() {
        return (BusinessPartner) get(PROPERTY_SCMAAPPLICANT);
    }

    public void setScmaApplicant(BusinessPartner scmaApplicant) {
        set(PROPERTY_SCMAAPPLICANT, scmaApplicant);
    }

    public Section getScmaSection() {
        return (Section) get(PROPERTY_SCMASECTION);
    }

    public void setScmaSection(Section scmaSection) {
        set(PROPERTY_SCMASECTION, scmaSection);
    }
