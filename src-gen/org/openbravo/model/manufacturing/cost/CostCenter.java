...
public class CostCenter extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PROJECTPHASEEMSPROCTMMACOSTCENTERIDLIST = "projectPhaseEMSproctmMaCostcenterIDList";
    ...
    public CostCenter() {
        ...
        setDefaultValue(PROPERTY_PROJECTPHASEEMSPROCTMMACOSTCENTERIDLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ProjectPhase> getProjectPhaseEMSproctmMaCostcenterIDList() {
      return (List<ProjectPhase>) get(PROPERTY_PROJECTPHASEEMSPROCTMMACOSTCENTERIDLIST);
    }

    public void setProjectPhaseEMSproctmMaCostcenterIDList(List<ProjectPhase> projectPhaseEMSproctmMaCostcenterIDList) {
        set(PROPERTY_PROJECTPHASEEMSPROCTMMACOSTCENTERIDLIST, projectPhaseEMSproctmMaCostcenterIDList);
    }
