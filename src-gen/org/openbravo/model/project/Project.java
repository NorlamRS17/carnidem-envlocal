...
public class Project extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSIPISIMPORTP = "ssipIsimportp";
    public static final String PROPERTY_SPROCTMDOCTYPE = "sproctmDoctype";
    public static final String PROPERTY_SPROCTMDOCUMENTNO = "sproctmDocumentno";
    ...
    public static final String PROPERTY_BUSINESSPARTNEREMSSPRPROJECTIDLIST = "businessPartnerEMSsprProjectIDList";
    ...
    public static final String PROPERTY_PROCUREMENTREQUISITIONEMSPROCTMCPROJECTIDLIST = "procurementRequisitionEMSproctmCProjectIDList";
    public static final String PROPERTY_PROCUREMENTREQUISITIONLINEEMSPROCTMCPROJECTIDLIST = "procurementRequisitionLineEMSproctmCProjectIDList";
    ...
    public static final String PROPERTY_SSWOSVEHICLEEMSATMACPROJECTIDLIST = "sswosVehicleEMSatmacProjectIDList";
    public static final String PROPERTY_TIMEANDEXPENSESHEETLIST = "timeAndExpenseSheetList";
    public static final String PROPERTY_TIMEANDEXPENSESHEETEMSPROCTMCPROJECTIDLIST = "timeAndExpenseSheetEMSproctmCProjectIDList";
    ...
    public static final String PROPERTY_ATINDPOPOSTVENTAEMSATMACPROJECTIDLIST = "atindpoPostventaEMSatmacProjectIDList";
    ...
    public static final String PROPERTY_SSTPCLIQUIDATIONPROJECTSEMSPROCTMCPROJECTIDLIST = "sstpcLiquidationProjectsEMSproctmCProjectIDList";
    ...
    public Project() {
        ...
        setDefaultValue(PROPERTY_SSIPISIMPORTP, false);
        ...
        setDefaultValue(PROPERTY_BUSINESSPARTNEREMSSPRPROJECTIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONEMSPROCTMCPROJECTIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONLINEEMSPROCTMCPROJECTIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SSWOSVEHICLEEMSATMACPROJECTIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_TIMEANDEXPENSESHEETLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_TIMEANDEXPENSESHEETEMSPROCTMCPROJECTIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_ATINDPOPOSTVENTAEMSATMACPROJECTIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SSTPCLIQUIDATIONPROJECTSEMSPROCTMCPROJECTIDLIST, new ArrayList<Object>());
    }
    ...
    public Boolean isSsipIsimportp() {
        return (Boolean) get(PROPERTY_SSIPISIMPORTP);
    }

    public void setSsipIsimportp(Boolean ssipIsimportp) {
        set(PROPERTY_SSIPISIMPORTP, ssipIsimportp);
    }

    public DocumentType getSproctmDoctype() {
        return (DocumentType) get(PROPERTY_SPROCTMDOCTYPE);
    }

    public void setSproctmDoctype(DocumentType sproctmDoctype) {
        set(PROPERTY_SPROCTMDOCTYPE, sproctmDoctype);
    }

    public String getSproctmDocumentno() {
        return (String) get(PROPERTY_SPROCTMDOCUMENTNO);
    }

    public void setSproctmDocumentno(String sproctmDocumentno) {
        set(PROPERTY_SPROCTMDOCUMENTNO, sproctmDocumentno);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerEMSsprProjectIDList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMSSPRPROJECTIDLIST);
    }

    public void setBusinessPartnerEMSsprProjectIDList(List<BusinessPartner> businessPartnerEMSsprProjectIDList) {
        set(PROPERTY_BUSINESSPARTNEREMSSPRPROJECTIDLIST, businessPartnerEMSsprProjectIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Requisition> getProcurementRequisitionEMSproctmCProjectIDList() {
      return (List<Requisition>) get(PROPERTY_PROCUREMENTREQUISITIONEMSPROCTMCPROJECTIDLIST);
    }

    public void setProcurementRequisitionEMSproctmCProjectIDList(List<Requisition> procurementRequisitionEMSproctmCProjectIDList) {
        set(PROPERTY_PROCUREMENTREQUISITIONEMSPROCTMCPROJECTIDLIST, procurementRequisitionEMSproctmCProjectIDList);
    }

    @SuppressWarnings("unchecked")
    public List<RequisitionLine> getProcurementRequisitionLineEMSproctmCProjectIDList() {
      return (List<RequisitionLine>) get(PROPERTY_PROCUREMENTREQUISITIONLINEEMSPROCTMCPROJECTIDLIST);
    }

    public void setProcurementRequisitionLineEMSproctmCProjectIDList(List<RequisitionLine> procurementRequisitionLineEMSproctmCProjectIDList) {
        set(PROPERTY_PROCUREMENTREQUISITIONLINEEMSPROCTMCPROJECTIDLIST, procurementRequisitionLineEMSproctmCProjectIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SswosVehicle> getSswosVehicleEMSatmacProjectIDList() {
      return (List<SswosVehicle>) get(PROPERTY_SSWOSVEHICLEEMSATMACPROJECTIDLIST);
    }

    public void setSswosVehicleEMSatmacProjectIDList(List<SswosVehicle> sswosVehicleEMSatmacProjectIDList) {
        set(PROPERTY_SSWOSVEHICLEEMSATMACPROJECTIDLIST, sswosVehicleEMSatmacProjectIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Sheet> getTimeAndExpenseSheetEMSproctmCProjectIDList() {
      return (List<Sheet>) get(PROPERTY_TIMEANDEXPENSESHEETEMSPROCTMCPROJECTIDLIST);
    }

    public void setTimeAndExpenseSheetEMSproctmCProjectIDList(List<Sheet> timeAndExpenseSheetEMSproctmCProjectIDList) {
        set(PROPERTY_TIMEANDEXPENSESHEETEMSPROCTMCPROJECTIDLIST, timeAndExpenseSheetEMSproctmCProjectIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<atindpo_postventa> getAtindpoPostventaEMSatmacProjectIDList() {
      return (List<atindpo_postventa>) get(PROPERTY_ATINDPOPOSTVENTAEMSATMACPROJECTIDLIST);
    }

    public void setAtindpoPostventaEMSatmacProjectIDList(List<atindpo_postventa> atindpoPostventaEMSatmacProjectIDList) {
        set(PROPERTY_ATINDPOPOSTVENTAEMSATMACPROJECTIDLIST, atindpoPostventaEMSatmacProjectIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<LiquidationProjects> getSstpcLiquidationProjectsEMSproctmCProjectIDList() {
      return (List<LiquidationProjects>) get(PROPERTY_SSTPCLIQUIDATIONPROJECTSEMSPROCTMCPROJECTIDLIST);
    }

    public void setSstpcLiquidationProjectsEMSproctmCProjectIDList(List<LiquidationProjects> sstpcLiquidationProjectsEMSproctmCProjectIDList) {
        set(PROPERTY_SSTPCLIQUIDATIONPROJECTSEMSPROCTMCPROJECTIDLIST, sstpcLiquidationProjectsEMSproctmCProjectIDList);
    }
