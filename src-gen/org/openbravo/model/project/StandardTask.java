...
public class StandardTask extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSPRJISGOINGMO = "ssprjIsgoingmo";
    public static final String PROPERTY_SSPRJISRETURNMO = "ssprjIsreturnmo";
    ...
    public StandardTask() {
        ...
        setDefaultValue(PROPERTY_SSPRJISGOINGMO, false);
        setDefaultValue(PROPERTY_SSPRJISRETURNMO, false);
    ...
    public Boolean isSsprjIsgoingmo() {
        return (Boolean) get(PROPERTY_SSPRJISGOINGMO);
    }

    public void setSsprjIsgoingmo(Boolean ssprjIsgoingmo) {
        set(PROPERTY_SSPRJISGOINGMO, ssprjIsgoingmo);
    }

    public Boolean isSsprjIsreturnmo() {
        return (Boolean) get(PROPERTY_SSPRJISRETURNMO);
    }

    public void setSsprjIsreturnmo(Boolean ssprjIsreturnmo) {
        set(PROPERTY_SSPRJISRETURNMO, ssprjIsreturnmo);
    }
