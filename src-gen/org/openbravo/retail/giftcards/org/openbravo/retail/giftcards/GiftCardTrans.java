...
/**
 * Entity class for entity GCNV_GiftCardTrans (stored in table gcnv_giftcard_trans).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class GiftCardTrans extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "gcnv_giftcard_trans";
    public static final String ENTITY_NAME = "GCNV_GiftCardTrans";
