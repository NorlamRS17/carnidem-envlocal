...
/**
 * Entity class for entity OBRETCO_CashManagementEvents (stored in table OBRETCO_CMEvents).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CashManagementEvents extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "OBRETCO_CMEvents";
    public static final String ENTITY_NAME = "OBRETCO_CashManagementEvents";
    ...
    public String getEventtype() {
        return (String) get(PROPERTY_EVENTTYPE);
    }

    public void setEventtype(String eventtype) {
        set(PROPERTY_EVENTTYPE, eventtype);
    }
