...
public class OBPOSErrors extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SPOBEPROCESSERROR = "spobeProcessError";
    public static final String PROPERTY_OBPOSERRORSLINELIST = "oBPOSErrorsLineList";
    ...
    public OBPOSErrors() {
        ...
        setDefaultValue(PROPERTY_ATTEMPTS, (long) 0);
        setDefaultValue(PROPERTY_PROCESSNOW, false);
        setDefaultValue(PROPERTY_SPOBEPROCESSERROR, false);
        setDefaultValue(PROPERTY_OBPOSERRORSLINELIST, new ArrayList<Object>());
    ...
    public Long getAttempts() {
        return (Long) get(PROPERTY_ATTEMPTS);
    }

    public void setAttempts(Long attempts) {
        set(PROPERTY_ATTEMPTS, attempts);
    }
    ...
    public Boolean isSpobeProcessError() {
        return (Boolean) get(PROPERTY_SPOBEPROCESSERROR);
    }

    public void setSpobeProcessError(Boolean spobeProcessError) {
        set(PROPERTY_SPOBEPROCESSERROR, spobeProcessError);
    }

    @SuppressWarnings("unchecked")
    public List<OBPOSErrorsLine> getOBPOSErrorsLineList() {
      return (List<OBPOSErrorsLine>) get(PROPERTY_OBPOSERRORSLINELIST);
    }

    public void setOBPOSErrorsLineList(List<OBPOSErrorsLine> oBPOSErrorsLineList) {
        set(PROPERTY_OBPOSERRORSLINELIST, oBPOSErrorsLineList);
    }
