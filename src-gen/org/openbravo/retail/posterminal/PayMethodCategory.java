...
/**
 * Entity class for entity OBPOS_Pay_Method_Category (stored in table OBPOS_Pay_Method_Category).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class PayMethodCategory extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "OBPOS_Pay_Method_Category";
    public static final String ENTITY_NAME = "OBPOS_Pay_Method_Category";
