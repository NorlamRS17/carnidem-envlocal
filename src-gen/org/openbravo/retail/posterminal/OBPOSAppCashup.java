...
public class OBPOSAppCashup extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_CASHUPREPORTXLS = "cashUpReportXLS";
    public static final String PROPERTY_LASTCASHUPREPORTDATE = "lastcashupreportdate";
    public static final String PROPERTY_SRCBPPROCESS = "srcbpProcess";
    ...
    public OBPOSAppCashup() {
        ...
        setDefaultValue(PROPERTY_CASHUPREPORTXLS, false);
        setDefaultValue(PROPERTY_SRCBPPROCESS, false);
    ...
    public Boolean isCashUpReportXLS() {
        return (Boolean) get(PROPERTY_CASHUPREPORTXLS);
    }

    public void setCashUpReportXLS(Boolean cashUpReportXLS) {
        set(PROPERTY_CASHUPREPORTXLS, cashUpReportXLS);
    }

    public Date getLastcashupreportdate() {
        return (Date) get(PROPERTY_LASTCASHUPREPORTDATE);
    }

    public void setLastcashupreportdate(Date lastcashupreportdate) {
        set(PROPERTY_LASTCASHUPREPORTDATE, lastcashupreportdate);
    }

    public Boolean isSrcbpProcess() {
        return (Boolean) get(PROPERTY_SRCBPPROCESS);
    }

    public void setSrcbpProcess(Boolean srcbpProcess) {
        set(PROPERTY_SRCBPPROCESS, srcbpProcess);
    }
