...
/**
 * Entity class for entity OBPOS_Approval_Reason (stored in table OBPOS_Approval_Reason).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class OBPOSApprovalReason extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "OBPOS_Approval_Reason";
    public static final String ENTITY_NAME = "OBPOS_Approval_Reason";
