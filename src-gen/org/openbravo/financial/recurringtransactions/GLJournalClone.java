...
/**
 * Entity class for entity OBRECTX_GL_Journal_V (stored in table OBRECTX_GL_Journal_V).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class GLJournalClone extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "OBRECTX_GL_Journal_V";
    public static final String ENTITY_NAME = "OBRECTX_GL_Journal_V";
    ...
    public GLJournal getGLJournalID() {
        return (GLJournal) get(PROPERTY_GLJOURNALID);
    }

    public void setGLJournalID(GLJournal gLJournalID) {
        set(PROPERTY_GLJOURNALID, gLJournalID);
    }
