...
public class ImportEntryArchive extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBPOSPOSTERMINAL = "oBPOSPOSTerminal";
    ...
    public OBPOSApplications getOBPOSPOSTerminal() {
        return (OBPOSApplications) get(PROPERTY_OBPOSPOSTERMINAL);
    }

    public void setOBPOSPOSTerminal(OBPOSApplications oBPOSPOSTerminal) {
        set(PROPERTY_OBPOSPOSTERMINAL, oBPOSPOSTerminal);
    }
