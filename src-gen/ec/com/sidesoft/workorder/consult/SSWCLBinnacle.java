...
/**
 * Entity class for entity sswcl_binnacle_v (stored in table sswcl_binnacle_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SSWCLBinnacle extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sswcl_binnacle_v";
    public static final String ENTITY_NAME = "sswcl_binnacle_v";
    public static final String PROPERTY_ID = "id";
    public static final String PROPERTY_SSWOSBINNACLE = "sswosBinnacle";
    ...
    public static final String PROPERTY_SSWCLSSWONEMAILSENT = "sswclSswonEmailsent";
    public static final String PROPERTY_SSWCLWORKORDERV = "sswclWorkOrderV";

    public SSWCLBinnacle() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_SUMMARYLEVEL, false);
        setDefaultValue(PROPERTY_SSWCLSSWONEMAILSENT, false);
    }
    ...
    public SswosBinnacle getSswosBinnacle() {
        return (SswosBinnacle) get(PROPERTY_SSWOSBINNACLE);
    }

    public void setSswosBinnacle(SswosBinnacle sswosBinnacle) {
        set(PROPERTY_SSWOSBINNACLE, sswosBinnacle);
    }
    ...
    public Boolean isSswclSswonEmailsent() {
        return (Boolean) get(PROPERTY_SSWCLSSWONEMAILSENT);
    }

    public void setSswclSswonEmailsent(Boolean sswclSswonEmailsent) {
        set(PROPERTY_SSWCLSSWONEMAILSENT, sswclSswonEmailsent);
    }
