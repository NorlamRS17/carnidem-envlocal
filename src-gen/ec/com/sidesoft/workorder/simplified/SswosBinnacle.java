...
/**
 * Entity class for entity Sswos_Binnacle (stored in table Sswos_Binnacle).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SswosBinnacle extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Sswos_Binnacle";
    public static final String ENTITY_NAME = "Sswos_Binnacle";
    ...
    public static final String PROPERTY_SSWONEMAILSENT = "sswonEmailSent";
    public static final String PROPERTY_SSWCLBINNACLEVLIST = "sswclBinnacleVList";

    public SswosBinnacle() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_SUMMARYLEVEL, false);
        setDefaultValue(PROPERTY_SSWONEMAILSENT, false);
    ...
    public Boolean isSswonEmailSent() {
        return (Boolean) get(PROPERTY_SSWONEMAILSENT);
    }

    public void setSswonEmailSent(Boolean sswonEmailSent) {
        set(PROPERTY_SSWONEMAILSENT, sswonEmailSent);
    }
