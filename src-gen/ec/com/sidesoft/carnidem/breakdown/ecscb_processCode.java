...
/**
 * Entity class for entity ecscb_process_code (stored in table ecscb_process_code).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ecscb_processCode extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ecscb_process_code";
    public static final String ENTITY_NAME = "ecscb_process_code";
