...
/**
 * Entity class for entity ssdnid_pendinginterest_v (stored in table ssdnid_pendinginterest_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsdnidPendingInterestV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssdnid_pendinginterest_v";
    public static final String ENTITY_NAME = "ssdnid_pendinginterest_v";
