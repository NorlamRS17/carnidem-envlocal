...
/**
 * Entity class for entity sdc_dc_confirmations (stored in table sdc_dc_confirmations).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SdcDcConfirmations extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sdc_dc_confirmations";
    public static final String ENTITY_NAME = "sdc_dc_confirmations";
    ...
    public String getMedium() {
        return (String) get(PROPERTY_MEDIUM);
    }
