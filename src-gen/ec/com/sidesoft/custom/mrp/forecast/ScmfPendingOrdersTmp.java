...
/**
 * Entity class for entity scmf_pendingorders_tmp (stored in table scmf_pendingorders_tmp).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ScmfPendingOrdersTmp extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "scmf_pendingorders_tmp";
    public static final String ENTITY_NAME = "scmf_pendingorders_tmp";
    ...
    public static final String PROPERTY_PLANNINGDATE = "planningdate";
    ...
    public ScmfPendingOrdersTmp() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_WEIGHTING, (long) 0);
    ...
    public Long getWeighting() {
        return (Long) get(PROPERTY_WEIGHTING);
    }
    ...
    public Date getPlanningdate() {
        return (Date) get(PROPERTY_PLANNINGDATE);
    }

    public void setPlanningdate(Date planningdate) {
        set(PROPERTY_PLANNINGDATE, planningdate);
    }
