...
/**
 * Entity class for entity scmf_transaction_v (stored in table scmf_transaction_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ScmfTransactionV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "scmf_transaction_v";
    public static final String ENTITY_NAME = "scmf_transaction_v";
