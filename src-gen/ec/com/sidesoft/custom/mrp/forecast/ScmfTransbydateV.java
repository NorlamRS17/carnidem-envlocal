...
/**
 * Entity class for entity scmf_transbydate_v (stored in table scmf_transbydate_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ScmfTransbydateV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "scmf_transbydate_v";
    public static final String ENTITY_NAME = "scmf_transbydate_v";
