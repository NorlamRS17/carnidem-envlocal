...
/**
 * Entity class for entity scmf_transaction_balance (stored in table scmf_transaction_balance).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ScmfTransactionBalance extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "scmf_transaction_balance";
    public static final String ENTITY_NAME = "scmf_transaction_balance";
    ...
    public ScmfTransactionBalance() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_MOVEMENTQUANTITY, (long) 0);
    ...
    public Long getMovementQuantity() {
        return (Long) get(PROPERTY_MOVEMENTQUANTITY);
    }
    ...
    public Long getTransactionCost() {
        return (Long) get(PROPERTY_TRANSACTIONCOST);
    }
