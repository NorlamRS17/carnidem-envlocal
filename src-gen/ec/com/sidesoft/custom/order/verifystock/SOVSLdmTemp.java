 ...
 ************************************************************************
*/
package ec.com.sidesoft.custom.order.verifystock;
...
/**
 * Entity class for entity SOVS_Ldm_Temp (stored in table sovs_ldm_temp).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SOVSLdmTemp extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sovs_ldm_temp";
    public static final String ENTITY_NAME = "SOVS_Ldm_Temp";
    ...
    public static final String PROPERTY_QTYNECESSARY = "qTYNecessary";
    public static final String PROPERTY_DIFFERENCES = "differences";
    public static final String PROPERTY_STORAGEDETAIL = "storageDetail";
    public static final String PROPERTY_PRODUCTORIGIN = "productorigin";
    ...
    public BigDecimal getQTYNecessary() {
        return (BigDecimal) get(PROPERTY_QTYNECESSARY);
    }

    public void setQTYNecessary(BigDecimal qTYNecessary) {
        set(PROPERTY_QTYNECESSARY, qTYNecessary);
    }

    public BigDecimal getDifferences() {
        return (BigDecimal) get(PROPERTY_DIFFERENCES);
    }

    public void setDifferences(BigDecimal differences) {
        set(PROPERTY_DIFFERENCES, differences);
    }
    ...
    public String getProductorigin() {
        return (String) get(PROPERTY_PRODUCTORIGIN);
    }

    public void setProductorigin(String productorigin) {
        set(PROPERTY_PRODUCTORIGIN, productorigin);
    }
