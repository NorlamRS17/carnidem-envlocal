...
/**
 * Entity class for entity ecscap_general_process (stored in table ecscap_general_process).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Ecscap_GeneralProcess extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ecscap_general_process";
    public static final String ENTITY_NAME = "ecscap_general_process";
