...
/**
 * Entity class for entity sfcbr_inc_statmnt_script (stored in table sfcbr_inc_statmnt_script).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SfcbrComprehensiveIncomeStatement extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfcbr_inc_statmnt_script";
    public static final String ENTITY_NAME = "sfcbr_inc_statmnt_script";
    ...
    public static final String PROPERTY_TOTALGROUPS = "totalGroups";
    ...
    public SfcbrComprehensiveIncomeStatement() {
    ...
    public String getTotalGroups() {
        return (String) get(PROPERTY_TOTALGROUPS);
    }

    public void setTotalGroups(String totalGroups) {
        set(PROPERTY_TOTALGROUPS, totalGroups);
    }
