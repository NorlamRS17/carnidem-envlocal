...
/**
 * Entity class for entity Sspch_Invoice (stored in table Sspch_Invoice).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SspchInvoice extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Sspch_Invoice";
    public static final String ENTITY_NAME = "Sspch_Invoice";
