...
/**
 * Entity class for entity sproctm_task_workforce (stored in table sproctm_task_workforce).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SproctmTaskWorkforce extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sproctm_task_workforce";
    public static final String ENTITY_NAME = "sproctm_task_workforce";
    ...
    public static final String PROPERTY_QTYEXECUTED = "qTYExecuted";
    ...
    public SproctmTaskWorkforce() {
        ...
        setDefaultValue(PROPERTY_QTYEXECUTED, new BigDecimal(0));
    ...
    public BigDecimal getQTYExecuted() {
        return (BigDecimal) get(PROPERTY_QTYEXECUTED);
    }

    public void setQTYExecuted(BigDecimal qTYExecuted) {
        set(PROPERTY_QTYEXECUTED, qTYExecuted);
    }
