...
/**
 * Entity class for entity sproctm_imp_workforce (stored in table sproctm_imp_workforce).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SproctmImpWorkforce extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sproctm_imp_workforce";
    public static final String ENTITY_NAME = "sproctm_imp_workforce";
    ...
    public static final String PROPERTY_SPROCTMIMPWFORCELINELIST = "sproctmImpWforceLineList";

    public SproctmImpWorkforce() {
        setDefaultValue(PROPERTY_ALERTSTATUS, "DR");
        setDefaultValue(PROPERTY_PROCESS, false);
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_SPROCTMIMPWFORCELINELIST, new ArrayList<Object>());
    }
    ...
    public List<SproctmImpWforceLine> getSproctmImpWforceLineList() {
      return (List<SproctmImpWforceLine>) get(PROPERTY_SPROCTMIMPWFORCELINELIST);
    }

    public void setSproctmImpWforceLineList(List<SproctmImpWforceLine> sproctmImpWforceLineList) {
        set(PROPERTY_SPROCTMIMPWFORCELINELIST, sproctmImpWforceLineList);
    }
