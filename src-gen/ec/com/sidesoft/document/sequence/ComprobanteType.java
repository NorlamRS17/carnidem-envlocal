...
/**
 * Entity class for entity ECSDS_ComprobanteType (stored in table ecsds_compro_type).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ComprobanteType extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ecsds_compro_type";
    public static final String ENTITY_NAME = "ECSDS_ComprobanteType";
