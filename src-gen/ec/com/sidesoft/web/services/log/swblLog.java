 ...
 ************************************************************************
*/
package ec.com.sidesoft.web.services.log;
...
/**
 * Entity class for entity swbl_log (stored in table swbl_log).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class swblLog extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "swbl_log";
    public static final String ENTITY_NAME = "swbl_log";
    ...
    public static final String PROPERTY_JSONREQUEST = "jsonRequest";
    public static final String PROPERTY_JSONRESPONSE = "jsonResponse";
    ...
    public swblLog() {
        ...
        setDefaultValue(PROPERTY_WAREHOUSERULETYPE, "IN");
    }
    ...
    public String getEndpoint() {
        return (String) get(PROPERTY_ENDPOINT);
    }
    ...
    public String getJsonRequest() {
        return (String) get(PROPERTY_JSONREQUEST);
    }

    public void setJsonRequest(String jsonRequest) {
        set(PROPERTY_JSONREQUEST, jsonRequest);
    }

    public String getJsonResponse() {
        return (String) get(PROPERTY_JSONRESPONSE);
    }

    public void setJsonResponse(String jsonResponse) {
        set(PROPERTY_JSONRESPONSE, jsonResponse);
    }
