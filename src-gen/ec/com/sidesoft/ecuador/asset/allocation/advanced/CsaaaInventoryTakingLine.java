...
/**
 * Entity class for entity csaaa_invt_tkg_line (stored in table csaaa_invt_tkg_line).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CsaaaInventoryTakingLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "csaaa_invt_tkg_line";
    public static final String ENTITY_NAME = "csaaa_invt_tkg_line";
    ...
    public static final String PROPERTY_CONCILIATION = "conciliation";
    public static final String PROPERTY_BARCODE = "barcode";
    public static final String PROPERTY_CSAAAINVENTORYTAKING = "csaaaInventoryTaking";
    ...
    public CsaaaInventoryTakingLine() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_CONCILIATION, false);
    }
    ...
    public Boolean isConciliation() {
        return (Boolean) get(PROPERTY_CONCILIATION);
    }

    public void setConciliation(Boolean conciliation) {
        set(PROPERTY_CONCILIATION, conciliation);
    }
    ...
    public CsaaaInventoryTaking getCsaaaInventoryTaking() {
        return (CsaaaInventoryTaking) get(PROPERTY_CSAAAINVENTORYTAKING);
    }

    public void setCsaaaInventoryTaking(CsaaaInventoryTaking csaaaInventoryTaking) {
        set(PROPERTY_CSAAAINVENTORYTAKING, csaaaInventoryTaking);
    }
