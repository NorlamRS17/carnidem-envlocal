...
import org.openbravo.model.sales.CommissionAmount;
/**
 * Entity class for entity scomst_unpaid_commission (stored in table scomst_unpaid_commission).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class scomst_unpaid_commission extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "scomst_unpaid_commission";
    public static final String ENTITY_NAME = "scomst_unpaid_commission";
    ...
    public static final String PROPERTY_COMMISSIONAMOUNTVALUE = "commissionAmountValue";
    ...
    public scomst_unpaid_commission() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_ACTUALAMOUNT, new BigDecimal(0));
        setDefaultValue(PROPERTY_CONVERTEDAMOUNT, new BigDecimal(0));
        setDefaultValue(PROPERTY_ACTUALQUANTITY, new BigDecimal(0));
        setDefaultValue(PROPERTY_ISCOSTCALCULATED, true);
        setDefaultValue(PROPERTY_COMMISSIONAMOUNTVALUE, new BigDecimal(0));
    }
    ...
    public BigDecimal getCommissionAmountValue() {
        return (BigDecimal) get(PROPERTY_COMMISSIONAMOUNTVALUE);
    }

    public void setCommissionAmountValue(BigDecimal commissionAmountValue) {
        set(PROPERTY_COMMISSIONAMOUNTVALUE, commissionAmountValue);
    }
