...
/**
 * Entity class for entity scrvro_distance_matrix (stored in table scrvro_distance_matrix).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Scrvro_DistanceMatrix extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "scrvro_distance_matrix";
    public static final String ENTITY_NAME = "scrvro_distance_matrix";
    ...
    public static final String PROPERTY_BPARTNERFROM = "bpartnerFrom";
    public static final String PROPERTY_BPARTNERTO = "bpartnerTo";
    ...
    public BusinessPartner getBpartnerFrom() {
        return (BusinessPartner) get(PROPERTY_BPARTNERFROM);
    }

    public void setBpartnerFrom(BusinessPartner bpartnerFrom) {
        set(PROPERTY_BPARTNERFROM, bpartnerFrom);
    }

    public BusinessPartner getBpartnerTo() {
        return (BusinessPartner) get(PROPERTY_BPARTNERTO);
    }

    public void setBpartnerTo(BusinessPartner bpartnerTo) {
        set(PROPERTY_BPARTNERTO, bpartnerTo);
    }
