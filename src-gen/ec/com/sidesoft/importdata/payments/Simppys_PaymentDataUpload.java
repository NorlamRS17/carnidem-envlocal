...
/**
 * Entity class for entity simppys_paymentdataupload (stored in table simppys_paymentdataupload).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Simppys_PaymentDataUpload extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "simppys_paymentdataupload";
    public static final String ENTITY_NAME = "simppys_paymentdataupload";
    ...
    public Simppys_PaymentDataUpload() {
