...
/**
 * Entity class for entity SSBOD_offer_pterm (stored in table SSBOD_offer_pterm).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsbodOfferPterm extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSBOD_offer_pterm";
    public static final String ENTITY_NAME = "SSBOD_offer_pterm";
