...
/**
 * Entity class for entity Ssbod_offer_doc (stored in table Ssbod_offer_doc).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SssbodOfferDoc extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Ssbod_offer_doc";
    public static final String ENTITY_NAME = "Ssbod_offer_doc";
