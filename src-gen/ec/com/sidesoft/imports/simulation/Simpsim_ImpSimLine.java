...
/**
 * Entity class for entity simpsim_imp_sim_line (stored in table simpsim_imp_sim_line).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Simpsim_ImpSimLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "simpsim_imp_sim_line";
    public static final String ENTITY_NAME = "simpsim_imp_sim_line";
    ...
    public static final String PROPERTY_REALCOST = "realCost";
    public static final String PROPERTY_UNITCOST = "unitCost";

    public Simpsim_ImpSimLine() {
        ...
        setDefaultValue(PROPERTY_REALCOST, new BigDecimal(0));
    ...
    public BigDecimal getRealCost() {
        return (BigDecimal) get(PROPERTY_REALCOST);
    }

    public void setRealCost(BigDecimal realCost) {
        set(PROPERTY_REALCOST, realCost);
    }
