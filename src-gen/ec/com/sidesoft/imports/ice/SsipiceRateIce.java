 ...
 ************************************************************************
*/
package ec.com.sidesoft.imports.ice;
...
/**
 * Entity class for entity ssipice_rate_ice (stored in table ssipice_rate_ice).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsipiceRateIce extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssipice_rate_ice";
    public static final String ENTITY_NAME = "ssipice_rate_ice";
    ...
    public BusinessPartner getSupplier() {
        return (BusinessPartner) get(PROPERTY_SUPPLIER);
    }

    public void setSupplier(BusinessPartner supplier) {
        set(PROPERTY_SUPPLIER, supplier);
    }
