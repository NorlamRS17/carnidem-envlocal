...
/**
 * Entity class for entity sspimpl_import_product_pl (stored in table sspimpl_import_product_pl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ImportProductPl extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspimpl_import_product_pl";
    public static final String ENTITY_NAME = "sspimpl_import_product_pl";
