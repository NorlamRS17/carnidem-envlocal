...
/**
 * Entity class for entity SRDUPE_Errors (stored in table srdupe_errors).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SRDUPEErrors extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "srdupe_errors";
    public static final String ENTITY_NAME = "SRDUPE_Errors";
    ...
    public static final String PROPERTY_ERRORUPDATE = "errorUpdate";
    public static final String PROPERTY_OBPOSERRORS = "obposErrors";
    ...
    public SRDUPEErrors() {
        ...
        setDefaultValue(PROPERTY_ERRORUPDATE, false);
    }
    ...
    public Boolean isErrorUpdate() {
        return (Boolean) get(PROPERTY_ERRORUPDATE);
    }

    public void setErrorUpdate(Boolean errorUpdate) {
        set(PROPERTY_ERRORUPDATE, errorUpdate);
    }

    public OBPOSErrors getObposErrors() {
        return (OBPOSErrors) get(PROPERTY_OBPOSERRORS);
    }

    public void setObposErrors(OBPOSErrors obposErrors) {
        set(PROPERTY_OBPOSERRORS, obposErrors);
    }
