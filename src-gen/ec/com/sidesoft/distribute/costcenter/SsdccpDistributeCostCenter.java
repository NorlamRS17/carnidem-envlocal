 ...
 ************************************************************************
*/
package ec.com.sidesoft.distribute.costcenter;
...
/**
 * Entity class for entity ssdccp_distcostcenter (stored in table ssdccp_distcostcenter).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsdccpDistributeCostCenter extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssdccp_distcostcenter";
    public static final String ENTITY_NAME = "ssdccp_distcostcenter";
    ...
    public SsdccpDistributeCostCenter() {
