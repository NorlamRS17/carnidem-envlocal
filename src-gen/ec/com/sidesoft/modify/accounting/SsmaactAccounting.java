...
/**
 * Entity class for entity Ssmaact_Accounting (stored in table ssmaact_accounting).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsmaactAccounting extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssmaact_accounting";
    public static final String ENTITY_NAME = "Ssmaact_Accounting";
