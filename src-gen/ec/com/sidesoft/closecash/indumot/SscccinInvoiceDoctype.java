...
/**
 * Entity class for entity sscccin_invoice_doctype (stored in table sscccin_invoice_doctype).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SscccinInvoiceDoctype extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sscccin_invoice_doctype";
    public static final String ENTITY_NAME = "sscccin_invoice_doctype";
