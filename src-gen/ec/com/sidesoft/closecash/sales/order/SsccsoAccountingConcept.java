...
/**
 * Entity class for entity Ssccso_Accounting_Concept (stored in table Ssccso_Accounting_Concept).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsccsoAccountingConcept extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Ssccso_Accounting_Concept";
    public static final String ENTITY_NAME = "Ssccso_Accounting_Concept";
    ...
    public SsccsoAccountingConcept() {
