...
/**
 * Entity class for entity sscccfa_fin_acc_concept (stored in table sscccfa_fin_acc_concept).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SscccfaFinAccConcept extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sscccfa_fin_acc_concept";
    public static final String ENTITY_NAME = "sscccfa_fin_acc_concept";
