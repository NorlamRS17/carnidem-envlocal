...
/**
 * Entity class for entity Ssccr_Cards_Types (stored in table Ssccr_Cards_Types).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsccrCardsTypes extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Ssccr_Cards_Types";
    public static final String ENTITY_NAME = "Ssccr_Cards_Types";
    ...
    public static final String PROPERTY_FINFINACCTRANSACTIONEMSSCCRCARDSTYPESIDLIST = "fINFinaccTransactionEMSsccrCardsTypesIDList";
    ...
    public SsccrCardsTypes() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_SUMMARYLEVEL, false);
        setDefaultValue(PROPERTY_FINFINACCTRANSACTIONEMSSCCRCARDSTYPESIDLIST, new ArrayList<Object>());
    ...
    public List<FIN_FinaccTransaction> getFINFinaccTransactionEMSsccrCardsTypesIDList() {
      return (List<FIN_FinaccTransaction>) get(PROPERTY_FINFINACCTRANSACTIONEMSSCCRCARDSTYPESIDLIST);
    }

    public void setFINFinaccTransactionEMSsccrCardsTypesIDList(List<FIN_FinaccTransaction> fINFinaccTransactionEMSsccrCardsTypesIDList) {
        set(PROPERTY_FINFINACCTRANSACTIONEMSSCCRCARDSTYPESIDLIST, fINFinaccTransactionEMSsccrCardsTypesIDList);
    }
