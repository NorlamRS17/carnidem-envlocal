...
/**
 * Entity class for entity Ssccr_Types_Of_Credit (stored in table Ssccr_Types_Of_Credit).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsccrTypesOfCredit extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Ssccr_Types_Of_Credit";
    public static final String ENTITY_NAME = "Ssccr_Types_Of_Credit";
    ...
    public static final String PROPERTY_FINFINACCTRANSACTIONEMSSCCRTYPESOFCREDITIDLIST = "fINFinaccTransactionEMSsccrTypesOfCreditIDList";
    ...
    public SsccrTypesOfCredit() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_SUMMARYLEVEL, false);
        setDefaultValue(PROPERTY_FINFINACCTRANSACTIONEMSSCCRTYPESOFCREDITIDLIST, new ArrayList<Object>());
    ...
    public List<FIN_FinaccTransaction> getFINFinaccTransactionEMSsccrTypesOfCreditIDList() {
      return (List<FIN_FinaccTransaction>) get(PROPERTY_FINFINACCTRANSACTIONEMSSCCRTYPESOFCREDITIDLIST);
    }

    public void setFINFinaccTransactionEMSsccrTypesOfCreditIDList(List<FIN_FinaccTransaction> fINFinaccTransactionEMSsccrTypesOfCreditIDList) {
        set(PROPERTY_FINFINACCTRANSACTIONEMSSCCRTYPESOFCREDITIDLIST, fINFinaccTransactionEMSsccrTypesOfCreditIDList);
    }
