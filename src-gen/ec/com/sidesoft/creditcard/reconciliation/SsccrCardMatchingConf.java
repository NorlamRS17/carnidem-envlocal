...
/**
 * Entity class for entity Ssccr_CardMatchingConf (stored in table Ssccr_CardMatchingConf).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsccrCardMatchingConf extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Ssccr_CardMatchingConf";
    public static final String ENTITY_NAME = "Ssccr_CardMatchingConf";
