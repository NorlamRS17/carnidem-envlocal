...
/**
 * Entity class for entity sccrt_card_load_transaction (stored in table sccrt_card_load_transaction).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SccrtCardLoadTransaction extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sccrt_card_load_transaction";
    public static final String ENTITY_NAME = "sccrt_card_load_transaction";
    ...
    public SccrtCardLoadTransaction() {
