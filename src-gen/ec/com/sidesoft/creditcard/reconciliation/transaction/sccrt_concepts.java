...
/**
 * Entity class for entity sccrt_concepts (stored in table sccrt_concepts).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class sccrt_concepts extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sccrt_concepts";
    public static final String ENTITY_NAME = "sccrt_concepts";
