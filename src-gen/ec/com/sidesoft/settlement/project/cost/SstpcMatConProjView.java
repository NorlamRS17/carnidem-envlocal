...
/**
 * Entity class for entity sstpc_mat_con_proj_v (stored in table sstpc_mat_con_proj_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SstpcMatConProjView extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sstpc_mat_con_proj_v";
    public static final String ENTITY_NAME = "sstpc_mat_con_proj_v";
