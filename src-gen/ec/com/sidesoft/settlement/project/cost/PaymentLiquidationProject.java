...
/**
 * Entity class for entity sstpc_payment (stored in table sstpc_payment).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class PaymentLiquidationProject extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sstpc_payment";
    public static final String ENTITY_NAME = "sstpc_payment";
    ...
    public static final String PROPERTY_ISADVANCED = "isadvanced";
    public static final String PROPERTY_LINE = "line";

    public PaymentLiquidationProject() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_AMOUNT, new BigDecimal(0));
        setDefaultValue(PROPERTY_ISLIQUIDATE, false);
        setDefaultValue(PROPERTY_ISADVANCED, new BigDecimal(0));
    }
    ...
    public BigDecimal getIsadvanced() {
        return (BigDecimal) get(PROPERTY_ISADVANCED);
    }

    public void setIsadvanced(BigDecimal isadvanced) {
        set(PROPERTY_ISADVANCED, isadvanced);
    }
