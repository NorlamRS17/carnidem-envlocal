...
/**
 * Entity class for entity STXREV_FinanciallAccounting (stored in table STXREV_acct).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class AccountingReversal extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "STXREV_acct";
    public static final String ENTITY_NAME = "STXREV_FinanciallAccounting";
    ...
    public static final String PROPERTY_REVERSO = "reverso";

    public AccountingReversal() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_FOREIGNCURRENCYDEBIT, new BigDecimal(0));
        setDefaultValue(PROPERTY_FOREIGNCURRENCYCREDIT, new BigDecimal(0));
        setDefaultValue(PROPERTY_MODIFY, false);
        setDefaultValue(PROPERTY_REVERSO, false);
    }
    ...
    public Boolean isReverso() {
        return (Boolean) get(PROPERTY_REVERSO);
    }

    public void setReverso(Boolean reverso) {
        set(PROPERTY_REVERSO, reverso);
    }
