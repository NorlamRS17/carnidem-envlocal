...
/**
 * Entity class for entity ssppinv_setting (stored in table ssppinv_setting).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsppinvSetting extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssppinv_setting";
    public static final String ENTITY_NAME = "ssppinv_setting";
