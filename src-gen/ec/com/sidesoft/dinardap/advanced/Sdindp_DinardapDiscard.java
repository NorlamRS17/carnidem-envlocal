...
/**
 * Entity class for entity sdindp_dinardap_discard (stored in table sdindp_dinardap_discard).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Sdindp_DinardapDiscard extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sdindp_dinardap_discard";
    public static final String ENTITY_NAME = "sdindp_dinardap_discard";
