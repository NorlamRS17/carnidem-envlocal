...
/**
 * Entity class for entity Sswhsro_Withholding_Summary (stored in table Sswhsro_Withholding_Summary).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SswhsroWithholdingSummary extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Sswhsro_Withholding_Summary";
    public static final String ENTITY_NAME = "Sswhsro_Withholding_Summary";
    ...
    public static final String PROPERTY_WITHHOLDINGSALE = "withholdingSale";
    ...
    public SswhsroWithholdingSummary() {
    ...
    public SSWSWithholdingSale getWithholdingSale() {
        return (SSWSWithholdingSale) get(PROPERTY_WITHHOLDINGSALE);
    }

    public void setWithholdingSale(SSWSWithholdingSale withholdingSale) {
        set(PROPERTY_WITHHOLDINGSALE, withholdingSale);
    }
