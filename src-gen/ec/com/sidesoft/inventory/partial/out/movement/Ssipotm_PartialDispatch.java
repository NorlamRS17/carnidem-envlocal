...
/**
 * Entity class for entity ssipotm_partial_dispatch (stored in table ssipotm_partial_dispatch).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Ssipotm_PartialDispatch extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssipotm_partial_dispatch";
    public static final String ENTITY_NAME = "ssipotm_partial_dispatch";
    ...
    public static final String PROPERTY_DISPATCHDATE = "dispatchDate";
    public static final String PROPERTY_WAREHOUSE = "warehouse";
    public static final String PROPERTY_STORAGEBIN = "storageBin";
    public static final String PROPERTY_DESCRIPTION = "description";
    public static final String PROPERTY_LOADPENDINGORDERS = "loadPendingOrders";
    public static final String PROPERTY_UPDATESTOCK = "updatestock";
    public static final String PROPERTY_ACCUMULATE = "accumulate";
    ...
    public Ssipotm_PartialDispatch() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_LOADPENDINGORDERS, false);
        setDefaultValue(PROPERTY_UPDATESTOCK, false);
        setDefaultValue(PROPERTY_ACCUMULATE, false);
    ...
    public Date getDispatchDate() {
        return (Date) get(PROPERTY_DISPATCHDATE);
    }

    public void setDispatchDate(Date dispatchDate) {
        set(PROPERTY_DISPATCHDATE, dispatchDate);
    }
    ...
    public Boolean isLoadPendingOrders() {
        return (Boolean) get(PROPERTY_LOADPENDINGORDERS);
    }

    public void setLoadPendingOrders(Boolean loadPendingOrders) {
        set(PROPERTY_LOADPENDINGORDERS, loadPendingOrders);
    }

    public Boolean isUpdatestock() {
        return (Boolean) get(PROPERTY_UPDATESTOCK);
    }

    public void setUpdatestock(Boolean updatestock) {
        set(PROPERTY_UPDATESTOCK, updatestock);
    }

    public Boolean isAccumulate() {
        return (Boolean) get(PROPERTY_ACCUMULATE);
    }

    public void setAccumulate(Boolean accumulate) {
        set(PROPERTY_ACCUMULATE, accumulate);
    }
