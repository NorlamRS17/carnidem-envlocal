...
/**
 * Entity class for entity ssipotm_attribute_product (stored in table ssipotm_attribute_product).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsipotmAttributeProduct extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssipotm_attribute_product";
    public static final String ENTITY_NAME = "ssipotm_attribute_product";
    ...
    public SsipotmAttributeProduct() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_STOCK, new BigDecimal(0));
    }
