...
/**
 * Entity class for entity Sfiac_Payment_Lot_file (stored in table Sfiac_Payment_Lot_file).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SfiacPaymentLotFile extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Sfiac_Payment_Lot_file";
    public static final String ENTITY_NAME = "Sfiac_Payment_Lot_file";
    ...
    public SfiacPaymentLotFile() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_NAME, "LoteDePagos_#yyyyMMdd#");
        setDefaultValue(PROPERTY_TEMPLATELOCATION, "/modules/ec.com.sidesoft.custom.payments.partialpayment/src/ec/com/sidesoft/custom/payments/partialpayment/templates_payment_lot/");
        setDefaultValue(PROPERTY_TEMPLATEFILENAME, "template_original.csv");
    }
