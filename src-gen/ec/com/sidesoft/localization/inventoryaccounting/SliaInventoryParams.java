...
/**
 * Entity class for entity slia_inv_parm (stored in table slia_inv_parm).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SliaInventoryParams extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "slia_inv_parm";
    public static final String ENTITY_NAME = "slia_inv_parm";
