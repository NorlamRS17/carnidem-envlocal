...
/**
 * Entity class for entity slqs_m_product_stock_v (stored in table slqs_m_product_stock_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SlqsMProductStockView extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "slqs_m_product_stock_v";
    public static final String ENTITY_NAME = "slqs_m_product_stock_v";
