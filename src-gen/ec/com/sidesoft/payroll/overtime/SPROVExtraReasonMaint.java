...
/**
 * Entity class for entity SPROV_Extra_Reason_Maint (stored in table SPROV_Extra_Reason_Maint).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SPROVExtraReasonMaint extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SPROV_Extra_Reason_Maint";
    public static final String ENTITY_NAME = "SPROV_Extra_Reason_Maint";
