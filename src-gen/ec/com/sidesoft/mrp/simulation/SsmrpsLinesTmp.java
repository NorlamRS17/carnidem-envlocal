...
/**
 * Entity class for entity ssmrps_lines_tmp (stored in table ssmrps_lines_tmp).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsmrpsLinesTmp extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssmrps_lines_tmp";
    public static final String ENTITY_NAME = "ssmrps_lines_tmp";
