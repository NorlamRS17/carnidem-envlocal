...
/**
 * Entity class for entity ssmrps_monthsnotcons (stored in table ssmrps_monthsnotcons).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsmrpsMonthsNotCons extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssmrps_monthsnotcons";
    public static final String ENTITY_NAME = "ssmrps_monthsnotcons";
