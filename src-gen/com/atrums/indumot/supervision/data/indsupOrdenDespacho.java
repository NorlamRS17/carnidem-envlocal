...
/**
 * Entity class for entity indsup_ord_desp (stored in table indsup_ord_desp).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class indsupOrdenDespacho extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "indsup_ord_desp";
    public static final String ENTITY_NAME = "indsup_ord_desp";
