...
/**
 * Entity class for entity sinvmin_square_bill (stored in table sinvmin_square_bill).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Sinvmin_SquareBill extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sinvmin_square_bill";
    public static final String ENTITY_NAME = "sinvmin_square_bill";
