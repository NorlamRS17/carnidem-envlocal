...
/**
 * Entity class for entity SPRBI_Department_Area (stored in table SPRBI_Department_Area).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SPRBIDepartmentArea extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SPRBI_Department_Area";
    public static final String ENTITY_NAME = "SPRBI_Department_Area";
