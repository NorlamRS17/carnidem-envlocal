...
/**
 * Entity class for entity sspr_payroll_aut (stored in table sspr_payroll_aut).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssprpayrollaut extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspr_payroll_aut";
    public static final String ENTITY_NAME = "sspr_payroll_aut";
    ...
    public static final String PROPERTY_CREATELINESSETTLERMENT = "createLinesSettlerment";
    ...
    public static final String PROPERTY_PROCESSCOUNTER = "processCounter";
    public static final String PROPERTY_PROCESSNOW = "processNow";
    public static final String PROPERTY_SSPRPAYROLLAUTLINELIST = "ssprPayrollAutLineList";

    public ssprpayrollaut() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_CREATELINESSETTLERMENT, "N");
        ...
        setDefaultValue(PROPERTY_PROCESSCOUNTER, new BigDecimal(0));
    ...
    public String getCreateLinesSettlerment() {
        return (String) get(PROPERTY_CREATELINESSETTLERMENT);
    }

    public void setCreateLinesSettlerment(String createLinesSettlerment) {
        set(PROPERTY_CREATELINESSETTLERMENT, createLinesSettlerment);
    }
    ...
    public BigDecimal getProcessCounter() {
        return (BigDecimal) get(PROPERTY_PROCESSCOUNTER);
    }

    public void setProcessCounter(BigDecimal processCounter) {
        set(PROPERTY_PROCESSCOUNTER, processCounter);
    }
