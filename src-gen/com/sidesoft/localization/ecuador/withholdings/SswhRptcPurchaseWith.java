...
/**
 * Entity class for entity Sswh_Rptc_PurchaseWith (stored in table Sswh_Rptc_PurchaseWith).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SswhRptcPurchaseWith extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Sswh_Rptc_PurchaseWith";
    public static final String ENTITY_NAME = "Sswh_Rptc_PurchaseWith";
    ...
    public static final String PROPERTY_CODIGORET = "codigoRet";
    public static final String PROPERTY_BASEIMP = "baseImp";
    public static final String PROPERTY_PORCENRET = "porcenRet";
    public static final String PROPERTY_VALORRET = "valorRet";
    ...
    public static final String PROPERTY_CODIGOATS = "codigoAts";

    public SswhRptcPurchaseWith() {
    ...
    public String getCodigoRet() {
        return (String) get(PROPERTY_CODIGORET);
    }

    public void setCodigoRet(String codigoRet) {
        set(PROPERTY_CODIGORET, codigoRet);
    }
    ...
    public BigDecimal getPorcenRet() {
        return (BigDecimal) get(PROPERTY_PORCENRET);
    }

    public void setPorcenRet(BigDecimal porcenRet) {
        set(PROPERTY_PORCENRET, porcenRet);
    }

    public BigDecimal getValorRet() {
        return (BigDecimal) get(PROPERTY_VALORRET);
    }

    public void setValorRet(BigDecimal valorRet) {
        set(PROPERTY_VALORRET, valorRet);
    }
    ...
    public String getCodigoAts() {
        return (String) get(PROPERTY_CODIGOATS);
    }

    public void setCodigoAts(String codigoAts) {
        set(PROPERTY_CODIGOATS, codigoAts);
    }
