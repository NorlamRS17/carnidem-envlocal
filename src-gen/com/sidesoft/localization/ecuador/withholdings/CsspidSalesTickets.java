...
/**
 * Entity class for entity sswh_salestickets (stored in table sswh_salestickets).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CsspidSalesTickets extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sswh_salestickets";
    public static final String ENTITY_NAME = "sswh_salestickets";
    ...
    public static final String PROPERTY_BASENOVAT = "baseNoVAT";
    public static final String PROPERTY_BASEZERO = "baseZero";
    ...
    public static final String PROPERTY_ESTABLISHMENTNO = "establishmentno";

    public CsspidSalesTickets() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_STATUS, "DR");
        setDefaultValue(PROPERTY_BASENOVAT, new BigDecimal(0));
        setDefaultValue(PROPERTY_BASEZERO, new BigDecimal(0));
        setDefaultValue(PROPERTY_VOUCHERSNUMBER, (long) 0);
        setDefaultValue(PROPERTY_ESTABLISHMENTNO, "0");
    }
    ...
    public BigDecimal getBaseNoVAT() {
        return (BigDecimal) get(PROPERTY_BASENOVAT);
    }

    public void setBaseNoVAT(BigDecimal baseNoVAT) {
        set(PROPERTY_BASENOVAT, baseNoVAT);
    }

    public BigDecimal getBaseZero() {
        return (BigDecimal) get(PROPERTY_BASEZERO);
    }

    public void setBaseZero(BigDecimal baseZero) {
        set(PROPERTY_BASEZERO, baseZero);
    }
    ...
    public String getEstablishmentno() {
        return (String) get(PROPERTY_ESTABLISHMENTNO);
    }

    public void setEstablishmentno(String establishmentno) {
        set(PROPERTY_ESTABLISHMENTNO, establishmentno);
    }
