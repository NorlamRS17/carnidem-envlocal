...
/**
 * Entity class for entity sfpsi_reconcile_so_v (stored in table sfpsi_reconcile_so_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Sfpsi_ReconcileSalesOrderV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfpsi_reconcile_so_v";
    public static final String ENTITY_NAME = "sfpsi_reconcile_so_v";
    ...
    public Sfpsi_ReconcileSalesOrderV() {
