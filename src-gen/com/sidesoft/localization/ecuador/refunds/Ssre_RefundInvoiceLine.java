...
/**
 * Entity class for entity ssre_refundinvoiceline (stored in table ssre_refundinvoiceline).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Ssre_RefundInvoiceLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssre_refundinvoiceline";
    public static final String ENTITY_NAME = "ssre_refundinvoiceline";
    ...
    public static final String PROPERTY_REFUNDINVOICE = "refundInvoice";
    ...
    public ssrerefundinvoice getRefundInvoice() {
        return (ssrerefundinvoice) get(PROPERTY_REFUNDINVOICE);
    }

    public void setRefundInvoice(ssrerefundinvoice refundInvoice) {
        set(PROPERTY_REFUNDINVOICE, refundInvoice);
    }
