...
public class SproctmCompleteAllRequestActionHandler extends BaseActionHandler {
  ...
  private String process(String ids, String userId, String clientId) {
    ...
    try {
      String sql = "SELECT sproctm_co_all_details(?,?,?) AS result";
      ...
      throw new OBException("SproctmCompleteAllRequestActionHandler.complete: " + e.getMessage());
    } finally {
      try {
