...
public class SproctmDoctype_ProjectMultifase extends SimpleCallout {
  private static final long serialVersionUID = 1L;

  @Override
  protected void execute(CalloutInfo info) throws ServletException {
    String documentTypeId = info.getStringParameter("inpemSproctmDoctype", null);
    ...
    if (docObj.getDocumentSequence() != null) {
      ...
      info.addResult("inpemSproctmDocumentno",
