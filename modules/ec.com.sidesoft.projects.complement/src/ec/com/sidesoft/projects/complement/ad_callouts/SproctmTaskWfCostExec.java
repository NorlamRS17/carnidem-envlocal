...
public class SproctmTaskWfCostExec extends SimpleCallout {

  @Override
  protected void execute(CalloutInfo info) throws ServletException {

    double strqtyExecuted = Double.parseDouble(info.getStringParameter("inpqtyExecuted", null));
    ...
    info.addResult("inptotalCost", strTotalCost);
