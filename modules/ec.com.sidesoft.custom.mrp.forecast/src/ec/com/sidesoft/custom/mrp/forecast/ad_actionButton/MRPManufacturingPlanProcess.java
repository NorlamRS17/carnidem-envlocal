package ec.com.sidesoft.custom.mrp.forecast.ad_actionButton;
...
public class MRPManufacturingPlanProcess extends DalBaseProcess {
  ...
  protected void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      parameters.add("Y");
      CallStoredProcedure.getInstance().call("scmf_mrprun_initialize", parameters, null, true, false);
      ...
      CallStoredProcedure.getInstance().call("scmf_mrprun_explode", parameters, null, true, false);
      OBDal.getInstance().commitAndClose();
      OBDal.getInstance().getSession().clear();
