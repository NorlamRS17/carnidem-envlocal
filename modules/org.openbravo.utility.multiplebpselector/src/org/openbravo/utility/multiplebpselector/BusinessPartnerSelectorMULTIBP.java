...
public class BusinessPartnerSelectorMULTIBP extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "org/openbravo/utility/multiplebpselector/BusinessPartnerSelectorMULTIBP")
        .createXmlDocument();
    ...
    xmlDocument.setParameter("reportC_BP_Group_ID",
        createBPGroupListbox(vars.getStringParameter("inpcBpGroupId")));
