...
enyo.kind({
  ...
  // separator
  {
    ...
    components: [{
      classes: 'span12',
      style: 'border-bottom: 1px solid #cccccc;visibility: hidden;',
      components: [{
...
enyo.kind({
  ...
  components: [{
    style: 'overflow:auto; height: 612px; margin: 5px; background-color: white;',
    components: [{
      ...
      components: [{
        ...
        components: [{
          classes: 'span12',
          style: 'border-bottom: 0px solid #cccccc;',
          components: [{
