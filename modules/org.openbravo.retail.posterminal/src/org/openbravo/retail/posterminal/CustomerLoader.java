  ...
  public JSONObject saveRecord(JSONObject jsoncustomer) throws Exception {
    ...
    try {
      ...
      if (customer.getId() == null) {
    	...
    	final Long timezoneOffset = jsoncustomer.has("timezoneOffset") ? Long.parseLong(jsoncustomer.getString("timezoneOffset")) : 0L;  
        final Date loaded = OBMOBCUtils.calculateClientDatetime(jsoncustomer.getString("loaded"), timezoneOffset);
