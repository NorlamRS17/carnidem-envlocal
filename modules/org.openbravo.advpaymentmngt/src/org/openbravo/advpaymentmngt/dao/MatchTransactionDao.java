...
public class MatchTransactionDao {
  ...
  public static List<FIN_FinaccTransaction> getMatchingFinancialTransaction(
      String strFinancialAccountId, Date transactionDate, Date confirmDate , String strReference, BigDecimal amount,
    ...
    try {
      ...
      if (confirmDate != null) {
        ...
        whereClause.append(".").append(FIN_Payment.PROPERTY_SSDRDATEDEPOSIT);
        whereClause.append(" = :transactionDate2)");
        parameters.put("transactionDate2", confirmDate);
      }else {
    	  whereClause.append(" ) ");
      }
    ...
    if (result.isEmpty()) {
      ...
      try {
        ...
        if (!"".equals(strReference) && !"**".equals(strReference)) {
          whereClause.append("   and ft.").append(FIN_FinaccTransaction.PROPERTY_FINPAYMENT);
          whereClause.append(" IS NULL");
          // Init Customization CashClose
          whereClause.append(" AND (ft.").append(FIN_FinaccTransaction.PROPERTY_SSCCCINREFERENCE);
          whereClause.append(" = :documentNo)");
          // End Customization CashClose
          parameters.put("documentNo", strReference);
        }
  ...
  public static List<FIN_FinaccTransaction> getMatchingFinancialTransaction(
      ...
      List<FIN_FinaccTransaction> excluded) {
    return getMatchingFinancialTransaction(strFinancialAccountId, null, null, strReference, amount,
        strBpartner, excluded);
  }

  public static List<FIN_FinaccTransaction> getMatchingFinancialTransaction(
      String strFinancialAccountId, Date transactionDate, Date confirmDate, BigDecimal amount,
      List<FIN_FinaccTransaction> excluded) {
    final StringBuilder whereClause = new StringBuilder();
    final Map<String, Object> parameters = new HashMap<>();
  ...
  public static List<FIN_FinaccTransaction> getMatchingFinancialTransaction(
    ...
    return getMatchingFinancialTransaction(strFinancialAccountId, null, null, amount, excluded);
  }

  public static List<FIN_FinaccTransaction> getMatchingFinancialTransaction(
      String strFinancialAccountId, BigDecimal amount) {
    return getMatchingFinancialTransaction(strFinancialAccountId, null, null, amount, null);
  }
