  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (!strMProductID.equals("")) {
      ...
      if (strPriceListId.equals(""))
        strPriceListId = SLResupplyLineProductData.selectPriceList(this, strRequisition);
      if (!strPriceListId.equals("")) {
        ...
        String strPriceListVersion = SLResupplyLineProductData.selectPriceListVersion(this,
            strPriceListId, strDueDate);
        if (!strPriceListVersion.equals("")) {
          SLResupplyLineProductData[] prices = SLResupplyLineProductData.getPrices(this,
    ...
    if (strChanged.equals("inpmProductId")) {
      ...
      strResult.append("new Array(\"inpmAttributesetinstanceId_R\", \""
          + FormatUtilities.replaceJS(SLResupplyLineProductData.attribute(this, strAttribute))
          + "\"),\n");
      ...
      String strHasSecondaryUOM = SLResupplyLineProductData.hasSecondaryUOM(this, strMProductID);
      ...
      try {
        ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR",
            "M_Product_UOM_ID", "", "M_Product_UOM_ID", Utility.getContext(this, vars,
                "#AccessibleOrgTree", "SLResupplyLineProduct"), Utility.getContext(this, vars,
                "#User_Client", "SLResupplyLineProduct"), 0);
