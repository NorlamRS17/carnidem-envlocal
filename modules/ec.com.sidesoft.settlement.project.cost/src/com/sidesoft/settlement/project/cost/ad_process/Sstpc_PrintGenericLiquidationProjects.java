package com.sidesoft.settlement.project.cost.ad_process;
...
public class Sstpc_PrintGenericLiquidationProjects extends HttpSecureAppServlet {
  ...
  private static Logger log4j1 = Logger.getLogger(Sstpc_PrintGenericLiquidationProjects.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    strSessionValue = "4CDE774BC4F04C01BF40B1F1C2468C81|SSTPC_LIQUIDATION_PROJECTS_ID";
    StrWindowdID = "4CDE774BC4F04C01BF40B1F1C2468C81";
    StrTableID = "5727E9E5DC604711AC27D3C5F5982E8F";
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    LiquidationProjects obdalLiqProj = OBDal.getInstance().get(LiquidationProjects.class,
        strDocumentId);
    DocumentType obdalDocType = OBDal.getInstance().get(DocumentType.class,
        obdalLiqProj.getDoctype().getId());
    ...
    PrintWithh.add(Restrictions.eq(SescrTemplateReport.PROPERTY_DOCTYPE, obdalDocType));
    ...
    if (LstTemplate.get(0).getWindow().getId().equals(StrWindowdID)) {
      ...
      if (log4j1.isDebugEnabled())
        log4j1.debug("Output: Liquidations Project - pdf");
