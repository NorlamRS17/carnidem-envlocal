...
public class ReportReconciliationFlopec extends HttpSecureAppServlet {
  ...
  private void printPageDataPDF(HttpServletRequest request, HttpServletResponse response,
    ...
    String strMainReportName = "@basedesign@/com/sidesoft/localization/ecuador/finances/reports/ReportReconciliation.jrxml";
    ...
    try {
      subReportOutstandingPayment = Utility.getTranslatedJasperReport(this,
          strBaseDesign
              + "/com/sidesoft/localization/ecuador/finances/reports/OutstandingPayment.jrxml",
          vars.getLanguage(), strBaseDesign);

      subReportOutstandingDeposit = Utility.getTranslatedJasperReport(this,
          strBaseDesign
              + "/com/sidesoft/localization/ecuador/finances/reports/OutstandingDeposit.jrxml",
          vars.getLanguage(), strBaseDesign);

      subReportUnreconciledBankStatementLines = Utility.getTranslatedJasperReport(this,
          strBaseDesign
              + "/com/sidesoft/localization/ecuador/finances/reports/UnreconciledBankStatement.jrxml",
          vars.getLanguage(), strBaseDesign);
    ...
    parameters.put("SUBREP_OutstandingPayment", subReportOutstandingPayment);
    parameters.put("SUBREP_OutstandingDeposit", subReportOutstandingDeposit);
    parameters.put("SUBREP_UnreconciledBankStatement", subReportUnreconciledBankStatementLines);
