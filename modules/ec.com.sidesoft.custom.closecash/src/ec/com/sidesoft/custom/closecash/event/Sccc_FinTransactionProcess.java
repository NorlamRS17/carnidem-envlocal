	  ...
	  protected Entity[] getObservedEntities() {
	    return entities;
          ...
          public void onSave(@Observes EntityNewEvent event) {
            ...
            final FIN_FinaccTransaction objFinaccTransaction = (FIN_FinaccTransaction) event
                .getTargetInstance();
            ...
            if (objFinaccTransaction.isScccIscashclousure()) {
              ...
              // private OBError processTransaction(VariablesSecureApp vars, ConnectionProvider
              // conn,
              // String strAction, FIN_FinaccTransaction transaction) throws Exception {
              try {
                VariablesSecureApp vars = new VariablesSecureApp(null);
                ProcessBundle pb = new ProcessBundle("F68F2890E96D4D85A1DEF0274D105BCE", vars)
                    .init(conn);
