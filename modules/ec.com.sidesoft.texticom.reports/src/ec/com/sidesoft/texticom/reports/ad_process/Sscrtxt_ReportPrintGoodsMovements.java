...
public class Sscrtxt_ReportPrintGoodsMovements extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(Sscrtxt_ReportPrintGoodsMovements.class);
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    InternalMovement MMovementLineID = OBDal.getInstance().get(InternalMovement.class,
        StrTransactionID);
    ...
    if (LstTemplate.get(0).getWindow().getId().equals(StrWindowdID)) {
      ...
      parameters.put("DOCUMENT_ID", MMovementLineID.getId().toString());
