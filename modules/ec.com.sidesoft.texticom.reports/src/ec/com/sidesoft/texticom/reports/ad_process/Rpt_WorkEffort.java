...
public class Rpt_WorkEffort extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(Rpt_WorkEffort.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars
          .getSessionValue("0D49D788605449178F19CBB42B5335EA|M_Production_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: Rpt_QuoteFromOpportunity - xls");

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("document_id", strDocumentId);

    String strReportPath = "@basedesign@/ec/com/sidesoft/texticom/reports/ad_Reports/workEffort/Rpt_work_effort.jrxml";
    renderJR(vars, response, strReportPath, "xls", parameters, null, null);
  }
