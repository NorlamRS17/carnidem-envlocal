package ec.com.sidesoft.ldm.report.ad_process;
...
public class Ssldmrp_GenericPrintProductionPlan extends HttpSecureAppServlet {
  ...
  private static Logger log4j1 = Logger.getLogger(Ssldmrp_GenericPrintProductionPlan.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    strSessionValue = "191|M_PRODUCTIONPLAN_ID";
    StrWindowdID = "191";
    StrTableID = "385";
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (LstTemplate.get(0).getWindow().getId().equals(StrWindowdID)) {
      ...
      if (log4j1.isDebugEnabled())
        log4j1.debug("Output: Production Plan - pdf");
