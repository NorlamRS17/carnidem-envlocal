...
public class ProductComplete extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    strOrgId = vars.getSessionValue("P|OBUIAPP_RECENTVIEWLIST");
    strWindowId = vars.getSessionValue("P|OBUIAPP_RECENTVIEWLIST", "windowId");
    strTabId = vars.getSessionValue("P|OBUIAPP_RECENTVIEWLIST", "tabId");
    
    List<PriceAdjustment> applicableGifts;
    lineId = vars.getSessionValue("167|C_INVOICELINE_ID");
	if(lineId != null && lineId.length()>30) {
		applicableGifts = ec.com.sidesoft.backoffice.discount.ad_action.Gift.getPromotions(lineId, "270");
	}else {
		lineId = vars.getSessionValue("143|C_ORDERLINE_ID");
		applicableGifts = ec.com.sidesoft.backoffice.discount.ad_action.Gift.getPromotions(lineId, "187");
	}	
    String mOffer = "";
    if(applicableGifts.size()>0)
    	mOffer=applicableGifts.get(0).getId();
    if (vars.commandIn("DEFAULT")) {
      ...
      if (windowId.equals("800051") || (windowId.equals("800052"))) {
        log4j.debug("selector called from process plan||work requirement using production=y filter");
      ...
      if (strStore.equals("Y")) {
        if (vars.getLanguage().equals("en_US"))
          data = ProductCompleteData.select(this, rownum, strKeyValue, "", strWarehouse,
              isCalledFromProduction, vars.getRole(), strBpartner, strClients, "1", null,
              oraLimit1, oraLimit2,mOffer);
        else
          data = ProductCompleteData.selecttrl(this, vars.getLanguage(), rownum, strKeyValue, "",
              ...
              null, oraLimit1, oraLimit2,mOffer);
      } else {
        if (vars.getLanguage().equals("en_US"))
          data = ProductCompleteData.selectNotStored(this, rownum, strKeyValue, "", strBpartner,
              strClients, strOrgs, isCalledFromProduction, "1", null, oraLimit1, oraLimit2
              ,mOffer);
        else
      ...
      printGridData(response, vars, strKey, strName, strWarehouse, strBpartner, strStore,
          ...
          strPageSize, strNewFilter, mOffer);
    } else
      pageError(response);
  }
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "ec/com/sidesoft/backoffice/discount/info/ProductComplete").createXmlDocument();
  ...
  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey,
      ...
      String strOrderDirs, String strOffset, String strPageSize, String strNewFilter, String mOffer)
      throws IOException, ServletException {
          ...
          if (strStore.equals("Y")) {
            if (vars.getLanguage().equals("en_US"))
              ...
              data = ProductCompleteData.selecttrl(this, vars.getLanguage(), "ROWNUM", strKey,
                  ...
                  strClients, strOrderBy, "", oraLimit1, oraLimit2,mOffer);
          } else {
            if (vars.getLanguage().equals("en_US"))
              ...
              data = ProductCompleteData.selectNotStoredtrl(this, "ROWNUM", vars.getLanguage(),
                  ...
                  strOrderBy, "", oraLimit1, oraLimit2,mOffer);
          }
        } else {
          ...
          if (strStore.equals("Y")) {
            ...
            if (vars.getLanguage().equals("en_US"))
              data = ProductCompleteData.selectNotStored(this, "1", strKey, strName, strBpartner,
                  strClients, strOrgs, strIsCalledFromProduction, strOrderBy, "", "", ""
                  ,mOffer);
            else
