...
public class SL_Order_Amt extends SimpleCallout {
	...
	@Override
	  protected void execute(CalloutInfo info) throws ServletException {
		...
		if(PriceAdjustment.discountPrice(order, product, qtyOrdered, priceStd)!=new BigDecimal ("0")){
		 discountprice = PriceAdjustment.discountPrice(order, product, qtyOrdered, priceStd);
		}
