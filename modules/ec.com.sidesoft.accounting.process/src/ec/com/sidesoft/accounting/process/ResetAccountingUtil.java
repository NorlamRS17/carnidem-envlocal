...
public class ResetAccountingUtil {
  ...
  private static final Logger log4j = Logger.getLogger(ResetAccountingUtil.class);
  ...
  public static HashMap<String, Integer> restore(String clientId, String adOrgId, String tableId,
    ...
    try {
      ...
      if (!table.isView()) {
        ...
        if (!StringUtils.isBlank(getDocumenTypeId())) {
          strUpdate = strUpdate + " and  C_DocType_ID = :documenTypeId ";
        }
        ...
        try {
          ...
          if (!StringUtils.isBlank(getDocumenTypeId())) {
            update.setString("documenTypeId", getDocumenTypeId());
          }
          ...
          for (String dbt : docbasetypes) {
            ...
            for (String organization : orgIds) {
              ...
              for (Date[] p : periods) {
                ...
                if (!StringUtils.isBlank(getDocumenTypeId())) {
                  consDate.append(" and  e.documentType.id = :documentTypeId ");
                }
                ...
                if (!StringUtils.isBlank(getDocumenTypeId())) {
                  query.setString("documentTypeId", getDocumenTypeId());
                }
  ...
  public static String getDocumenTypeId() {
    return documenTypeId;
  }

  public static void setDocumenTypeId(String documenTypeId) {
    ResetAccountingUtil.documenTypeId = documenTypeId;
  }
  ...
  private static List<String> getDocbasetypes(String clientId, String tableId, String recordId) {
    ...
    if (!StringUtils.isBlank(getDocumenTypeId())) {
      myQuery = myQuery + " and  e.documentType.id = :documentTypeId ";
    }
