...
public class FinnAccountSelectorFilterExpression implements FilterExpression {
  ...
  public String getExpression(Map<String, String> _requestMap) {
    try {
      ...
      JSONObject jsonparams = new JSONObject(requestMap.get("context"));

      if (jsonparams.has("inpfinFinancialAccountFromId")) {
        FIN_FinancialAccount financialaccount = OBDal.getInstance().get(FIN_FinancialAccount.class,
            jsonparams.get("inpfinFinancialAccountFromId"));
