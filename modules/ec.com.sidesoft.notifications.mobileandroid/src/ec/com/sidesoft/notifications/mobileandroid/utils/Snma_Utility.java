package ec.com.sidesoft.notifications.mobileandroid.utils;
...
public class Snma_Utility {
  ...
  static public List<JSONObject> getNotificatinosVendor(String strUserVendorID)
	      throws JSONException {

 
	    List<JSONObject> notificationVendors = new ArrayList<JSONObject>();
	    ConnectionProvider conn = new DalConnectionProvider(false);
	    ...
	    try {
	      ...
	      String strSql = null;
	      strSql = "select \n" + 
	      		"snma_app_notify_id as notification_vendor_id\n" + 
	      		", snma_type_notify_id as type_notification_id\n" + 
	      		", salesrep_id  as user_ob_id\n" + 
	      		", description\n" + 
	      		", coalesce(enddatenotification,datenotification) as date_notification\n" + 
	      		" from snma_app_notify\n" + 
	      		" where salesrep_id in (select  ad_user_id from ad_user where c_bpartner_id='" + strUserVendorID + "') " +
	      		" and date(coalesce(enddatenotification,now()))=date(now())"
	      		;
	      ...
	      while (rsConsulta.next()) {
	        ...
	        JSONObject notificationVendor = new JSONObject();

	        notificationVendor.put("notification_vendor_id",
	            rsConsulta.getString("notification_vendor_id") != null ? rsConsulta.getString("notification_vendor_id")
	                : "");
	        notificationVendor.put("type_notification_id",
	            rsConsulta.getString("type_notification_id") != null ? rsConsulta.getString("type_notification_id") : "");
	        
	        notificationVendor.put("user_ob_id",
		            rsConsulta.getString("user_ob_id") != null ? rsConsulta.getString("user_ob_id") : "");
		        	        
	        notificationVendor.put("description",
	            rsConsulta.getString("description") != null ? rsConsulta.getString("description") : "");
	        
	        notificationVendor.put("date_notification",
	            rsConsulta.getString("date_notification") != null ? rsConsulta.getString("date_notification") : "");
	       
		               
	        notificationVendors.add(notificationVendor);
	      }
	      // Close ConnectionProvider
	      conndb.close();
	      // Close PreparedStatement
	      ...
	      System.out.println("getNotificatinosVendor: " + e.getMessage());
	      throw new OBException("getNotificatinosVendor: " + e.getMessage());
	    }

	    return notificationVendors;

	  }

  static public List<JSONObject> getTypeNotificatinosVendor()
	      throws JSONException {
	    ...
	    try {
	      ...
	      strSql = "select\n" + 
	      		"snma_type_notify_id as type_notification_id\n" + 
	      		", value as code_notify\n" + 
	      		", name as name_notify\n" + 
	      		"from  snma_type_notify"
	      		;
	      ...
	      while (rsConsulta.next()) {
	        ...
	        notificationVendor.put("type_notification_id",
	            rsConsulta.getString("type_notification_id") != null ? rsConsulta.getString("type_notification_id")
	                : "");
	        notificationVendor.put("code_notify",
	            rsConsulta.getString("code_notify") != null ? rsConsulta.getString("code_notify") : "");
	        
	        notificationVendor.put("name_notify",
		            rsConsulta.getString("name_notify") != null ? rsConsulta.getString("name_notify") : "");
	      ...
	      System.out.println("getTypeNotificatinosVendor: " + e.getMessage());
	      throw new OBException("getTypeNotificatinosVendor: " + e.getMessage());
	    }
