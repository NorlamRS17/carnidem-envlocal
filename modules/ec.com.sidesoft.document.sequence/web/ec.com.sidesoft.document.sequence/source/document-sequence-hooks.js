...
SIDESOFTUTILS.generateCode = function (documentSequence, bp, identifier, inDevelopment, store, RUC) {
  ...
  var verificationCode = SIDESOFTUTILS.getVerificationCode(date + identifier + RUC + tipoDeAmbiente + serie + numComproSec + random8Digit + tipoDeEmision) //Campo 9

  if (verificationCode === -1) {
    return verificationCode;
  }

  return date + identifier + RUC + tipoDeAmbiente + serie + numComproSec + random8Digit + tipoDeEmision + verificationCode;
}
