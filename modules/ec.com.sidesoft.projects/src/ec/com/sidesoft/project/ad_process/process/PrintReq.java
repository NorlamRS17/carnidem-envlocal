 ...
 * ***********************************************************************
 */
package ec.com.sidesoft.project.ad_process.process;
...
public class PrintReq extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(PrintReq.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars
          .getSessionValue("AA0CC8D6014F439398795B49346E246C|C_ProjectTask_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    String StrWindowdID = "";
    String StrTableID = "";
    StrWindowdID = "AA0CC8D6014F439398795B49346E246C";
    StrTableID = "584";
    String StrTransactionID = vars
        .getSessionValue("AA0CC8D6014F439398795B49346E246C|C_ProjectTask_ID");

    /*
     * ProjectTask CProjectTaskID = OBDal.getInstance().get(ProjectTask.class, StrTransactionID);
     * Organization ADOrg = OBDal.getInstance().get(Organization.class,
     * CProjectTaskID.getOrganization().getId().toString());
     */
