...
public class ECWSClient {
  ...
  private String[] saveAutValues(Document documento, Invoice invoice)
    ...
    if (numA != null) {
      ...
      fecha.setYear(Integer.valueOf(sFA.substring(0, 4)));
      fecha.setMonth(Integer.valueOf(sFA.substring(5, 7)));
      fecha.setDay(Integer.valueOf(Integer.valueOf(sFA.substring(8, 10))));
      fecha.setHour(Integer.valueOf(sFA.substring(11, 13)));
      fecha.setMinute(Integer.valueOf(sFA.substring(14, 16)));
      fecha.setSecond(Integer.valueOf(sFA.substring(17, 19)));
