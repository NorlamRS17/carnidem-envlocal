...
public class Generate_Movement extends DalBaseProcess {
	...
	public static void UpdateInvoice(ConnectionProvider connectionProvider,
			...
			String strURLRide, String strStatusFe, String strDateAut) {
		...
		if (strDateAut != null 
			...
			applyDateAu = true;
			sqlDate = ", EM_Eei_Fechaauto = ? ";
		}
		
		strSql = "update m_movement set em_eei_codigo=?, em_eei_numauto=?, em_eei_urlxml=?,em_eei_urlride=?, em_eei_status=? "+sqlDate+" where m_movement_id =?";
