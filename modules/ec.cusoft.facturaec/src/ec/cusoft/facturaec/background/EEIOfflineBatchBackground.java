...
public class EEIOfflineBatchBackground extends DalBaseProcess implements KillableProcess {
          ...
          try {
            ...
            if(maxDate.equals(null)) {
                ...
                if (!invoice.isSalesTransaction()) {
                	 eDocType = invoice.getSswhCDoctype().getEeiEdocType();	
                }
                
                if (hoursDifference > maxDate.intValue() && !eDocType.equals("07")) {
