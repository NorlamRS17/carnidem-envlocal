...
public class QualityControlReportActionHandler extends BaseReportActionHandler {

  private static final Logger log = LoggerFactory
      .getLogger(QualityControlReportActionHandler.class);
  ...
  protected JSONObject doExecute(Map<String, Object> parameters, String content) {
    ...
    try {
      parameters.replace("reportId", "B38B1CDC70BD431FADBF0B72E45D3514");
