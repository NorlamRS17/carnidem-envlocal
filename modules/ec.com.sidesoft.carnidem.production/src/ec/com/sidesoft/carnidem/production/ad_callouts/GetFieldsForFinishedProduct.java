...
public class GetFieldsForFinishedProduct extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    info.addResult("inpemSpqulyTotalqty", productionLine.getMovementQuantity());
    info.addResult("inpemSpqulyUomId", productionLine.getUOM().getId());
