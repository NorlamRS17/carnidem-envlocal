 ...
 *************************************************************************
 */
package ec.com.sidesoft.deposit.number.ad_actionbutton;
...
import ec.com.sidesoft.deposit.number.process.FIN_ExecutePayment;
...
public class ExecutePayments extends HttpSecureAppServlet {
  ...
  private static final String BatchPaymentExecutionForm = "169AD4B5D4E349A69767B50E167CCF52";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      final String strDepositNo = vars.getRequiredStringParameter("inpDepositNo");
      if (strDepositNo == null || strDepositNo.equals("")) {
        OBError message = Utility.translateError(this, vars, vars.getLanguage(),
            Utility.parseTranslation(this, vars, vars.getLanguage(), "@SSCCR_DepositNo_Required@"));
        vars.setMessage(strTabId, message);
        printPageClosePopUpAndRefreshParent(response, vars);
      }
      printPage(response, vars, executionProcess, getOrganization(vars, strWindowId), strDepositNo);
      ...
      processAndClose(response, vars, strWindowId, executionProcess, payments,
          dao.getObject(Organization.class, strOrganizationId), strDepositNo);
    }
  }

  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
      PaymentExecutionProcess executionProcess, String strOrganizationId, String strDepositNo)
      throws IOException, ServletException {
    log4j.debug("Output: Execute Payments get parameters");
    dao = new AdvPaymentMngtDao();

    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate("ec/com/sidesoft/deposit/number/ad_actionbutton/ExecutePayments")
        .createXmlDocument();
    ...
    xmlDocument.setParameter("depositno", strDepositNo);
  ...
  private void processAndClose(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strDepositNo) throws ServletException, IOException {
    ...
    try {
      ...
      if (strDepositNo != null && !strDepositNo.equals("")) {
        for (FIN_Payment payment : payments) {
          payment.setReferenceNo(strDepositNo);
