 ...
 *************************************************************************
 */
package ec.com.sidesoft.deposit.number.ad_forms;
...
import ec.com.sidesoft.deposit.number.dao.AdvPaymentMngtDao;
import ec.com.sidesoft.deposit.number.dao.BatchPaymentDao;
...
public class BatchPaymentExecution extends HttpSecureAppServlet {
	...
	private static final String[] colNames = { "documentno", "businesspartner", "description", "duedate", "amount",
			"rowkey" };
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (vars.commandIn("DEFAULT")) {
			...
			String strOrganizationId = vars.getGlobalVariable("inpOrgId", "BatchPaymentExecution|OrgId", "0");
			...
			String strIsReceipt = vars.getGlobalVariable("inpIsReceipt", "BatchPaymentExecution|IsReceipt", "Y");

			printPageDataSheet(response, vars, strOrganizationId, strDateFrom, strDateTo, strFinancialAccountId,
					strPaymentMethodId, strIsReceipt);
			...
			printGrid(response, vars, strSortCols, strSortDirs, strOffset, strPageSize, strNewFilter, strOrgId,
					strFinancialAccountId, strPaymentMethodId, strDateFrom, strDateTo, isReceipt);
			...
			printGridData(response, vars, strSortCols, strSortDirs, strOffset, strPageSize, strNewFilter, strOrgId,
					strFinancialAccountId, strPaymentMethodId, strDateFrom, strDateTo, isReceipt);
			...
			boolean isReceipt = "Y"
					.equals(vars.getGlobalVariable("inpIsReceipt", "BatchPaymentExecution|IsReceipt", ""));
			reloadFinancialAccountCombo(response, strPaymentMethodId, strFinancialAccountId, strOrgId, strCurrencyId,
					isReceipt);
	...
	private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strOrganizationId,
			String strDateFrom, String strDateTo, String strFinancialAccountId, String strPaymentMethodId,
			String strIsReceipt) throws IOException, ServletException {
		log4j.debug("Output: BatchPaymentExecution");

		XmlDocument xmlDocument = xmlEngine
				.readXmlTemplate("ec/com/sidesoft/deposit/number/ad_forms/BatchPaymentExecution").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "BatchPaymentExecution", false, "", "", "", false,
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"ec.com.sidesoft.deposit.number.ad_forms.BatchPaymentExecution");
			xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
			xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
			xmlDocument.setParameter("childTabContainer", tabs.childTabs());
			xmlDocument.setParameter("theme", vars.getTheme());

			NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PaymentExecution.html", classInfo.id,
					classInfo.type, strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "PaymentExecution.html", strReplaceWith);
		...
		String paymentMethodComboHtml = FIN_Utility.getPaymentMethodList(strPaymentMethodId, "", newOrg, true, true,
				isReceipt);
		...
		String finAccountComboHtml = FIN_Utility.getFinancialAccountList(strPaymentMethodId, strFinancialAccountId,
				newOrg, true, "", isReceipt);
	...
	private void printGridStructure(HttpServletResponse response, VariablesSecureApp vars)
		...
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("ec/com/sidesoft/deposit/number/utility/DataGridStructure")
				.createXmlDocument();
	...
	private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
		...
		// String[] colNames = { "documentno", "businesspartner", "description",
		// "duedate", "amount",
		// "rowkey" };
		String[] colWidths = { "150", "300", "350", "150", "150", "0" }; // total 780
	...
	private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strOrderCols,
			String strOrderDirs, String strOffset, String strPageSize, String strNewFilter, String strOrgId,
			String strFinancialAccountId, String strPaymentMethodId, String strDateFrom, String strDateTo,
			boolean isReceipt) throws IOException {
			...
			for (FIN_Payment pay : gridPayments) {
				...
				for (int k = 0; k < headers.length; k++) {
					...
					if (columnData != "") {
						...
						strRowsData.append(columnData.replaceAll("<b>", "").replaceAll("<B>", "").replaceAll("</b>", "")
								.replaceAll("</B>", "").replaceAll("<i>", "").replaceAll("<I>", "")
	...
	private void reloadPaymentMethodCombo(HttpServletResponse response, String srtPaymentMethod,
			String strFinancialAccountId, String strOrgId, boolean isReceipt) throws IOException, ServletException {
		log4j.debug("Callout: Financial Account has changed to");

		String paymentMethodComboHtml = FIN_Utility.getPaymentMethodList(srtPaymentMethod, strFinancialAccountId,
	...
	private void reloadFinancialAccountCombo(HttpServletResponse response, String strPaymentMethodId,
		...
		String finAccountComboHtml = FIN_Utility.getFinancialAccountList(strPaymentMethodId, strFinancialAccountId,
				strOrgId, true, strCurrencyId, isReceipt);
	...
	private void printGrid(HttpServletResponse response, VariablesSecureApp vars, String strOrderCols,
			String strOrderDirs, String strOffset, String strPageSize, String strNewFilter, String strOrgId,
			String strFinancialAccountId, String strPaymentMethodId, String strDateFrom, String strDateTo,
			boolean isReceipt) throws IOException {

		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("ec/com/sidesoft/deposit/number/utility/BatchPaymentGrid")
				.createXmlDocument();

		AdvPaymentMngtDao dao = new AdvPaymentMngtDao();
		List<FIN_Payment> gridPayments = null;
		int offset = Integer.valueOf("7").intValue();
		String type = "Hidden";
		String title = "";
		String description = "";
		...
		FieldProvider[] data = BatchPaymentDao.getTransactionsFiltered(gridPayments);
