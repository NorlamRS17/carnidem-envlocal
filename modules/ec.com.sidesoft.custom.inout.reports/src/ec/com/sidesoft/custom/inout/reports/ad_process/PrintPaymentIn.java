...
public class PrintPaymentIn extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars
          .getSessionValue("E547CE89D4C04429B6340FFA44E70716|FIN_PAYMENT_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    String strReportName = "@basedesign@/ec/com/sidesoft/custom/inout/reports/ad_reports/PayablesReceivables_Voucher.jrxml";
