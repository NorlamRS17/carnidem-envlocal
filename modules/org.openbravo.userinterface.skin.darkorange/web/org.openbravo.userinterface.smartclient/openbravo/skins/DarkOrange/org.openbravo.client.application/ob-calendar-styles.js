...
if (isc.OBCalendar) { // To guarantee backward compatibility: isc.OBCalendar has been introduced in OB3 MP19
  ...
  isc.OBCalendar.changeDefaults('previousButtonDefaults', {
    src: OB.Styles.skinsPath + 'DarkOrange/org.openbravo.client.application/images/statusbar/iconButton-previous.png'
  });

  isc.OBCalendar.changeDefaults('nextButtonDefaults', {
    src: OB.Styles.skinsPath + 'DarkOrange/org.openbravo.client.application/images/statusbar/iconButton-next.png'
  });

  isc.OBCalendar.changeDefaults('addEventButtonDefaults', {
    src: OB.Styles.skinsPath + 'DarkOrange/org.openbravo.client.application/images/statusbar/iconButton-add.png'
  });

  isc.OBCalendar.changeDefaults('dayLanesToggleButtonDefaults', {
    src: OB.Styles.skinsPath + 'DarkOrange/org.openbravo.client.application/images/calendar/iconDayLanesToggle.png'
  });
}
