...
public class ImportPriceListEventListener extends EntityPersistenceEventObserver {
  private static Entity[] entities = {
      ModelProvider.getInstance().getEntity(ImportPriceList.ENTITY_NAME) };
  ...
  public void onDelete(@Observes EntityDeleteEvent event) {
    ...
    ImportPriceList record = OBDal.getInstance().get(ImportPriceList.class,
