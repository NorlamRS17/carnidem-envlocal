...
@ApplicationScoped
@ComponentProvider.Qualifier(SPOR_ORecoveredComponentProvider.QUALIFIER)

public class SPOR_ORecoveredComponentProvider extends BaseComponentProvider {
	public static final String QUALIFIER = "OrderRecovered_Training_Main";
	public static final String MODULE_JAVA_PACKAGE = "ec.com.sidesoft.pos.order.recovered";
	...
	public List<ComponentResource> getGlobalComponentResources(){
		...
		grhelper.add("hooks/OrderRecovered.js");
