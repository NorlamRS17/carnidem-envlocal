...
public class SpareTransfer extends DalBaseProcess {
	private static final Logger log4j = Logger.getLogger(SpareTransfer.class);
	...
	public void doExecute(ProcessBundle bundle) throws Exception {
		...
		try {
			...
			String result = Helper.executeSql("spsmvat_goodsmovement", recordId, "ST", null);
