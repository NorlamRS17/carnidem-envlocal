...
static Logger log4j = Logger.getLogger(AttributeSetInstanceValueData.class);
  ...
  public String emCsljJuliandate;
  public String islot;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_cslj_juliandate") || fieldName.equals("emCsljJuliandate"))
      return emCsljJuliandate;
  ...
  public static AttributeSetInstanceValueData[] select(ConnectionProvider connectionProvider, String mAttributesetId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT A_S.M_ATTRIBUTESET_ID, A_S.NAME, A_S.DESCRIPTION, A_S.GUARANTEEDAYS, A_S.ISGUARANTEEDATE,A_S.em_cslj_juliandate, A_S.ISLOT, A_S.ISSERNO, " +
    ...
    ResultSet result;
    Vector<AttributeSetInstanceValueData> vector = new Vector<AttributeSetInstanceValueData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectAttributeSetInstanceValueData.emCsljJuliandate = UtilSql.getValue(result, "em_cslj_juliandate");
  ...
  public static int insertHeader(Connection conn, ConnectionProvider connectionProvider, String mAttributesetinstanceId, String adClientId, String adOrgId, String adUserId, String mAttributesetId, String serno, String lot, String guaranteedate, String mLotId, String islocked, String lockDescription, String em_cslj_datejulian)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, em_cslj_datejulian);
  ...
  public static int updateHeader(Connection conn, ConnectionProvider connectionProvider, String adUserId, String mAttributesetId, String serno, String lot, String guaranteedate, String mLotId, String islocked, String lockDescription, String em_cslj_datejulian, String mAttributesetinstanceId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        UPDATE M_ATTRIBUTESETINSTANCE SET UPDATED=now(), UPDATEDBY = ?, M_ATTRIBUTESET_ID = ?, SERNO=?, LOT=?, GUARANTEEDATE=TO_DATE(?), " +
      "        M_LOT_ID = ?, ISLOCKED = ?, LOCK_DESCRIPTION = ?, em_cslj_datejulian = ?  " +
      "        WHERE M_ATTRIBUTESETINSTANCE_ID = ?";
