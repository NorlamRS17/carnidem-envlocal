...
static Logger log4j = Logger.getLogger(AttributeSetInstanceData.class);
  ...
  public static AttributeSetInstanceData[] select(ConnectionProvider connectionProvider, String mAttributesetId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT A_S.M_ATTRIBUTESET_ID, A_S.NAME, A_S.DESCRIPTION, A_S.GUARANTEEDAYS,A_S.em_cslj_juliandate, A_S.ISGUARANTEEDATE, A_S.ISLOT, A_S.ISSERNO, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectAttributeSetInstanceData.emCsljJuliandate = UtilSql.getValue(result, "em_cslj_juliandate");
