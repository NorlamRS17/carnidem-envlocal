...
static Logger log4j = Logger.getLogger(AgingDaoData.class);
  ...
  public static AgingDaoData select(ConnectionProvider connectionProvider, String showDoubtfulDebt, String asOfDate, String currencyId, String fiveRangeBucket, String fourthRangeBucket01, String thirdRangeBucket01, String secondRangeBucket01, String firstRangeBucket01, String firstRangeBucket, String secondRangeBucket, String thirdRangeBucket, String fourthRangeBucket, String org, String cbPartnerId, String recOrPay, String excludeVoids, String pgLimit, String oraLimit1)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "				       LEFT JOIN ssws_withholdingsale wh ON wh.ssws_withholdingsale_id = psd.em_ssws_withholdingsale_id " +
    ...
    strSql = strSql + 
      ...
      "				                      WHERE CASE WHEN psd.em_ssws_withholdingsale_id is null THEN Trunc(p.paymentdate) ELSE 									Trunc(wh.withholdingdate) END > TO_DATE(?)" +
    ...
    st = conn.prepareStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, asOfDate);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, currencyId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, fiveRangeBucket);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, fourthRangeBucket01);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, thirdRangeBucket01);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, secondRangeBucket01);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, firstRangeBucket01);
  ...
  private AgingDaoData getselect() throws SQLException {
    AgingDaoData objectAgingDaoData = new AgingDaoData();
        ...
        objectAgingDaoData.duedate = UtilSql.getValue(result, "duedate");
        objectAgingDaoData.taxid = UtilSql.getValue(result, "taxid");
  ...
  public static AgingDaoData selectCredit(ConnectionProvider connectionProvider, String currencyId, String org, String paidStatus, String asOfDate, String recOrPay, String cbPartnerId, String pgLimit, String oraLimit1)    throws ServletException {
    ...
    strSql = strSql + 
      "    SELECT B.* FROM (" +
      "    SELECT A.credit, bp.c_bpartner_id as bpId, bp.name as bpName, A.dateInvoiced as dateInvoiced, A.invoiceId as invoiceId, A.docNo, bp.taxId" +
      "    FROM (" +
    ...
    strSql = strSql + 
      ...
      "		       LEFT JOIN ssws_withholdingsale wh ON wh.ssws_withholdingsale_id = fpsd.em_ssws_withholdingsale_id " +
    ...
    strSql = strSql + 
      "))" +
      "                       AND CASE WHEN fpsd.em_ssws_withholdingsale_id is null THEN Trunc(fp2.paymentdate) ELSE Trunc(wh.withholdingdate) END 				 <= TO_DATE(?)" +
      "                       AND fp2.isreceipt = ?" +
      "                       AND 2=2";
    ...
    strSql = strSql + 
      ...
      "		       			LEFT JOIN ssws_withholdingsale wh ON wh.ssws_withholdingsale_id = fpsd1.em_ssws_withholdingsale_id " +
      "                                 WHERE  fpc.fin_payment_id = fp1.fin_payment_id " +
      "                                        AND CASE WHEN fpsd1.em_ssws_withholdingsale_id is null THEN Trunc(fp1.paymentdate) ELSE 						Trunc(wh.withholdingdate) END  <= TO_DATE(?) " +
  ...
  public static AgingDaoData selectDetail(ConnectionProvider connectionProvider, String currencyId, String showDoubtfulDebt, String asOfDate, String fourthRangeBucket01, String thirdRangeBucket01, String secondRangeBucket01, String firstRangeBucket01, String firstRangeBucket, String secondRangeBucket, String thirdRangeBucket, String fourthRangeBucket, String org, String cbPartnerId, String recOrPay, String excludeVoids, String pgLimit, String oraLimit1)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "           B.dateacct as dateInvoiced, FIN_AGING_INVOICECURRENCY_RATE(B.c_invoice_id, ?, B.c_currency_id) * (B.doubtfuldebtamt) as doubtfuldebt, B.duedate, bp.taxId" +
      "           FROM (  " +
      "                 SELECT A.c_invoice_id, A.c_currency_id, A.bpId, A.documentNo, A.dateacct, SUM(A.amount) as amount, SUM(A.doubtfuldebtamt) as doubtfuldebtAmt, A.scope, A.duedate" +
      "                 FROM ( " +
    ...
    strSql = strSql + 
      ...
      "                                                AND pd.fin_payment_detail_id = psd.fin_payment_detail_id) ) ) " +
      "                      ) A       " +
      "                GROUP BY A.c_invoice_id, A.c_currency_id, A.bpId, A.documentNo, A.dateacct, A.scope, A.duedate" +
      "               ) B" +
  ...
  private AgingDaoData getselectDetail() throws SQLException {
    AgingDaoData objectAgingDaoData = new AgingDaoData();
        ...
        objectAgingDaoData.dateinvoiced = UtilSql.getDateValue(result, "dateinvoiced", "dd-MM-yyyy");
        objectAgingDaoData.doubtfuldebt = UtilSql.getValue(result, "doubtfuldebt");
        objectAgingDaoData.duedate = UtilSql.getDateValue(result, "duedate", "dd-MM-yyyy");
        objectAgingDaoData.taxid = UtilSql.getValue(result, "taxid");
        objectAgingDaoData.rownum = Long.toString(countRecord);
      return objectAgingDaoData;
  }
