...
static Logger log4j = Logger.getLogger(CreateFromShipmentData.class);
  ...
  public String cAum;
  public String aumname;
  public String uompreference;
  public String haveuompreference;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("product_name") || fieldName.equals("productName"))
      return productName;
    else if (fieldName.equalsIgnoreCase("m_locator_id") || fieldName.equals("mLocatorId"))
      return mLocatorId;
    else if (fieldName.equalsIgnoreCase("aumqtyoi"))
      return aumqtyoi;
      ...
      return cAum;
    else if (fieldName.equalsIgnoreCase("aumname"))
      return aumname;
    else if (fieldName.equalsIgnoreCase("uompreference"))
      return uompreference;
    else if (fieldName.equalsIgnoreCase("haveuompreference"))
      return haveuompreference;
  ...
  public static CreateFromShipmentData[] selectFromPO(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgClient, String poId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT '' as product_name, '' as m_locator_id,0 as aumqtyOI,0 as movementqty,  o.C_ORDER_ID, Ad_Column_Identifier(TO_CHAR('C_Order'), TO_CHAR(o.c_order_id), TO_CHAR(?)) AS NAME, " +
      ...
      "        l.AUMQTY - SUM(COALESCE(M_GET_CONVERTED_AUMQTY(l.m_product_id, m.Qty, l.c_aum), 0)) AS AUMQTY, l.C_AUM AS C_AUM, " +
      "        (SELECT UOMSYMBOL FROM C_UOM WHERE C_UOM_ID = l.C_AUM) AS AUMNAME, '' AS UOMPREFERENCE, '' AS HAVEUOMPREFERENCE," +
    ...
    ResultSet result;
    Vector<CreateFromShipmentData> vector = new Vector<CreateFromShipmentData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectCreateFromShipmentData.productName = UtilSql.getValue(result, "product_name");
        objectCreateFromShipmentData.mLocatorId = UtilSql.getValue(result, "m_locator_id");
        objectCreateFromShipmentData.aumqtyoi = UtilSql.getValue(result, "aumqtyoi");
        objectCreateFromShipmentData.movementqty = UtilSql.getValue(result, "movementqty");
        ...
        objectCreateFromShipmentData.aumqty = UtilSql.getValue(result, "aumqty");
        objectCreateFromShipmentData.cAum = UtilSql.getValue(result, "c_aum");
        objectCreateFromShipmentData.aumname = UtilSql.getValue(result, "aumname");
        objectCreateFromShipmentData.uompreference = UtilSql.getValue(result, "uompreference");
        objectCreateFromShipmentData.haveuompreference = UtilSql.getValue(result, "haveuompreference");
        ...
        objectCreateFromShipmentData.cDoctypeId = UtilSql.getValue(result, "c_doctype_id");
  ...
  public static CreateFromShipmentData[] selectFromPOSOTrx(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgClient, String poId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        l.AUMQTY - SUM(COALESCE(M_GET_CONVERTED_AUMQTY(l.m_product_id, l.qtydelivered, l.c_aum), 0)) AS AUMQTY, l.C_AUM AS C_AUM, " +
      "        (SELECT UOMSYMBOL FROM C_UOM WHERE C_UOM_ID = l.C_AUM) AS AUMNAME, '' AS UOMPREFERENCE" +
  ...
  public static CreateFromShipmentData[] selectFromPOSOTrxCombo(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgClient, String cBpartnerId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        AND EXISTS (" +
      "         SELECT ol.c_order_id, ol.c_orderline_id, ol.qtyordered, COALESCE(il.qty,0) qtyinvoiced, COALESCE(iol.qty,0) qtydelivered," +
      "          ol.qtyordered + COALESCE(iol.qty,0) - COALESCE(il.qty,0) qty" +
      "         FROM c_orderline ol" +
      "          JOIN sinvmin_square_bill sb ON sb.c_orderline_id = ol.c_orderline_id" +
      "          LEFT JOIN (" +
      "           SELECT c_orderline_id, SUM(qty) qty" +
      "           FROM sinvmin_square_bill" +
      "           WHERE ad_table_id = '318' AND m_inoutline_id IS NULL" +
      "           GROUP BY c_orderline_id" +
      "          ) il ON il.c_orderline_id = ol.c_orderline_id" +
      "          LEFT JOIN (" +
      "           SELECT c_orderline_id, SUM(qty) qty" +
      "           FROM sinvmin_square_bill" +
      "           WHERE ad_table_id = '319' AND c_invoiceline_id IS NULL" +
      "           GROUP BY c_orderline_id" +
      "          ) iol ON iol.c_orderline_id = ol.c_orderline_id" +
      "         WHERE sb.ad_table_id = '259' AND ol.qtyordered + COALESCE(iol.qty,0) - COALESCE(il.qty,0) > 0" +
  ...
  public static CreateFromShipmentData[] selectFromPOTrlSOTrx(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgClient, String poId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      "        SELECT o.C_ORDER_ID, Ad_Column_Identifier(TO_CHAR('C_Order'), TO_CHAR(o.c_order_id), TO_CHAR(?)) AS NAME, " +
      "        ol.qty AS QTY, l.C_UOM_ID, COALESCE(uomt.UOMSymbol, uom.UOMSymbol) AS UOMSymbol, " +
      ...
      "        l.AUMQTY - SUM(COALESCE(M_GET_CONVERTED_AUMQTY(l.m_product_id, l.qtydelivered, l.c_aum), 0)) AS AUMQTY, l.C_AUM AS C_AUM, " +
      "        (SELECT UOMSYMBOL FROM C_UOM WHERE C_UOM_ID = l.C_AUM) AS AUMNAME, '' AS UOMPREFERENCE" +
      "        FROM C_UOM uom left join C_UOM_TRL uomt on uom.C_UOM_ID = uomt.C_UOM_ID and uomt.AD_Language = ?," +
  ...
  public static CreateFromShipmentData[] selectFromPOUpdate(Connection conn, ConnectionProvider connectionProvider, String adLanguage, String cOrderlineId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT l.QtyOrdered-SUM(COALESCE(m.Qty,0)) AS ID, l.C_UOM_ID, l.AUMQTY - SUM(COALESCE(M_GET_CONVERTED_AUMQTY(l.m_product_id, m.Qty, l.c_aum), 0)) AS AUMQTY, l.C_AUM, " +
      "      uom.UOMSymbol, l.M_Product_ID,Ad_Column_Identifier(to_char('M_Product'), to_char(l.m_product_id), to_char(?)) AS NAME, l.C_OrderLine_ID," +
      ...
      "   	  coalesce(l.c_costcenter_id,o.c_costcenter_id) as c_costcenter_id," +
      "      coalesce(l.user1_id,o.user1_id) as user1_id,coalesce( l.user2_id,o.user2_id) as user2_id , " +
      "      coalesce (l.c_bpartner_id,o.c_bpartner_id) as c_bpartner_id, l.explode, 'Y' as isorder, o.C_DOCTYPE_ID AS C_DOCTYPE_ID" +
      "      FROM C_ORDERLINE l left join M_MATCHPO m on l.C_OrderLine_ID=m.C_OrderLine_ID" +
      "                                              and  m.M_InOutLine_ID IS NOT NULL " +
    ...
    strSql = strSql + 
      ...
      "      coalesce(l.a_asset_id,o.a_asset_id), coalesce(l.c_project_id, o.c_project_id), coalesce(l.c_costcenter_id,o.c_costcenter_id) ," +
      "      coalesce(l.user1_id,o.user1_id) ,coalesce( l.user2_id,o.user2_id) , coalesce (l.c_bpartner_id,o.c_bpartner_id), l.explode, o.C_DOCTYPE_ID" +
      "      ORDER BY l.Line";
  ...
  public static CreateFromShipmentData[] selectFromPOUpdateSOTrx(Connection conn, ConnectionProvider connectionProvider, String adLanguage, String cOrderlineId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT COALESCE(ol.qty,0) AS ID, l.C_UOM_ID, l.AUMQTY - SUM(COALESCE(M_GET_CONVERTED_AUMQTY(l.m_product_id, l.qtydelivered, l.c_aum), 0)) AS AUMQTY, l.C_AUM, " +
      "      uom.UOMSymbol, l.M_Product_ID,Ad_Column_Identifier(to_char('M_Product'), to_char(l.m_product_id), to_char(?)) AS NAME, " +
      "      l.C_OrderLine_ID, l.Line, '' as C_InvoiceLine_ID, '' as M_InOutLine_ID, COALESCE(uom1.BREAKDOWN, 'N') AS BREAKDOWN, " +
      "      MAX(mu.C_UOM_ID) AS C_UOM_ID_Conversion, MAX(uom1.STDPRECISION) AS STDPRECISION, " +
      "      l.QUANTITYORDER*C_DIVIDE(COALESCE(ol.qty,0),l.QtyOrdered) as quantityOrder, l.M_Product_UOM_ID," +
      "      l.M_ATTRIBUTESETINSTANCE_ID, l.ad_org_id, l.DESCRIPTION AS DESCRIPTION," +
      "      coalesce(l.a_asset_id,o.a_asset_id) as a_asset_id, coalesce(l.c_project_id, o.c_project_id) as c_project_id , " +
      "   	  coalesce(l.c_costcenter_id,o.c_costcenter_id) as c_costcenter_id," +
      "      coalesce(l.user1_id,o.user1_id) as user1_id,coalesce( l.user2_id,o.user2_id) as user2_id , " +
      "      l.c_bpartner_id, l.explode, 'Y' as isorder, o.C_DOCTYPE_ID AS C_DOCTYPE_ID" +
    ...
    strSql = strSql + 
      ...
      "      uom1.BREAKDOWN, l.QUANTITYORDER, l.M_Product_UOM_ID, l.M_ATTRIBUTESETINSTANCE_ID, l.ad_org_id, l.DESCRIPTION," +
      "      coalesce(l.a_asset_id,o.a_asset_id), coalesce(l.c_project_id, o.c_project_id), coalesce(l.c_costcenter_id,o.c_costcenter_id)," +
      "   	  coalesce(l.user1_id,o.user1_id),coalesce( l.user2_id,o.user2_id), l.c_bpartner_id, l.explode, o.C_DOCTYPE_ID," +
      "   	  ol.qty" +
      "      HAVING ((l.explode='Y') OR (COALESCE(ol.qty,0) > 0)) " +
      "      ORDER BY l.Line";
  ...
  public static CreateFromShipmentData[] selectFromInvoice(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgClient, String cInvoiceId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        l.AUMQTY - SUM(COALESCE(M_GET_CONVERTED_AUMQTY(l.m_product_id, mi.Qty, l.c_aum), 0)) AS AUMQTY, l.C_AUM AS C_AUM, " +
      "        (SELECT UOMSYMBOL FROM C_UOM WHERE C_UOM_ID = l.C_AUM) AS AUMNAME, '' AS UOMPREFERENCE, i.C_DOCTYPE_ID AS C_DOCTYPE_ID" +
    ...
    strSql = strSql + 
      ...
      "        coalesce(l.user1_id,i.user1_id) , coalesce(l.user2_id, i.user2_id), l.c_bpartner_id, l.explode, l.bom_parent_id, i.C_DOCTYPE_ID" +
  ...
  public static CreateFromShipmentData[] selectFromInvoiceTrx(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgClient, String cInvoiceId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      "        SELECT i.C_Invoice_ID, Ad_Column_Identifier(TO_CHAR('C_Invoice'), TO_CHAR(i.C_Invoice_ID), TO_CHAR(?)) AS NAME, " +
      "        mi.qty AS QTY, l.C_UOM_ID,uom.UOMSymbol," +
      "        l.M_Product_ID,Ad_Column_Identifier(TO_CHAR('M_Product'), TO_CHAR(l.m_product_id), TO_CHAR(?)) AS RELATION_NAME, " +
      ...
      "        CASE  WHEN l.Bom_parent_id is null then 'Y' else 'N' END as isparent," +
      "        l.AUMQTY - SUM(COALESCE(M_GET_CONVERTED_AUMQTY(l.m_product_id, mi.MOVEMENTQTY, l.c_aum), 0)) AS AUMQTY, l.C_AUM AS C_AUM, " +
      "        (SELECT UOMSYMBOL FROM C_UOM WHERE C_UOM_ID = l.C_AUM) AS AUMNAME, '' AS UOMPREFERENCE" +
      "        FROM C_INVOICELINE l" +
      "        LEFT JOIN (" +
      "         SELECT il.c_invoice_id, il.c_invoiceline_id, il.qtyinvoiced, COALESCE(sbiol.qty,0) movementqty," +
      "          il.qtyinvoiced + COALESCE(sbiol.qty,0) qty" +
      "         FROM c_invoiceline il" +
      "          JOIN sinvmin_square_bill sb ON sb.c_invoiceline_id = il.c_invoiceline_id" +
      "          LEFT JOIN (" +
      "           SELECT c_invoiceline_id, SUM(qty) qty" +
      "           FROM sinvmin_square_bill" +
      "           WHERE ad_table_id = '319' AND c_invoiceline_id IS NOT NULL" +
      "           GROUP BY c_invoiceline_id" +
      "          ) sbiol ON sbiol.c_invoiceline_id = il.c_invoiceline_id" +
      "         WHERE sb.ad_table_id = '318' AND il.qtyinvoiced + COALESCE(sbiol.qty,0) > 0" +
      "          AND il.c_invoiceline_id NOT IN (" +
      "           SELECT c_invoiceline_id" +
      "           FROM sinvmin_square_bill" +
      "           WHERE ad_table_id = '318' AND m_inoutline_id IS NOT NULL" +
      "          )" +
      "        ) mi ON mi.c_invoiceline_id = l.c_invoiceline_id," +
      "        C_INVOICE i, C_UOM uom,  M_PRODUCT p" +
      "        WHERE i.C_INVOICE_ID = l.C_INVOICE_ID " +
      "        AND i.DocStatus IN ('CL','CO')" +
      "        AND i.AD_Client_ID IN (";
    ...
    strSql = strSql + 
      ...
      "		mi.qty" +
      "        HAVING ((l.explode='Y')  OR (mi.qty > 0))  " +
      "        ORDER BY NAME, l.Line";
  ...
  public static CreateFromShipmentData[] selectFromInvoiceTrxCombo(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgClient, String cBpartnerId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        AND dt.isreturn = 'N'" +
      "        AND EXISTS (" +
      "         SELECT il.c_invoice_id, il.c_invoiceline_id, il.qtyinvoiced, COALESCE(sbiol.qty,0) qtydelivered," +
      "          il.qtyinvoiced + COALESCE(sbiol.qty,0) qty" +
      "         FROM c_invoiceline il" +
      "          JOIN sinvmin_square_bill sb ON sb.c_invoiceline_id = il.c_invoiceline_id" +
      "          LEFT JOIN (" +
  ...
  public static CreateFromShipmentData[] selectFromInvoiceUpdate(Connection conn, ConnectionProvider connectionProvider, String adLanguage, String cInvoicelineId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "      coalesce(l.a_asset_id,i.a_asset_id), coalesce(l.c_project_id, i.c_project_id), coalesce(l.c_costcenter_id,i.c_costcenter_id), " +
      "      coalesce(l.user1_id,i.user1_id ), coalesce(l.user2_id , i.user2_id),l.c_bpartner_id, l.explode, i.c_doctype_id" +
      "      HAVING ((l.explode='Y')  OR (l.QtyInvoiced-SUM(COALESCE(mi.Qty,0))<>0))   " +
      "      ORDER BY l.Line";
  ...
  public static CreateFromShipmentData[] selectFromInvoiceTrxUpdate(Connection conn, ConnectionProvider connectionProvider, String adLanguage, String cInvoicelineId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT mi.qty AS ID, l.C_UOM_ID,uom.UOMSymbol," +
  ...
  public static CreateFromShipmentData[] set()    throws ServletException {
    ...
    objectCreateFromShipmentData[0].aumqty = "";
    objectCreateFromShipmentData[0].cAum = "";
    objectCreateFromShipmentData[0].aumname = "";
    objectCreateFromShipmentData[0].uompreference = "";
    return objectCreateFromShipmentData;
  }
  ...
  public static int insert(Connection conn, ConnectionProvider connectionProvider, String mInoutlineId, String mInoutId, String adClientId, String adOrgId, String adUserId, String description, String mProductId, String cUomId, String tp, String aumqty, String cAum, String cOrderlineId, String mLocatorId, String isinvoiced, String quantityorder, String mProductUomId, String mAttributesetinstanceId, String aAssetId, String cProjectId, String cCostcenterId, String user1Id, String user2Id, String cBpartnerId, String explode, String isOrder)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, tp);
 ...
 */
  ...
  public static String countOrders(Connection conn, ConnectionProvider connectionProvider, String mInoutId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int deleteFromShipmentDuplicateLines(Connection conn, ConnectionProvider connectionProvider, String mInoutId, String mProductId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static CreateFromShipmentData[] selectOrderInout(ConnectionProvider connectionProvider, String poId, String poLineId)    throws ServletException {
    return selectOrderInout(connectionProvider, poId, poLineId, 0, 0);
  }

  public static CreateFromShipmentData[] selectOrderInout(ConnectionProvider connectionProvider, String poId, String poLineId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "	    co.c_doctype_id, " +
      "	    ma.em_cslj_priority, " +
      "	    ma.em_cslj_juliandate, " +
      "	    ma.em_scplag_iselaborationdate, " +
      "	    mas.m_attributesetinstance_id AS atributo, " +
      "	    mas.em_cslj_datejulian AS description, " +
      "	    msd.qtyonhand as qtyonhand, " +
      "	    col.qtyordered-coalesce(QtyDelivered,0) AS aumqty, " +
      "	    CASE   " +
      "	      WHEN ma.em_cslj_priority = 'ED' " +
      "	       AND ma.em_scplag_iselaborationdate = 'Y' " +
      "	      THEN TO_DATE(split_part(mas.description, '_', 2), 'DD-MM-YYYY') " +
      "	      ELSE NULL " +
      "	    END AS elaboration_date, " +
      "		ml.m_locator_id," +
      "	    mp.name as product_name" +
      "	  FROM c_order co " +
      "	  JOIN c_orderline col ON col.c_order_id = co.c_order_id " +
      "	  JOIN m_product mp ON mp.m_product_id = col.m_product_id " +
      "	  JOIN m_attributeset ma ON ma.m_attributeset_id = mp.m_attributeset_id " +
      "	  JOIN m_storage_detail msd ON msd.m_product_id = mp.m_product_id " +
      "	  JOIN m_attributesetinstance mas ON mas.m_attributesetinstance_id = msd.m_attributesetinstance_id " +
      "	  JOIN m_warehouse mw ON mw.m_warehouse_id = co.m_warehouse_id " +
      "	  JOIN m_locator ml ON ml.m_warehouse_id = mw.m_warehouse_id " +
      "	    AND msd.m_locator_id = ml.m_locator_id " +
      "	  WHERE co.c_order_id =? and col.c_orderline_id=?" +
      "	    AND msd.qtyonhand <> 0 " +
      "	), " +
      "	ordered_jd AS ( " +
      "	  SELECT *, " +
      "		 ROW_NUMBER() OVER (PARTITION BY c_orderline_id ORDER BY description ASC) AS pos " +
      "	  FROM base " +
      "	  WHERE em_cslj_priority = 'JD' " +
      "	    AND em_cslj_juliandate = 'Y' " +
      "	), " +
      "	recursive_jd AS ( " +
      "	  SELECT " +
      "	    product_name,m_locator_id,c_order_id, c_orderline_id, c_uom_id, m_product_id, pos, " +
      "	    name, value, documentno, ad_org_id, c_costcenter_id, user1_id, " +
      "	    c_bpartner_id, c_doctype_id, em_cslj_priority, em_cslj_juliandate, " +
      "	    em_scplag_iselaborationdate, atributo, description, qtyonhand, aumqty, " +
      "	    CASE WHEN qtyonhand >= aumqty THEN qtyonhand - aumqty ELSE 0 END AS new_qtyonhand, " +
      "	    CASE WHEN qtyonhand >= aumqty THEN 0 ELSE aumqty - qtyonhand END AS remaining_aumqty " +
      "	  FROM ordered_jd " +
      "	  WHERE pos = 1 " +
      "	  UNION ALL " +
      "	  SELECT " +
      "	    o.product_name,o.m_locator_id,o.c_order_id, o.c_orderline_id, o.c_uom_id, o.m_product_id, o.pos, " +
      "	    o.name, o.value, o.documentno, o.ad_org_id, o.c_costcenter_id, o.user1_id, " +
      "	    o.c_bpartner_id, o.c_doctype_id, o.em_cslj_priority, o.em_cslj_juliandate, " +
      "	    o.em_scplag_iselaborationdate, o.atributo, o.description, o.qtyonhand, " +
      "	    r.remaining_aumqty AS aumqty, " +
      "	    CASE " +
      "	      WHEN r.remaining_aumqty = 0 THEN o.qtyonhand " +
      "	      WHEN o.qtyonhand >= r.remaining_aumqty THEN o.qtyonhand - r.remaining_aumqty " +
      "	      ELSE 0 END AS new_qtyonhand, " +
      "	    CASE " +
      "	      WHEN r.remaining_aumqty = 0 THEN 0 " +
      "	      WHEN o.qtyonhand >= r.remaining_aumqty THEN 0 " +
      "	      ELSE r.remaining_aumqty - o.qtyonhand END AS remaining_aumqty " +
      "	  FROM ordered_jd o " +
      "	  JOIN recursive_jd r ON o.c_orderline_id = r.c_orderline_id AND o.pos = r.pos + 1 " +
      "	), " +
      "	ordered_ed AS ( " +
      "	  SELECT *, " +
      "		 ROW_NUMBER() OVER (PARTITION BY c_orderline_id ORDER BY ABS(CURRENT_DATE - elaboration_date) ASC) AS pos " +
      "	  FROM base " +
      "	  WHERE em_cslj_priority = 'ED' " +
      "	    AND em_scplag_iselaborationdate = 'Y' " +
      "	    AND elaboration_date IS NOT NULL " +
      "	), " +
      "	recursive_ed AS ( " +
      "	  SELECT " +
      "	    product_name,m_locator_id,c_order_id, c_orderline_id, c_uom_id, m_product_id, pos, " +
      ...
      "	      ELSE r.remaining_aumqty - o.qtyonhand END AS remaining_aumqty " +
      "	  FROM ordered_ed o " +
      "	  JOIN recursive_ed r ON o.c_orderline_id = r.c_orderline_id AND o.pos = r.pos + 1 " +
      "	), " +
      "	unioned AS ( " +
      "	  SELECT * FROM recursive_jd " +
      "	  UNION ALL " +
      "	  SELECT * FROM recursive_ed " +
      "	) " +
      "	SELECT " +
      "	  c_order_id, " +
      "	  ROUND(qtyonhand - new_qtyonhand, 2) AS movementqty,  " +
      "	  Ad_Column_Identifier(TO_CHAR('C_Order'), TO_CHAR(c_order_id), TO_CHAR('Y')) AS name, " +
      "	  c_uom_id, " +
      "	  'kg' AS uomsymbol, " +
      "	  m_product_id, " +
      "	  Ad_Column_Identifier(TO_CHAR('M_Product'), TO_CHAR(m_product_id), TO_CHAR('Y')) AS relation_name, " +
      "	  ROW_NUMBER() OVER (ORDER BY c_orderline_id, pos) AS line, " +
      "	  c_orderline_id, " +
      "	  'nuevo' AS description, " +
      "	  aumqty as aumqtyOI, " +
      "	  NULL AS c_aum, " +
      "	  NULL AS aumname, " +
      "	  '' AS uompreference, " +
      ...
      "	  '' AS c_invoiceline_id, " +
      "	  '' AS breakdown, " +
      "	  NULL AS c_uom_id_conversion, " +
      "	  NULL AS stdprecision, " +
      "	  NULL AS quantityorder, " +
      "	  NULL AS m_product_uom_id, " +
      "	  atributo AS m_attributesetinstance_id, " +
      "	  ad_org_id, " +
      "	  NULL AS a_asset_id, " +
      ...
      "	  product_name " +
      "	  FROM unioned " +
      "	  WHERE qtyonhand <> new_qtyonhand " +
      "	  ORDER BY c_orderline_id, pos;  ";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, poId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, poLineId);
