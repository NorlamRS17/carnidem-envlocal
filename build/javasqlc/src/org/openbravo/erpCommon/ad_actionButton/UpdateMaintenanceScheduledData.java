...
static Logger log4j = Logger.getLogger(UpdateMaintenanceScheduledData.class);
  ...
  public String emScmaStartPeriodicity;
  public String emScmaEndPeriodicity;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_scma_start_periodicity") || fieldName.equals("emScmaStartPeriodicity"))
      return emScmaStartPeriodicity;
    else if (fieldName.equalsIgnoreCase("em_scma_end_periodicity") || fieldName.equals("emScmaEndPeriodicity"))
      return emScmaEndPeriodicity;
   else {
  ...
  public static UpdateMaintenanceScheduledData[] select(ConnectionProvider connectionProvider, String language, String scheduleddateFrom, String scheduleddateTo, String maintenancetype, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT MA_Maint_Scheduled_ID, AD_COLUMN_IDENTIFIER(TO_CHAR('MA_Maint_Scheduled'), TO_CHAR(MA_Maint_Scheduled_ID), TO_CHAR(?)) AS maintscheduled, scheduledDate,TO_CHAR(em_scma_start_periodicity, 'HH24:MI:SS') as em_scma_start_periodicity,TO_CHAR(em_scma_end_periodicity, 'HH24:MI:SS') as em_scma_end_periodicity" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectUpdateMaintenanceScheduledData.emScmaStartPeriodicity = UtilSql.getValue(result, "em_scma_start_periodicity");
        objectUpdateMaintenanceScheduledData.emScmaEndPeriodicity = UtilSql.getValue(result, "em_scma_end_periodicity");
