...
class SLResupplyLineConversionData implements FieldProvider {
static Logger log4j = Logger.getLogger(SLResupplyLineConversionData.class);
  ...
  public static SLResupplyLineConversionData[] select(ConnectionProvider connectionProvider)    throws ServletException {
    return select(connectionProvider, 0, 0);
  }

  public static SLResupplyLineConversionData[] select(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT * FROM DUAL";

    ResultSet result;
    Vector<SLResupplyLineConversionData> vector = new Vector<SLResupplyLineConversionData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        SLResupplyLineConversionData objectSLResupplyLineConversionData = new SLResupplyLineConversionData();
        objectSLResupplyLineConversionData.dummy = UtilSql.getValue(result, "dummy");
        objectSLResupplyLineConversionData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectSLResupplyLineConversionData);
    ...
    SLResupplyLineConversionData objectSLResupplyLineConversionData[] = new SLResupplyLineConversionData[vector.size()];
    vector.copyInto(objectSLResupplyLineConversionData);
    return(objectSLResupplyLineConversionData);
  }
