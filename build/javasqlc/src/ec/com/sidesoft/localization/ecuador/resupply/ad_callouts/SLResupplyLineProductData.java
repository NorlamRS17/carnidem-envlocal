...
class SLResupplyLineProductData implements FieldProvider {
static Logger log4j = Logger.getLogger(SLResupplyLineProductData.class);
  ...
  public static SLResupplyLineProductData[] select(ConnectionProvider connectionProvider)    throws ServletException {
    return select(connectionProvider, 0, 0);
  }

  public static SLResupplyLineProductData[] select(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT '' AS pricelist_version, '' AS pricelist, '' AS pricelimit, '' AS pricestd  FROM DUAL";

    ResultSet result;
    Vector<SLResupplyLineProductData> vector = new Vector<SLResupplyLineProductData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        SLResupplyLineProductData objectSLResupplyLineProductData = new SLResupplyLineProductData();
        objectSLResupplyLineProductData.pricelistVersion = UtilSql.getValue(result, "pricelist_version");
        objectSLResupplyLineProductData.pricelist = UtilSql.getValue(result, "pricelist");
        objectSLResupplyLineProductData.pricelimit = UtilSql.getValue(result, "pricelimit");
        objectSLResupplyLineProductData.pricestd = UtilSql.getValue(result, "pricestd");
        objectSLResupplyLineProductData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectSLResupplyLineProductData);
    ...
    SLResupplyLineProductData objectSLResupplyLineProductData[] = new SLResupplyLineProductData[vector.size()];
    vector.copyInto(objectSLResupplyLineProductData);
    return(objectSLResupplyLineProductData);
  }
  ...
  public static SLResupplyLineProductData[] getPrices(ConnectionProvider connectionProvider, String mProductId, String mPriceListVersionId)    throws ServletException {
    return getPrices(connectionProvider, mProductId, mPriceListVersionId, 0, 0);
  }

  public static SLResupplyLineProductData[] getPrices(ConnectionProvider connectionProvider, String mProductId, String mPriceListVersionId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
