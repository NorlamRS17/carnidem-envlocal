...
class SSFCOrderBPartnerData implements FieldProvider {
static Logger log4j = Logger.getLogger(SSFCOrderBPartnerData.class);
  ...
  public static SSFCOrderBPartnerData[] select(ConnectionProvider connectionProvider, String cBpartnerId)    throws ServletException {
    return select(connectionProvider, cBpartnerId, 0, 0);
  }

  public static SSFCOrderBPartnerData[] select(ConnectionProvider connectionProvider, String cBpartnerId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    ResultSet result;
    Vector<SSFCOrderBPartnerData> vector = new Vector<SSFCOrderBPartnerData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        SSFCOrderBPartnerData objectSSFCOrderBPartnerData = new SSFCOrderBPartnerData();
        objectSSFCOrderBPartnerData.cPaymenttermId = UtilSql.getValue(result, "c_paymentterm_id");
        objectSSFCOrderBPartnerData.mPricelistId = UtilSql.getValue(result, "m_pricelist_id");
        objectSSFCOrderBPartnerData.paymentrule = UtilSql.getValue(result, "paymentrule");
        objectSSFCOrderBPartnerData.poreference = UtilSql.getValue(result, "poreference");
        objectSSFCOrderBPartnerData.soDescription = UtilSql.getValue(result, "so_description");
        objectSSFCOrderBPartnerData.isdiscountprinted = UtilSql.getValue(result, "isdiscountprinted");
        objectSSFCOrderBPartnerData.invoicerule = UtilSql.getValue(result, "invoicerule");
        objectSSFCOrderBPartnerData.deliveryrule = UtilSql.getValue(result, "deliveryrule");
        objectSSFCOrderBPartnerData.deliveryviarule = UtilSql.getValue(result, "deliveryviarule");
        objectSSFCOrderBPartnerData.creditavailable = UtilSql.getValue(result, "creditavailable");
        objectSSFCOrderBPartnerData.poPricelistId = UtilSql.getValue(result, "po_pricelist_id");
        objectSSFCOrderBPartnerData.paymentrulepo = UtilSql.getValue(result, "paymentrulepo");
        objectSSFCOrderBPartnerData.poPaymenttermId = UtilSql.getValue(result, "po_paymentterm_id");
        objectSSFCOrderBPartnerData.salesrepId = UtilSql.getValue(result, "salesrep_id");
        objectSSFCOrderBPartnerData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectSSFCOrderBPartnerData);
    ...
    SSFCOrderBPartnerData objectSSFCOrderBPartnerData[] = new SSFCOrderBPartnerData[vector.size()];
    vector.copyInto(objectSSFCOrderBPartnerData);
    return(objectSSFCOrderBPartnerData);
  }
  ...
  public static String mWarehouSSFCOnhand(ConnectionProvider connectionProvider, String adOrgId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
