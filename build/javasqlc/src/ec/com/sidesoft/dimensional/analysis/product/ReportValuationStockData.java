...
static Logger log4j = Logger.getLogger(ReportValuationStockData.class);
  ...
  public static ReportValuationStockData[] select(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String costOrg, String costClient, String costType, String warehouseDimension, String categoryProduct, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "               '' as ID, '' as PADRE , '' AS NAME, '' AS BNAME, '' AS MNAME" +
      "        FROM (SELECT M_PRODUCT_CATEGORY.NAME AS CATEGORY_NAME, A.M_PRODUCT_ID, " +
      "		( AD_COLUMN_IDENTIFIER (to_char('M_Product'),to_char(M_PRODUCT.M_PRODUCT_ID),to_char(?)) || to_char(' (' || COALESCE( M_Brand.name,'')|| ' - ' || COALESCE (Ssfi_Model_Prod.NAME,'') || ') '))  AS PRODUCT_NAME, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReportValuationStockData.bname = UtilSql.getValue(result, "bname");
        objectReportValuationStockData.mname = UtilSql.getValue(result, "mname");
  ...
  public static ReportValuationStockData[] selectClusteredByWarehouse(ConnectionProvider connectionProvider, String adLanguage, String datePlus, String legalEntity, String cCurrencyConv, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, String costOrg, String costClient, String costType, String warehouseDimension, String filterOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "     (AD_COLUMN_IDENTIFIER (to_char('M_Product'),to_char(zz.M_PRODUCT_ID),to_char(?))|| to_char(' (' || COALESCE( zz.bname,'')|| ' - ' || COALESCE (zz.mname,'') || ') ')) AS PRODUCT_NAME," +
      ...
      "		Ssfi_Model_Prod.NAME as mname" +
      "    FROM M_PRODUCT_CATEGORY pc" +
      "      JOIN M_PRODUCT p ON pc.m_product_category_id = p.m_product_category_id" +
      "      left join Ssfi_Model_Prod on Ssfi_Model_Prod.Ssfi_Model_Prod_ID = p.em_Ssfi_Model_Prod_ID" +
      "	  left join M_Brand on M_Brand.M_Brand_ID = Ssfi_Model_Prod.M_Brand_ID	  " +
      "      JOIN (" +
    ...
    strSql = strSql + 
      ...
      "  GROUP BY a.M_PRODUCT_ID, pc.NAME, p.VALUE, a.c_uom_id, M_Brand.name, Ssfi_Model_Prod.NAME" +
      "  HAVING SUM(A.QTY) <>0" +
      "  ) ZZ" +
    ...
    strSql = strSql + 
      ...
      "  SELECT pc.name AS category_name," +
      "      stock.m_product_id," +
      "      ( AD_COLUMN_IDENTIFIER (to_char('M_Product'),to_char(stock.M_PRODUCT_ID),to_char(?)) || to_char(' (' || COALESCE( M_Brand.name,'')|| ' - ' || COALESCE (Ssfi_Model_Prod.NAME,'') || ') ')) AS PRODUCT_NAME," +
    ...
    strSql = strSql + ((categoryProduct==null || categoryProduct.equals(""))?"":"  AND p.M_PRODUCT_CATEGORY_ID= ?  ");
    strSql = strSql + 
      "      GROUP BY p.m_product_id, p.value, p.m_product_category_id, trx.c_uom_id, p.em_Ssfi_Model_Prod_ID" +
      "      HAVING sum(trx.movementqty) <> 0" +
      "    ) stock ON pc.m_product_category_id = stock.m_product_category_id" +
      "	 left join Ssfi_Model_Prod on Ssfi_Model_Prod.Ssfi_Model_Prod_ID = stock.em_Ssfi_Model_Prod_ID" +
      "     left join M_Brand on M_Brand.M_Brand_ID = Ssfi_Model_Prod.M_Brand_ID" +
  ...
  public static ReportValuationStockData[] selectXLS(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String costOrg, String costClient, String costType, String warehouseDimension, String categoryProduct)    throws ServletException {
    return selectXLS(connectionProvider, adLanguage, cCurrencyConv, legalEntity, datePlus, maxaggDate, processTime, dateTimeFormat, organization, warehouse, costOrg, costClient, costType, warehouseDimension, categoryProduct, 0, 0);
  }
  ...
  public static ReportValuationStockData[] selectXLS(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String costOrg, String costClient, String costType, String warehouseDimension, String categoryProduct, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SELECT CATEGORY_NAME, M_PRODUCT_ID, PRODUCT_NAME, PRODUCT_SEARCHKEY, SUM(QTY) AS QTY, UOM_NAME, CASE ISCOSTCALCULATED" +
      "                       WHEN 'Y' THEN " +
      "                       CASE WHEN SUM(QTY) > 0 THEN  SUM(TOTAL_COST) / SUM(QTY) " +
      "						ELSE " +
      "						SUM(TOTAL_COST) " +
      "						END " +
      "                       ELSE NULL" +
      ...
      "               SUM(QTY) * COSTTYPE as VALUATION_TYPE," +
      "               ZZ.WAREHOUSE as WAREHOUSE," +
      "               '' as ID, '' as PADRE , '' AS NAME, BNAME, MNAME" +
      "        FROM (SELECT M_PRODUCT_CATEGORY.NAME AS CATEGORY_NAME, A.M_PRODUCT_ID, " +
      "		( AD_COLUMN_IDENTIFIER (to_char('M_Product'),to_char(M_PRODUCT.M_PRODUCT_ID),to_char(?)) )  AS PRODUCT_NAME, " +
      "              M_PRODUCT.VALUE AS PRODUCT_SEARCHKEY, A.QTY, C_UOM.NAME AS UOM_NAME," +
      "                     CASE a.iscostcalculated" +
      "                       WHEN 'Y' THEN C_CURRENCY_CONVERT_PRECISION (Suma,A.c_currency_id,?,A.MOVEMENTDATE,NULL,A.AD_CLIENT_ID,?,'C')" +
      "                       ELSE NULL" +
      ...
      "                       WHEN 'Y' THEN C_CURRENCY_CONVERT_PRECISION (P.COST,P.c_currency_id,?,to_date(?),NULL,A.AD_CLIENT_ID,?,'C')" +
      "                       ELSE NULL" +
      "                     END AS COSTTYPE, A.WAREHOUSE AS WAREHOUSE,COALESCE( M_Brand.name,'') AS BNAME,(COALESCE (Ssfi_Model_Prod.VALUE,'') || ' ' || COALESCE(Ssfi_Model_Prod.NAME,'')) AS MNAME" +
      "              FROM M_PRODUCT_CATEGORY," +
      "                   (SELECT trx.M_PRODUCT_ID, sum(trx.MOVEMENTQTY) AS QTY, sum(CASE WHEN trx.MOVEMENTQTY < 0 THEN- tc.trxcost ELSE tc.trxcost END) AS Suma, " +
      "                   trx.C_UOM_ID, trx.AD_CLIENT_ID, trx.iscostcalculated, tc.c_currency_id, trx.movementdate, WH.NAME AS WAREHOUSE, WH.M_WAREHOUSE_ID " +
      "                    FROM M_TRANSACTION trx " +
    ...
    strSql = strSql + 
      ") ZZ" +
      "        GROUP BY ZZ.M_PRODUCT_ID, CATEGORY_NAME, ZZ.WAREHOUSE, PRODUCT_NAME, PRODUCT_SEARCHKEY, UOM_NAME, ISCOSTCALCULATED, COSTTYPE, BNAME, MNAME" +
      "        HAVING SUM(QTY) <> 0" +
      "        ORDER BY WAREHOUSE, CATEGORY_NAME, PRODUCT_NAME ) script" +
      "        WHERE (qty > 0 AND COST_TYPE >= 0)  " +
      "    	OR (qty = 0 AND COST_TYPE > 0) ";
  ...
  public static ReportValuationStockData[] selectWithoutCostXSL(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct)    throws ServletException {
    return selectWithoutCostXSL(connectionProvider, adLanguage, cCurrencyConv, legalEntity, datePlus, maxaggDate, processTime, dateTimeFormat, organization, warehouse, categoryProduct, 0, 0);
  }
  ...
  public static ReportValuationStockData[] selectWithoutCostXSL(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "                     END AS AVERAGE_COST," +
      "               SUM(TOTAL_COST) AS TOTAL_COST," +
      "               ZZ.WAREHOUSE as WAREHOUSE, BNAME, MNAME" +
      "        FROM (SELECT M_PRODUCT_CATEGORY.NAME AS CATEGORY_NAME, A.M_PRODUCT_ID, " +
      "		(AD_COLUMN_IDENTIFIER (to_char('M_Product'),to_char(M_PRODUCT.M_PRODUCT_ID),to_char(?))) AS PRODUCT_NAME, " +
      "              M_PRODUCT.VALUE AS PRODUCT_SEARCHKEY, A.QTY, C_UOM.NAME AS UOM_NAME," +
      "                     CASE a.iscostcalculated" +
      ...
      "                       ELSE NULL" +
      "                     END AS TOTAL_COST,  A.ISCOSTCALCULATED, A.AD_CLIENT_ID, A.MOVEMENTDATE, A.C_CURRENCY_ID, A.WAREHOUSE AS WAREHOUSE," +
      "					 COALESCE( M_Brand.name,'') AS BNAME,(COALESCE (Ssfi_Model_Prod.VALUE,'') || ' ' || COALESCE(Ssfi_Model_Prod.NAME,'')) AS MNAME" +
      "              FROM M_PRODUCT_CATEGORY," +
      "                   (SELECT trx.M_PRODUCT_ID, sum(trx.MOVEMENTQTY) AS QTY, sum(CASE WHEN trx.MOVEMENTQTY < 0 THEN- tc.trxcost ELSE tc.trxcost END) AS Suma, " +
      "                   trx.C_UOM_ID, trx.AD_CLIENT_ID, trx.iscostcalculated, tc.c_currency_id, trx.movementdate, WH.NAME AS WAREHOUSE" +
      "                    FROM M_TRANSACTION trx " +
    ...
    strSql = strSql + 
      "              AND   (A.QTY <> 0 OR A.Suma <> 0)) ZZ" +
      "        GROUP BY ZZ.M_PRODUCT_ID, CATEGORY_NAME, ZZ.WAREHOUSE, PRODUCT_NAME, PRODUCT_SEARCHKEY, UOM_NAME, ISCOSTCALCULATED, BNAME, MNAME" +
      "        HAVING SUM(QTY) <> 0" +
      "        ORDER BY WAREHOUSE, CATEGORY_NAME, PRODUCT_NAME";
  ...
  public static ReportValuationStockData[] selectClusteredByWarehouseWithoutCostXLS(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct)    throws ServletException {
    return selectClusteredByWarehouseWithoutCostXLS(connectionProvider, adLanguage, cCurrencyConv, legalEntity, datePlus, maxaggDate, processTime, dateTimeFormat, organization, warehouse, categoryProduct, 0, 0);
  }
  ...
  public static ReportValuationStockData[] selectClusteredByWarehouseWithoutCostXLS(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "		(COALESCE (Ssfi_Model_Prod.VALUE,'') || ' ' || COALESCE(Ssfi_Model_Prod.NAME,'')) AS MNAME" +
      "    FROM M_PRODUCT_CATEGORY pc" +
      "      JOIN M_PRODUCT p ON pc.m_product_category_id = p.m_product_category_id" +
      "	  left join Ssfi_Model_Prod on Ssfi_Model_Prod.Ssfi_Model_Prod_ID = p.em_Ssfi_Model_Prod_ID" +
      "	  left join M_Brand on M_Brand.M_Brand_ID = Ssfi_Model_Prod.M_Brand_ID" +
    ...
    strSql = strSql + 
      "      AND (A.QTY <> 0 OR A.Suma <> 0)" +
      "  GROUP BY a.M_PRODUCT_ID, pc.NAME, p.VALUE, a.c_uom_id, M_Brand.NAME, Ssfi_Model_Prod.NAME, Ssfi_Model_Prod.VALUE" +
      "  HAVING SUM(A.QTY) <>0" +
      "  ) ZZ" +
      "    JOIN C_UOM ON c_uom.c_uom_id = zz.c_uom_id" +
      "    JOIN c_currency ON c_currency.c_currency_id = ?" +
  ...
  public static ReportValuationStockData[] selectClusteredByWarehouseXLS(ConnectionProvider connectionProvider, String adLanguage, String datePlus, String legalEntity, String cCurrencyConv, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, String costOrg, String costClient, String costType, String warehouseDimension, String filterOrgId)    throws ServletException {
    return selectClusteredByWarehouseXLS(connectionProvider, adLanguage, datePlus, legalEntity, cCurrencyConv, maxaggDate, processTime, dateTimeFormat, organization, warehouse, categoryProduct, costOrg, costClient, costType, warehouseDimension, filterOrgId, 0, 0);
  }
  ...
  public static ReportValuationStockData[] selectClusteredByWarehouseXLS(ConnectionProvider connectionProvider, String adLanguage, String datePlus, String legalEntity, String cCurrencyConv, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, String costOrg, String costClient, String costType, String warehouseDimension, String filterOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "     (AD_COLUMN_IDENTIFIER (to_char('M_Product'),to_char(zz.M_PRODUCT_ID),to_char(?))) AS PRODUCT_NAME," +
      "     PRODUCT_SEARCHKEY, zz.QTY AS QTY, C_UOM.NAME AS UOM_NAME, " +
      "     CASE WHEN zz.QTY > 0 THEN " +
      "     ROUND(TOTAL_COST / zz.QTY, c_currency.costingprecision) " +
      "     ELSE " +
      "     ROUND(TOTAL_COST , c_currency.costingprecision) " +
      "     END AS AVERAGE_COST, " +
      "     TOTAL_COST AS TOTAL_COST," +
      "     C_CURRENCY_CONVERT_PRECISION (c.COST,c.c_currency_id, c_currency.c_currency_id,to_date(?),NULL,c.AD_CLIENT_ID,?,'C') AS COST_TYPE," +
      "     ROUND(zz.QTY *  C_CURRENCY_CONVERT_PRECISION (c.COST,c.c_currency_id, c_currency.c_currency_id,to_date(?),NULL,c.AD_CLIENT_ID,?,'C'), c_currency.stdprecision) as VALUATION_TYPE," +
    ...
    strSql = strSql + ((categoryProduct==null || categoryProduct.equals(""))?"":"  AND pc.M_PRODUCT_CATEGORY_ID= ?  ");
    strSql = strSql + 
      "  ORDER BY CATEGORY_NAME, PRODUCT_NAME ) script " +
      "  WHERE (qty > 0 AND COST_TYPE >= 0)  " +
      "  OR (qty = 0 AND COST_TYPE > 0) ";
