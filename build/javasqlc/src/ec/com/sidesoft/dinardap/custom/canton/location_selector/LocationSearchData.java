...
static Logger log4j = Logger.getLogger(LocationSearchData.class);
  ...
  public String emSdinccCantonId;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("c_location_id") || fieldName.equals("cLocationId"))
      ...
      return cRegionId;
    else if (fieldName.equalsIgnoreCase("em_sdincc_canton_id") || fieldName.equals("emSdinccCantonId"))
      return emSdinccCantonId;
  ...
  public static LocationSearchData[] select(ConnectionProvider connectionProvider, String language, String cLocationId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        L.em_sdincc_canton_id, ca.name AS canton," +
      ...
      "            LEFT JOIN secpm_canton AS ca ON ca.secpm_canton_id=L.em_sdincc_canton_id," +
      "             C_COUNTRY C " +
    ...
    ResultSet result;
    Vector<LocationSearchData> vector = new Vector<LocationSearchData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLocationSearchData.emSdinccCantonId = UtilSql.getValue(result, "em_sdincc_canton_id");
        objectLocationSearchData.canton = UtilSql.getValue(result, "canton");
  ...
  public static LocationSearchData[] set(String cCountryId)    throws ServletException {
    ...
    objectLocationSearchData[0].emSdinccCantonId = "";
    objectLocationSearchData[0].canton = "";
  ...
  public int update(ConnectionProvider connectionProvider)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      UPDATE C_LOCATION SET UPDATED = now(), UPDATEDBY = ?, ADDRESS1 = ?, ADDRESS2 = ?, CITY = ?, POSTAL = ?, C_COUNTRY_ID = ?, C_REGION_ID = ?, em_sdincc_canton_id = ?" +
      "      WHERE C_LOCATION_ID = ?";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emSdinccCantonId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cLocationId);
  ...
  public int insert(ConnectionProvider connectionProvider)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      INSERT INTO C_LOCATION (C_LOCATION_ID, AD_CLIENT_ID, AD_ORG_ID, ISACTIVE, CREATED, CREATEDBY, UPDATED, UPDATEDBY, ADDRESS1, ADDRESS2, CITY, POSTAL, C_COUNTRY_ID, C_REGION_ID, em_sdincc_canton_id) VALUES (?, ?, ?, 'Y', now(), ?, now(), ?, ?, ?, ?, ?, ?, ?, ?)";
