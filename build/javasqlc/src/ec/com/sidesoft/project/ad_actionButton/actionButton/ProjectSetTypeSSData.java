...
package ec.com.sidesoft.project.ad_actionButton.actionButton;
...
class ProjectSetTypeSSData implements FieldProvider {
static Logger log4j = Logger.getLogger(ProjectSetTypeSSData.class);
  ...
  public String emSsprjIsreturnmo;
  public String emSsprjIsgoingmo;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("c_phase_id") || fieldName.equals("cPhaseId"))
      ...
      return datecontract;
    else if (fieldName.equalsIgnoreCase("em_ssprj_isreturnmo") || fieldName.equals("emSsprjIsreturnmo"))
      return emSsprjIsreturnmo;
    else if (fieldName.equalsIgnoreCase("em_ssprj_isgoingmo") || fieldName.equals("emSsprjIsgoingmo"))
      return emSsprjIsgoingmo;
   else {
  ...
  public static ProjectSetTypeSSData[] select(ConnectionProvider connectionProvider, String c_projecttype_id)    throws ServletException {
    return select(connectionProvider, c_projecttype_id, 0, 0);
  }

  public static ProjectSetTypeSSData[] select(ConnectionProvider connectionProvider, String c_projecttype_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        , '' as EM_Ssprj_Isreturnmo, '' as EM_Ssprj_Isgoingmo" +
      "        FROM C_PHASE P WHERE C_PROJECTTYPE_ID = ?" +
      "        ORDER BY P.SEQNO";

    ResultSet result;
    Vector<ProjectSetTypeSSData> vector = new Vector<ProjectSetTypeSSData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        ProjectSetTypeSSData objectProjectSetTypeSSData = new ProjectSetTypeSSData();
        objectProjectSetTypeSSData.cPhaseId = UtilSql.getValue(result, "c_phase_id");
        objectProjectSetTypeSSData.name = UtilSql.getValue(result, "name");
        objectProjectSetTypeSSData.seqno = UtilSql.getValue(result, "seqno");
        objectProjectSetTypeSSData.description = UtilSql.getValue(result, "description");
        objectProjectSetTypeSSData.help = UtilSql.getValue(result, "help");
        objectProjectSetTypeSSData.mProductId = UtilSql.getValue(result, "m_product_id");
        objectProjectSetTypeSSData.standardqty = UtilSql.getValue(result, "standardqty");
        objectProjectSetTypeSSData.stdduration = UtilSql.getValue(result, "stdduration");
        objectProjectSetTypeSSData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectProjectSetTypeSSData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectProjectSetTypeSSData.cTaskId = UtilSql.getValue(result, "c_task_id");
        objectProjectSetTypeSSData.cProjectId = UtilSql.getValue(result, "c_project_id");
        objectProjectSetTypeSSData.startdate = UtilSql.getValue(result, "startdate");
        objectProjectSetTypeSSData.datecontract = UtilSql.getValue(result, "datecontract");
        objectProjectSetTypeSSData.emSsprjIsreturnmo = UtilSql.getValue(result, "em_ssprj_isreturnmo");
        objectProjectSetTypeSSData.emSsprjIsgoingmo = UtilSql.getValue(result, "em_ssprj_isgoingmo");
        objectProjectSetTypeSSData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectProjectSetTypeSSData);
    ...
    ProjectSetTypeSSData objectProjectSetTypeSSData[] = new ProjectSetTypeSSData[vector.size()];
    vector.copyInto(objectProjectSetTypeSSData);
    return(objectProjectSetTypeSSData);
  }

  public static ProjectSetTypeSSData[] selectProject(ConnectionProvider connectionProvider, String c_project_id)    throws ServletException {
    return selectProject(connectionProvider, c_project_id, 0, 0);
  }

  public static ProjectSetTypeSSData[] selectProject(ConnectionProvider connectionProvider, String c_project_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ProjectSetTypeSSData[] selectDates(ConnectionProvider connectionProvider, String c_project_id)    throws ServletException {
    return selectDates(connectionProvider, c_project_id, 0, 0);
  }

  public static ProjectSetTypeSSData[] selectDates(ConnectionProvider connectionProvider, String c_project_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        ProjectSetTypeSSData objectProjectSetTypeSSData = new ProjectSetTypeSSData();
        objectProjectSetTypeSSData.startdate = UtilSql.getDateValue(result, "startdate", "dd-MM-yyyy");
        objectProjectSetTypeSSData.datecontract = UtilSql.getDateValue(result, "datecontract", "dd-MM-yyyy");
        objectProjectSetTypeSSData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectProjectSetTypeSSData);
        if (countRecord >= numberRegisters && numberRegisters != 0) {
          continueResult = false;
  ...
  public static ProjectSetTypeSSData[] selectTask(ConnectionProvider connectionProvider, String C_PHASE_ID)    throws ServletException {
    return selectTask(connectionProvider, C_PHASE_ID, 0, 0);
  }

  public static ProjectSetTypeSSData[] selectTask(ConnectionProvider connectionProvider, String C_PHASE_ID, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT T.C_TASK_ID, T.SEQNO, T.NAME, T.DESCRIPTION, T.HELP," +
      "        T.M_PRODUCT_ID, T.STANDARDQTY, T.STDDURATION, " +
      "        T.EM_Ssprj_Isreturnmo, T.EM_Ssprj_Isgoingmo" +
      "        FROM C_TASK T" +
      "        WHERE T.C_PHASE_ID = ?" +
      "        ORDER BY T.SEQNO";
