...
package ec.com.sidesoft.backoffice.discount.info;
...
static Logger log4j = Logger.getLogger(ProductCompleteData.class);
  ...
  public static ProductCompleteData[] select(ConnectionProvider connectionProvider, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String adUserClient, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, String offerId)    throws ServletException {
    return select(connectionProvider, rownum, key, name, warehouse, production, adRoleId, cBpartnerId, adUserClient, orderBy, pgLimit, oraLimit1, oraLimit2, offerId, 0, 0);
  }

  public static ProductCompleteData[] select(ConnectionProvider connectionProvider, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String adUserClient, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, String offerId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      select pr.* from m_offer o" +
      "    join Ssbod_offer_ctg oc on oc.m_offer_id = o.m_offer_id" +
      "    join Ssbod_gift_catogory gc on gc.Ssbod_gift_catogory_id = oc.Ssbod_gift_catogory_id" +
      "    join Ssbod_gc_prodcat gprc on gprc.Ssbod_gift_catogory_id = gc.Ssbod_gift_catogory_id" +
      "    join (SELECT B.*," +
    ...
    strSql = strSql + 
      ...
      "        T.PREQTYONHAND, T.PREQTYORDERONHAND, P.m_product_category_id" +
    ...
    strSql = strSql + 
      "    ) pr on pr.m_product_category_id = gprc.m_product_category_id" +
      "        and ((gprc.Product_Selector = 'Y' and (" +
      "            pr.m_product_id not in(select m_product_id " +
      "                from ssbod_gc_product where isactive = 'Y' " +
      "                and Ssbod_Gc_Prodcat_ID = gprc.Ssbod_Gc_Prodcat_ID))) " +
      "        or (gprc.Product_Selector = 'N' and (pr.m_product_id in(select m_product_id " +
      "                from ssbod_gc_product where isactive = 'Y' " +
      "                and Ssbod_Gc_Prodcat_ID = gprc.Ssbod_Gc_Prodcat_ID))))" +
      "where o.m_offer_id = ?";

    ResultSet result;
    Vector<ProductCompleteData> vector = new Vector<ProductCompleteData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, offerId);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductCompleteData.mProductCategoryId = UtilSql.getValue(result, "m_product_category_id");
  ...
  public static String countRows(ConnectionProvider connectionProvider, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String adUserClient, String pgLimit, String oraLimit1, String oraLimit2, String offerId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      select count(*) as VALUE from m_offer o" +
      "    join Ssbod_offer_ctg oc on oc.m_offer_id = o.m_offer_id" +
      "    join Ssbod_gift_catogory gc on gc.Ssbod_gift_catogory_id = oc.Ssbod_gift_catogory_id" +
      "    join Ssbod_gc_prodcat gprc on gprc.Ssbod_gift_catogory_id = gc.Ssbod_gift_catogory_id" +
      "    join (SELECT A.* FROM ( SELECT ";
    strSql = strSql + ((rownum==null || rownum.equals(""))?"":rownum);
    strSql = strSql + 
      " AS RN1, B.* FROM ( SELECT 1, P.m_product_category_id, P.m_product_id" +
      "        FROM M_STORAGE_DETAIL T" +
      "          left join  M_ATTRIBUTESETINSTANCE A on T.M_ATTRIBUTESETINSTANCE_ID = A.M_ATTRIBUTESETINSTANCE_ID," +
      "          M_PRODUCT P," +
      "          M_LOCATOR L, M_Warehouse W, AD_ORG O, AD_ROLE_ORGACCESS RO" +
  ...
  public static ProductCompleteData[] selecttrl(ConnectionProvider connectionProvider, String adLanguage, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String adUserClient, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, String offerId)    throws ServletException {
    return selecttrl(connectionProvider, adLanguage, rownum, key, name, warehouse, production, adRoleId, cBpartnerId, adUserClient, orderBy, pgLimit, oraLimit1, oraLimit2, offerId, 0, 0);
  }
  ...
  public static ProductCompleteData[] selecttrl(ConnectionProvider connectionProvider, String adLanguage, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String adUserClient, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, String offerId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        COALESCE(T.PREQTYORDERONHAND, 0) AS QUANTITYORDER_REF, P.m_product_category_id " +
      "        FROM" +
      "             M_STORAGE_DETAIL T" +
      "                              left join M_ATTRIBUTESETINSTANCE A on T.M_ATTRIBUTESETINSTANCE_ID = A.M_ATTRIBUTESETINSTANCE_ID," +
      "             M_PRODUCT P," +
  ...
  public static String countRowsNotStored(ConnectionProvider connectionProvider, String rownum, String key, String name, String cBpartnerId, String adUserClient, String adUserOrg, String production, String pgLimit, String oraLimit1, String oraLimit2, String offerId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "   select count(*) as VALUE from m_offer o" +
      "    join Ssbod_offer_ctg oc on oc.m_offer_id = o.m_offer_id" +
    ...
    strSql = strSql + 
      " AS RN1, B.* FROM ( " +
      "        SELECT 1, P.m_product_id, P.m_product_category_id " +
  ...
  public static ProductCompleteData[] selectNotStored(ConnectionProvider connectionProvider, String rownum, String key, String name, String cBpartnerId, String adUserClient, String adUserOrg, String production, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, String offerId)    throws ServletException {
    return selectNotStored(connectionProvider, rownum, key, name, cBpartnerId, adUserClient, adUserOrg, production, orderBy, pgLimit, oraLimit1, oraLimit2, offerId, 0, 0);
  }

  public static ProductCompleteData[] selectNotStored(ConnectionProvider connectionProvider, String rownum, String key, String name, String cBpartnerId, String adUserClient, String adUserOrg, String production, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, String offerId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      select pr.* as VALUE from m_offer o" +
      "    join Ssbod_offer_ctg oc on oc.m_offer_id = o.m_offer_id" +
      "    join Ssbod_gift_catogory gc on gc.Ssbod_gift_catogory_id = oc.Ssbod_gift_catogory_id" +
      "    join Ssbod_gc_prodcat gprc on gprc.Ssbod_gift_catogory_id = gc.Ssbod_gift_catogory_id" +
      "    join (SELECT B.*," +
  ...
  public static ProductCompleteData[] selectNotStoredtrl(ConnectionProvider connectionProvider, String rownum, String adLanguage, String key, String name, String cBpartnerId, String adUserClient, String adUserOrg, String production, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, String offerId)    throws ServletException {
    return selectNotStoredtrl(connectionProvider, rownum, adLanguage, key, name, cBpartnerId, adUserClient, adUserOrg, production, orderBy, pgLimit, oraLimit1, oraLimit2, offerId, 0, 0);
  }

  public static ProductCompleteData[] selectNotStoredtrl(ConnectionProvider connectionProvider, String rownum, String adLanguage, String key, String name, String cBpartnerId, String adUserClient, String adUserOrg, String production, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, String offerId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      select pr.* as VALUE from m_offer o" +
      "    join Ssbod_offer_ctg oc on oc.m_offer_id = o.m_offer_id" +
